...
ub(Ic,"color"),a=k("div","buttons-container"),b.appendChild(a),sa(a,c.okText,"ok",Ti),sa(a,c.cancelText,"cancel",ye)),t||null!==Lb||(Lb=k("div","calendar-dialog event-editor-repeat-options"),B.body.appendChild(Lb),b=k("div","title-bar"),y(b,c.repeatOptionsTitle),Lb.appendChild(b),Fc(b,Lb,null),w(b,"ib-close",c.closeTooltipText,ze,!0),b=k("div","contents"),Lb.appendChild(b),ka(b,c.daysToExcludeText),Ae=M(b,c.dayNames[0])[0],Be=M(b,c.dayNames[1])[0],Ce=M(b,c.dayNames[2])[0],De=M(b,c.dayNames[3])[0],
Ee=M(b,c.dayNames[4])[0],Fe=M(b,c.dayNames[5])[0],Ge=M(b,c.dayNames[6])[0],ka(b,c.repeatEndsText),dc=k("input"),b.appendChild(dc),ub(dc,"date"),a=k("div","buttons-container"),b.appendChild(a),sa(a,c.okText,"ok",Ui),sa(a,c.cancelText,"cancel",ze)),t||null!==ec||(ec=k("div","calendar-dialog message"),B.body.appendChild(ec),Zf=k("div","title-bar"),ec.appendChild(Zf),b=k("div","contents"),ec.appendChild(b),$f=k("div","text"),b.appendChild($f),a=M(b,c.removeAllEventsInSeriesText),He=a[0],ag=a[1],a=k("div",
"buttons-container"),b.appendChild(a),fc=k("input","yes","button"),fc.value=c.yesText,a.appendChild(fc),gc=k("input","no","button"),gc.value=c.noText,a.appendChild(gc)),t||null!==Mb||(Mb=k("div","calendar-dialog select-export-type"),B.body.appendChild(Mb),b=k("div","title-bar"),y(b,c.exportEventsTitle),Mb.appendChild(b),Fc(b,Mb,null),w(b,"ib-close",c.closeTooltipText,Ie,!0),b=k("div","contents"),Mb.appendChild(b),Fa=k("input",null,"text"),Fa.placeholder=c.exportFilenamePlaceholderText,b.appendChild(Fa),
a=k("div","split"),b.appendChild(a),e=k("div","radio-buttons-container split-contents"),a.appendChild(e),f=k("div","radio-buttons-container split-contents"),a.appendChild(f),bg=S(e,"CSV","ExportType"),hh=S(e,"XML","ExportType"),ih=S(e,"JSON","ExportType"),jh=S(e,"TEXT","ExportType"),kh=S(f,"iCAL","ExportType"),lh=S(f,"MD","ExportType"),mh=S(f,"HTML","ExportType"),nh=S(f,"TSV","ExportType"),a=k("div","buttons-container"),b.appendChild(a),sa(a,c.okText,"ok",Vi),sa(a,c.cancelText,"cancel",Ie)),Wi(),
Xi(),Yi(),t||(Zi(),$i(),aj(),bj()));d&&ta(!0,!1);null!==G&&(cg.innerText=oh(c.monthTitleBarDateFormat,A))}function Jc(){var a=[];Sa(function(b){a.push(b)});return a}function Sa(a){for(var b in Ja)if(Ja.hasOwnProperty(b))for(var d in Ja[b])if(Ja[b].hasOwnProperty(d)){var e=ph(Ja[b][d]);if(a(e,b,d))return}}function Nb(a,b){b=r(b)?b:!0;a=a.sort(function(d,e){return d.from-e.from});b&&(a=a.sort(function(d,e){return qh(e.isAllDay)-qh(d.isAllDay)}));return a}function dg(a,b){vb(B.body,Aa);var d=function(){Ka(B.body,
...
Kj();Lj();a=k("div","buttons-container");b.appendChild(a);vf=sa(a,c.removeEventText,"remove",Mj);ae=sa(a,c.addText,"ok",Nj);sa(a,c.cancelText,"cancel",id)}}function Jj(){ka(Db,c.titleText);var a=k("div","input-title-container");Db.appendChild(a);kb=k("input",null,"text");a.appendChild(kb);0<c.maximumEventTitleLength&&(kb.maxLength=c.maximumEventTitleLength);var b=function(){ii(null)};ji=sa(a,"...","select-colors",Oj,c.selectColorsText);ka(Db,c.fromText.replace(":",n.empty)+"/"+c.toText);a=k("div",
"split");Db.appendChild(a);lb=k("input");lb.onchange=b;a.appendChild(lb);ub(lb,"date");mb=k("input");a.appendChild(mb);ub(mb,"time");a=k("div","split");Db.appendChild(a);Ia=k("input");Ia.onchange=b;a.appendChild(Ia);ub(Ia,"date");nb=k("input");a.appendChild(nb);ub(nb,"time");nd=M(Db,c.isAllDayText,b)[0];ce=M(Db,c.showAlertsText)[0]}function Kj(){var a=k("div","radio-buttons-container");yf.appendChild(a);Eb=S(a,c.repeatsNever,"RepeatType",Xb);de=S(a,c.repeatsEveryDayText,"RepeatType",Xb);ee=S(a,c.repeatsEveryWeekText,
"RepeatType",Xb);fe=S(a,c.repeatsEvery2WeeksText,"RepeatType",Xb);ge=S(a,c.repeatsEveryMonthText,"RepeatType",Xb);he=S(a,c.repeatsEveryYearText,"RepeatType",Xb);ob=S(a,c.repeatsCustomText,"RepeatType",Xb);zf=sa(a,"...","repeat-options",Pj,c.repeatOptionsTitle);a=k("div","split split-margin");yf.appendChild(a);Yb=k("input",null,"number");Yb.setAttribute("min","1");a.appendChild(Yb);var b=k("div","radio-buttons-container split-contents");a.appendChild(b);uc=S(b,c.dailyText,"RepeatCustomType");ie=S(b,
c.weeklyText,"RepeatCustomType");je=S(b,c.monthlyText,"RepeatCustomType");ke=S(b,c.yearlyText,"RepeatCustomType")}function Lj(){var a=k("div","split");Wb.appendChild(a);ka(a,c.locationText);ka(a,c.groupText);a=k("div","split");Wb.appendChild(a);vc=k("input",null,"text");a.appendChild(vc);0<c.maximumEventLocationLength&&(vc.maxLength=c.maximumEventLocationLength);wc=k("input",null,"text");a.appendChild(wc);0<c.maximumEventGroupLength&&(wc.maxLength=c.maximumEventGroupLength);ka(Wb,c.descriptionText);
xc=k("textarea","custom-scroll-bars");Wb.appendChild(xc);0<c.maximumEventDescriptionLength&&(xc.maxLength=c.maximumEventDescriptionLength);ka(Wb,c.urlText);od=k("input",null,"url");Wb.appendChild(od)}function Kc(){U(null,J)}function Xb(){zf.disabled=Eb.checked;ke.disabled=!ob.checked;uc.disabled=!ob.checked;ie.disabled=!ob.checked;je.disabled=!ob.checked;Yb.disabled=!ob.checked}function ii(a){a=r(a)?a:fa;var b=!1;(a=r(a)&&F(a.locked)?a.locked:!1)?b=!0:nd.checked&&(Ia.value=lb.value,mb.value="00:00",
nb.value="23:59",b=!0);Ia.disabled=b;mb.disabled=b;nb.disabled=b;var d=Kd(lb),e=Kd(Ia);Fh(Ia,d);Fh(dc,e);d>e&&Zc(d,Ia);a||(e>d||e<d?(b=!0,Eb.checked=!0):b=!1);Eb.disabled=b;de.disabled=b;ee.disabled=b;fe.disabled=b;ge.disabled=b;he.disabled=b;ob.disabled=b;zf.disabled=b;Yb.disabled=b;uc.disabled=b;ie.disabled=b;je.disabled=b;ke.disabled=b;a||Xb()}function U(a,b,d){vb(B.body,Aa);var e=Qa,f=void 0;f=r(f)?f:0;e=e.getElementsByClassName("tab");0<e.length&&e[f].click();xf.innerHTML=n.empty;f=k("div","radio-buttons-container");
xf.appendChild(f);for(var g in K)K.hasOwnProperty(g)&&(K[g].eventEditorInput=S(f,K[g].text,"Type"));r(a)?(y(Vb,c.editEventTitle),Ah(a.type),ae.value=c.updateText,vf.style.display="inline-block",fa=a,mb.value=af(a.from),nb.value=af(a.to),nd.checked=ki(a.isAllDay),ce.checked=ki(a.showAlerts,!0),kb.value=C(a.title),xc.value=C(a.description),vc.value=C(a.location),wc.value=C(a.group),od.value=C(a.url),Gc.value=C(a.color,c.defaultEventBackgroundColor),Hc.value=C(a.colorText,c.defaultEventTextColor),Ic.value=
C(a.colorBorder,c.defaultEventBorderColor),Yb.value=I(a.repeatEveryCustomValue,1),Zc(a.from,lb),Zc(a.to,Ia),d=I(a.repeatEvery),d===x.never?Eb.checked=!0:d===x.everyDay?de.checked=!0:d===x.everyWeek?ee.checked=!0:d===x.every2Weeks?fe.checked=!0:d===x.everyMonth?ge.checked=!0:d===x.everyYear?he.checked=!0:d===x.custom&&(ob.checked=!0),d=I(a.repeatEveryCustomType),d===Q.daily?uc.checked=!0:d===Q.weekly?ie.checked=!0:d===Q.monthly?je.checked=!0:d===Q.yearly&&(ke.checked=!0),d=Rb(a.repeatEveryExcludeDays),
Ae.checked=-1<d.indexOf(1),Be.checked=-1<d.indexOf(2),Ce.checked=-1<d.indexOf(3),De.checked=-1<d.indexOf(4),Ee.checked=-1<d.indexOf(5),Fe.checked=-1<d.indexOf(6),Ge.checked=-1<d.indexOf(0),Zc(a.repeatEnds,dc)):(g=new Date,b=r(b)?b:g,Xc(b)&&(b.setHours(g.getHours()),b.setMinutes(g.getMinutes())),g=$c(b,c.defaultEventDuration),y(Vb,c.addEventTitle),Ah(),ae.value=c.addText,vf.style.display="none",fa={},nd.checked=!1,ce.checked=!0,kb.value=n.empty,xc.value=n.empty,vc.value=n.empty,wc.value=n.empty,od.value=
n.empty,Gc.value=c.defaultEventBackgroundColor,Hc.value=c.defaultEventTextColor,Ic.value=c.defaultEventBorderColor,Eb.checked=!0,Ae.checked=!1,Be.checked=!1,Ce.checked=!1,De.checked=!1,Ee.checked=!1,Fe.checked=!1,Ge.checked=!1,dc.value=null,Yb.value="1",uc.checked=!0,za(d)&&(b.setHours(d[0]),b.setMinutes(d[1]),g.setHours(d[0]),g.setMinutes(d[1]),g=$c(g,c.defaultEventDuration)),mb.value=af(b),nb.value=af(g),Zc(b,lb),Zc(g,Ia));w(Vb,"ib-close",c.closeTooltipText,id,!0);a=rf(a);for(var h in K)K.hasOwnProperty(h)&&
r(K[h].eventEditorInput)&&(K[h].eventEditorInput.disabled=a);ae.disabled=a;lb.disabled=a;Ia.disabled=a;mb.disabled=a;nb.disabled=a;nd.disabled=a;ce.disabled=a;kb.disabled=a;ji.disabled=a;xc.disabled=a;vc.disabled=a;wc.disabled=a;od.disabled=a;Eb.disabled=a;de.disabled=a;ee.disabled=a;fe.disabled=a;ge.disabled=a;he.disabled=a;ob.disabled=a;zf.disabled=a;ii();La.push(id);Qa.style.display="block";kb.focus()}function pc(){kb.focus();kb.select()}function Nj(){var a=mb.value.split(":"),b=nb.value.split(":"),
d=yc(kb.value),e=yc(od.value);if(2>a.length)le(c.fromTimeErrorMessage);else if(2>b.length)le(c.toTimeErrorMessage);else if(d===n.empty)le(c.titleErrorMessage);else if(0<e.length&&!li(e))le(c.urlErrorMessage);else{a=Kd(lb);b=Kd(Ia);var f=yc(xc.value),g=yc(vc.value),h=yc(wc.value),l=Kd(dc,null),p=parseInt(Yb.value);var q=0;for(var v in K)if(K.hasOwnProperty(v)&&r(K[v].eventEditorInput)&&K[v].eventEditorInput.checked){q=parseInt(v);break}bf(a,mb.value);bf(b,nb.value);isNaN(p)&&(p=0,Eb.checked=!0,uc.checked=
!0);b<a?le(c.toSmallerThanFromErrorMessage):(id(),v=r(fa.id),d={from:a,to:b,title:d,description:f,location:g,group:h,isAllDay:nd.checked,showAlerts:ce.checked,color:fa.color,colorText:fa.colorText,colorBorder:fa.colorBorder,repeatEveryExcludeDays:fa.repeatEveryExcludeDays,repeatEnds:l,url:e,repeatEveryCustomValue:p,type:q},Eb.checked?d.repeatEvery=x.never:de.checked?d.repeatEvery=x.everyDay:ee.checked?d.repeatEvery=x.everyWeek:fe.checked?d.repeatEvery=x.every2Weeks:ge.checked?d.repeatEvery=x.everyMonth:
he.checked?d.repeatEvery=x.everyYear:ob.checked&&(d.repeatEvery=x.custom),uc.checked?d.repeatEveryCustomType=Q.daily:ie.checked?d.repeatEveryCustomType=Q.weekly:je.checked?d.repeatEveryCustomType=Q.monthly:ke.checked&&(d.repeatEveryCustomType=Q.yearly),v?d.id=fa.id:(d.organizerName=c.organizerName,d.organizerEmailAddress=c.organizerEmailAddress),v?qa.updateEvent(fa.id,d,!1):qa.addEvent(d,!1),ra(),la())}}function id(a){me(a);Ka(B.body,Aa);Qa.style.display="none"}function Mj(){Af();Je(c.confirmEventRemoveTitle,
c.confirmEventRemoveMessage,function(){ne();id();r(fa.id)&&(qa.removeEvent(fa.id,!0),la())},function(){ne()})}function la(){W(ma)&&Sb(J);W(oa)&&rh();W(wa)&&Nc(Bb)}function oc(a,b,d,e){d=r(d)?d:"09:00";e=r(e)?d:"09:00";bf(a,d);bf(b,e);b=$c(b,c.defaultEventDuration);a={from:a,to:b,title:c.newEventDefaultTitle,description:n.empty,location:n.empty,group:n.empty,isAllDay:!1,showAlerts:!0,color:c.defaultEventBackgroundColor,colorText:c.defaultEventTextColor,colorBorder:c.defaultEventBorderColor,repeatEveryExcludeDays:[],
repeatEnds:null,url:n.empty,repeatEveryCustomValue:n.empty,repeatEvery:x.never,repeatEveryCustomType:Q.daily,organizerName:n.empty,organizerEmailAddress:n.empty,type:0,locked:!1};qa.addEvent(a,!1);ra();la();return a}function rf(a){return r(a)&&F(a.locked)?a.locked:!1}function le(a){Je(c.errorText,a,ne,null,!1,!1);Af()}function Af(){wf.style.display="block"}function ne(){wf.style.display="none"}function Ti(){ye();fa.color=Gc.value;fa.colorText=Hc.value;fa.colorBorder=Ic.value}function ye(a){me(a);
ne();Kb.style.display="none"}function Oj(){La.push(ye);Kb.style.display="block";Af()}function Ui(){ze();var a=[];Ae.checked&&a.push(1);Be.checked&&a.push(2);Ce.checked&&a.push(3);De.checked&&a.push(4);Ee.checked&&a.push(5);Fe.checked&&a.push(6);Ge.checked&&a.push(0);fa.repeatEveryExcludeDays=a}function ze(a){me(a);ne();Lb.style.display="none"}function Pj(){La.push(ze);Lb.style.display="block";Af()}function Je(a,b,d,e,f,g){f=r(f)?f:!1;g=r(g)?g:!0;La.push(!1);ec.style.display="block";y(Zf,a);y($f,b);
fc.onclick=mi;fc.addEventListener("click",d);gc.onclick=mi;g?(gc.style.display="inline-block",fc.value=c.yesText):(gc.style.display="none",fc.value=c.okText);f?(ag.style.display="block",He.checked=!1):(ag.style.display="none",He.checked=!0);qf(e)&&gc.addEventListener("click",e)}function mi(){La.pop();ec.style.display="none"}function Lc(a){vb(B.body,Aa);La.push(Ie);Mb.style.display="block";Fb=a;bg.checked=!0;Fa.value=n.empty;Fa.focus()}function Ie(a){me(a);Ka(B.body,Aa);Mb.style.display="none"}function Vi(){Ie();
bg.checked?Gb(Fb,"csv",Fa.value):hh.checked?Gb(Fb,"xml",Fa.value):ih.checked?Gb(Fb,"json",Fa.value):jh.checked?Gb(Fb,"text",Fa.value):kh.checked?Gb(Fb,"ical",Fa.value):lh.checked?Gb(Fb,"md",Fa.value):mh.checked?Gb(Fb,"html",Fa.value):nh.checked&&Gb(Fb,"tsv",Fa.value)}function Wi(){if(!t&&null===ha){ha=k("div","calendar-dialog search");B.body.appendChild(ha);var a=k("div","title-bar");y(a,c.searchEventsTitle);ha.appendChild(a);Fc(a,ha,function(){Ng=!0;oe()});a.ondblclick=Og;var b=w(a,"ib-close",c.closeTooltipText,
Id);b.onmousedown=D;b.onmouseup=D;zc=w(a,"ib-minus",c.minimizedTooltipText,Og);zc.onmousedown=D;zc.onmouseup=D;pb=k("div","contents");ha.appendChild(pb);a=k("div","history-container");pb.appendChild(a);ba=k("input",null,"text");ba.placeholder=c.searchTextBoxPlaceholder;ba.oninput=pd;ba.onpropertychange=pd;ba.onkeypress=Qj;a.appendChild(ba);qb=k("div","ib-arrow-down-full");qb.style.display="none";qb.onclick=Rj;a.appendChild(qb);$a=k("div","history-dropdown custom-scroll-bars");a.appendChild($a);a=
k("div","checkbox-container");pb.appendChild(a);Bf=M(a,c.notSearchText,rb)[0];Cf=M(a,c.matchCaseText,rb)[0];qd=M(a,c.advancedText+":",Sj)[0];qd.checked=!0;pe=k("div","advanced");pb.appendChild(pe);var d=k("div","split");pe.appendChild(d);b=k("div","split-contents");d.appendChild(b);a=k("div","split-contents");d.appendChild(a);ka(b,c.includeText,"text-header");d=k("div","checkbox-container");b.appendChild(d);qe=M(d,c.titleText.replace(":",n.empty),rb)[0];Df=M(d,c.locationText.replace(":",n.empty),
rb)[0];Ef=M(d,c.descriptionText.replace(":",n.empty),rb)[0];Ff=M(d,c.groupText.replace(":",n.empty),rb)[0];Gf=M(d,c.urlText.replace(":",n.empty),rb)[0];qe.checked=!0;ka(a,c.optionsText,"text-header");b=k("div","radio-buttons-container");a.appendChild(b);Hf=S(b,c.startsWithText,"SearchOptionType",rb);If=S(b,c.endsWithText,"SearchOptionType",rb);Jf=S(b,c.containsText,"SearchOptionType",rb);Jf.checked=!0;a=k("div","buttons-container");pb.appendChild(a);Kf=sa(a,c.previousText,"previous",ni);Lf=sa(a,c.nextText,
"next",oi)}}function Sj(){pe.style.display=qd.checked?"block":"none";tg();oe()}function rb(){oe();pd(!1)}function pd(a){a=r(a)?a:!0;0<ab.length&&Jh(G," focused-event");Kf.disabled=!0;Lf.disabled=ba.value===n.empty;ab=[];Zb=0;Pg=null;a&&pi();oe()}function Ed(){"block"!==ha.style.display&&(ab=[],ha.style.display="block",pd(!1),ba.value=u.lastSearchText,Bf.checked=u.not,Cf.checked=u.matchCase,qd.checked=u.showAdvanced,qe.checked=u.searchTitle,Df.checked=u.searchLocation,Ef.checked=u.searchDescription,
Ff.checked=u.searchGroup,Gf.checked=u.searchUrl,Hf.checked=u.startsWith,If.checked=u.endsWith,Jf.checked=u.contains,pe.style.display=qd.checked?"block":"none",tg());"block"!==pb.style.display&&Og();ba.focus();ba.select();0<u.history.length&&(qb.style.display="block")}function tg(){Ng||t||(xa(u.left)?ha.style.left=u.left+"px":ha.style.left=Ga.innerWidth/2-ha.offsetWidth/2+"px",xa(u.top)?ha.style.top=u.top+"px":ha.style.top=Ga.innerHeight/2-ha.offsetHeight/2+"px")}function Id(){var a=!1;"block"===ha.style.display&&
(ha.style.display="none",pd(),a=!0);return a}function Og(){"block"===pb.style.display?(pb.style.display="none",zc.className="ib-square-hollow",ua(zc,c.restoreTooltipText)):(pb.style.display="block",zc.className="ib-minus",ua(zc,c.minimizedTooltipText))}function ni(){if(0<Zb){Zb--;var a=ab[Zb];qi();Z(a.from);ri(a)}}function Qj(a){a.keyCode===P.enter&&aa(a)&&!Kf.disabled?ni():a.keyCode!==P.enter||Lf.disabled?pi():oi()}function oi(){if(0===ab.length){var a="day-",b=Bf.checked,d=Cf.checked,e=d?ba.value:
ba.value.toLowerCase(),f={},g=Nb(Jc()),h=g.length,l=W(ma),p=W(oa),q=W(wa);l?a="full-day-":p?a="month-":q&&(a="week-day-");oe(!0);for(var v=0;v<h;v++){var E=g[v];if(ad(E)){var ea=C(E.title),Tb=C(E.location),Ub=C(E.description),Qg=C(E.group),Rg=C(E.url),$b=!1;d||(ea=ea.toLowerCase(),Ub=Ub.toLowerCase(),Tb=Tb.toLowerCase(),Qg=Qg.toLowerCase(),Rg=Rg.toLowerCase());qe.checked&&re(ea,e)?$b=!0:Df.checked&&re(Tb,e)?$b=!0:Ef.checked&&re(Ub,e)?$b=!0:Ff.checked&&re(Qg,e)?$b=!0:Gf.checked&&re(Rg,e)&&($b=!0);
b&&($b=!$b);!$b||null===tb(a+E.id)&&(l||p||q)||(l||p||q?ab.push(hd(E,!1)):(ea=E.from.getMonth()+"-"+E.from.getFullYear(),f.hasOwnProperty(ea)||(ab.push(hd(E,!1)),f[ea]=!0)))}}}else Zb++;qi();0<ab.length&&(a=ab[Zb],Z(new Date(a.from)),ri(a))}function ri(a){var b="day-",d=W(ma),e=W(oa),f=W(wa);Jh(G," focused-event");d?b="full-day-":e?b="month-":f&&(b="week-day-");b=tb(b+a.id);null!==b&&(b.className+=" focused-event",Pg=a.id,(d||e||f)&&b.scrollIntoView())}function qi(){Kf.disabled=0===Zb;Lf.disabled=
Zb===ab.length-1||0===ab.length}function re(a,b){return Hf.checked?a.substring(0,b.length)===b:If.checked?a.substring(a.length-b.length,a.length)===b:-1<a.indexOf(b)}function oe(a){a=r(a)?a:!1;mc(Ca.searchOptionsChanged);var b=yc(ba.value);a&&(qb.style.display="block");Uc(Ca.searchOptionsChanged,function(){var d=!0,e=u.history.length;if(a){d=!1;for(var f=0;f<e;f++)if(u.history[f]===b){d=!0;break}d||u.history.push(b)}if(!a||d)u.lastSearchText=b,u.not=Bf.checked,u.matchCase=Cf.checked,u.showAdvanced=
qd.checked,u.searchTitle=qe.checked,u.searchLocation=Df.checked,u.searchDescription=Ef.checked,u.searchGroup=Ff.checked,u.searchUrl=Gf.checked,u.startsWith=Hf.checked,u.endsWith=If.checked,u.contains=Jf.checked,Ng&&(u.left=ha.offsetLeft,u.top=ha.offsetTop),z("onSearchOptionsUpdated",u)},2E3,!1)}function pi(){var a=u.history.length;0<a?(qb.style.display="block",mc(Ca.searchEventsHistoryDropDown),Uc(Ca.searchEventsHistoryDropDown,function(){var b=ba.value,d=!1;if(yc(b)!==n.empty){si();$a.innerHTML=
...
function ti(a,b){var d=k("div","history-dropdown-item");$a.appendChild(d);var e=k("span","search-search");y(e,a.substring(0,b));d.appendChild(e);e=k("span");y(e,a.substring(b));d.appendChild(e);d.onclick=function(f){D(f);Xe();ba.value=a;ba.selectionStart=ba.selectionEnd=ba.value.length;ba.focus();pd(!1)}}function Xe(){null!==$a&&($a.style.display="none",qb.className="ib-arrow-down-full")}function ui(){null!==$a&&($a.style.display="block",qb.className="ib-arrow-up-full")}function Xi(){if(!t&&null===
fb){fb=k("div","calendar-dialog configuration");B.body.appendChild(fb);var a=k("div","title-bar");y(a,c.configurationTitleText);fb.appendChild(a);Fc(a,fb,null);w(a,"ib-close",c.closeTooltipText,vi,!0);a=k("div","contents");fb.appendChild(a);var b=hi(a);kd(b,c.displayTabText,function(d){ld(d,Hb,fb)},!0);kd(b,c.organizerTabText,function(d){ld(d,rd,fb)});Hb=md(a,!0,!1);rd=md(a,!1,!1);fg=M(Hb,c.enableAutoRefreshForEventsText)[0];gg=M(Hb,c.enableBrowserNotificationsText,null,null,null,"checkbox-tabbed-in")[0];
hg=M(Hb,c.enableTooltipsText,null,null,null,"checkbox-tabbed-down")[0];ig=M(Hb,c.enableDragAndDropForEventText)[0];jg=M(Hb,c.enableDayNameHeadersInMainDisplayText)[0];kg=M(Hb,c.showEmptyDaysInWeekViewText)[0];lg=M(Hb,c.showHolidaysInTheDisplaysText)[0];ka(rd,c.organizerNameText);Re=k("input",null,"text");rd.appendChild(Re);ka(rd,c.organizerEmailAddressText);Se=k("input",null,"email");rd.appendChild(Se);b=k("div","buttons-container");a.appendChild(b);sa(b,c.okText,"ok",Tj);sa(b,c.cancelText,"cancel",
vi)}}function Tj(){fg.checked?qa.startTheAutoRefreshTimer():qa.stopTheAutoRefreshTimer();c.eventNotificationsEnabled=gg.checked;c.tooltipsEnabled=hg.checked;c.dragAndDropForEventsEnabled=ig.checked;c.showDayNamesInMainDisplay=jg.checked;c.showEmptyDaysInWeekView=kg.checked;c.showHolidays=lg.checked;c.organizerName=Re.value;c.organizerEmailAddress=Se.value;db=!1;z("onOptionsUpdated",c);Sg();mg();Z(A,!0,!0)}function vi(){mg()}function mg(a){me(a);Ka(B.body,Aa);fb.style.display="none"}function ad(a){var b=
C(a.group),d=b.toLowerCase();a=I(a.type);var e=!0;b!==n.empty?r(L.visibleGroups)&&(e=-1<L.visibleGroups.indexOf(d)):e=!c.hideEventsWithoutGroupAssigned;e&&r(L.visibleEventTypes)&&K.hasOwnProperty(a)&&(e=-1<L.visibleEventTypes.indexOf(a));return e}function Yi(){null===O&&(O=k("div","calendar-tooltip"),B.body.appendChild(O),Tg=k("div","ib-close"),Mf=k("div","ib-plus"),Nf=k("div","title-buttons"),Nf.appendChild(Tg),Nf.appendChild(Mf),Ac=k("div","title"),se=k("div","date"),Bc=k("div","duration"),te=k("div",
"repeats"),ue=k("div","description"),ve=k("div","location"),Cc=k("div","url"),Tg.onclick=Tc,Mf.onclick=function(){U(Md)},document.body.addEventListener("mousemove",Tc))}function Ih(a,b,d,e){D(a);mc(Ca.showToolTip);Tc();e=r(e)?e:!1;"block"!==O.style.display&&c.tooltipsEnabled&&Uc(Ca.showToolTip,function(){if(e||!B.body.contains(Aa)&&!Ve()&&!gi()&&null===Y){d=r(d)?d:n.empty;O.className=d===n.empty?"calendar-tooltip-event":"calendar-tooltip";if(d!==n.empty)y(O,d);else{O.onmousemove=D;Md=b;O.innerHTML=
n.empty;Ac.innerHTML=n.empty;Bc.innerHTML=n.empty;O.appendChild(Nf);O.appendChild(Ac);O.appendChild(se);O.appendChild(Bc);jb(Mf,c.manualEditingEnabled);Oa(b.url)?(y(Cc,Uj(b.url)),vb(O,Cc),Cc.onclick=function(g){D(g);Mg(b.url);Tc()}):(Cc.innerHTML=n.empty,Cc.onclick=null,Ka(O,Cc));if(I(b.repeatEvery)>x.never){var f=k("div","ib-refresh-medium ib-no-hover ib-no-active");f.style.borderColor=Ac.style.color;Ac.appendChild(f)}Ac.innerHTML+=bd(b.title);xa(b.repeatEvery)&&b.repeatEvery>x.never?(y(te,c.repeatsText.replace(":",
n.empty)+n.space+cd(b.repeatEvery)),vb(O,te)):(te.innerHTML=n.empty,Ka(O,te));Oa(b.location)?(y(ve,b.location),vb(O,ve)):(ve.innerHTML=n.empty,Ka(O,ve));Oa(b.description)?(y(ue,b.description),vb(O,ue)):(ue.innerHTML=n.empty,Ka(O,ue));b.from.getDate()===b.to.getDate()?b.isAllDay?y(se,c.allDayText):(y(se,Ld(b.from,b.to)),y(Bc,Pb(b.from,b.to))):(kf(se,b.from,b.to),y(Bc,Pb(b.from,b.to)));Bc.innerHTML===n.empty&&O.removeChild(Bc)}Od(a,O)}},c.eventTooltipDelay,!1)}function Tc(){mc(Ca.showToolTip);wi()&&
(O.style.display="none",Md=null,O.onmousemove=null)}function wi(){return Ug(Ca.showToolTip)||null!==O&&"block"===O.style.display}function ua(a,b,d){null!==a&&(a.onmousemove=function(e){Ih(e,null,b,d)})}function Fc(a,b,d){a.onmousedown=function(e){Dc||(da(),bb=b,Dc=!0,xi=e.pageX-bb.offsetLeft,yi=e.pageY-bb.offsetTop,Of=bb.offsetLeft,Pf=bb.offsetTop)};a.onmouseup=function(){zi(d)};a.oncontextmenu=function(){zi(null)}}function zi(a){Dc&&(Dc=!1,bb=null,Pf=Of=0,null!==a&&a())}function ij(a){Dc&&(bb.style.left=
a.pageX-xi+"px",bb.style.top=a.pageY-yi+"px")}function jj(){Dc&&(bb.style.left=Of+"px",bb.style.top=Pf+"px",Dc=!1,bb=null,Pf=Of=0)}function hi(a){var b=k("div");a.appendChild(b);return b}function kd(a,b,d,e){e=r(e)?e:!1;var f=k("div","tab tab-control"+(e?"-selected":n.empty));y(f,b);a.appendChild(f);f.onclick=function(){d(f)}}function md(a,b,d){b=r(b)?b:!1;d=r(d)?d:!0;var e=k("div","checkbox-container tab-content custom-scroll-bars");a.appendChild(e);d&&(e.className+=" custom-scroll-bars");b||(e.style.display=
"none");return e}function ld(a,b,d){var e=d.getElementsByClassName("tab-control-selected"),f=e.length;d=d.getElementsByClassName("tab-content");for(var g=d.length,h=0;h<f;h++)e[h].className="tab tab-control";for(e=0;e<g;e++)d[e].style.display="none";a.className="tab tab-control-selected";b.style.display="block"}function df(a,b,d,e){e=r(e)?e:!1;r(d)&&d<new Date&&(a.className+=" expired");e&&r(d)&&(d.getFullYear()!==A.getFullYear()||d.getMonth()!==A.getMonth())&&(a.className+=" not-in-current-month");
Oa(b.color)?(a.style.backgroundColor=b.color,Oa(b.colorText)&&(a.style.color=b.colorText),Oa(b.colorBorder)&&(a.style.borderColor=b.colorBorder)):b.isAllDay&&(a.className+=" all-day")}function ef(a,b){Pg===b.id&&(a.className+=" focused-event");Ai(b.id)&&(a.className+=" selected-event");for(var d=!1,e=X.length,f=0;f<e;f++)if(X[f].id===b.id){d=!0;break}d&&(a.className=hb?a.className+" cut-event":a.className+" copy-event")}function we(a,b,d){d=r(d)?d:!1;var e=B.getElementsByClassName("event");e=[].slice.call(e);
for(var f=e.length,g=0;g<f;g++){var h=e[g],l=h.getAttribute("event-id");null!==l&&l===a.toString()&&(h.className=d?h.className.replace(n.space+b,n.empty):h.className+(n.space+b))}}function oj(a,b){Bi(function(){if(Xc(a)&&!Ci.hasOwnProperty(b.id)&&(!F(b.showAlerts)||b.showAlerts)){var d=new Date,e=new Date,f=new Date,g=I(b.repeatEvery);d.setHours(b.from.getHours(),b.from.getMinutes(),0,0);e.setHours(b.to.getHours(),b.to.getMinutes(),0,0);g!==x.never||Xc(b.from)||d.setHours(0,0,0,0);g!==x.never||Xc(b.to)||
e.setHours(23,59,59,99);f>=d&&f<=e&&Vj(b)}},!1,b)}function Vj(a){Ci[a.id]=!0;(new Notification(c.eventNotificationTitle,{body:c.eventNotificationBody.replace("{0}",a.title)})).onclick=function(){var b=C(a.url);b===n.empty?U(a):Mg(b);z("onNotificationClicked",a)}}function Sg(){Bi(function(){"granted"!==Notification.permission&&Notification.requestPermission()})}function Bi(a,b,d){c.eventNotificationsEnabled&&!t&&(b=r(b)?b:!0,Notification?a():b&&console.error("Browser notifications API unavailable."),
r(d)&&z("onNotification",d))}function Mg(a){Ga.open(a,c.urlWindowTarget);sb("onEventUrlClicked",a)}function Wc(a){a=r(a)?a:!0;for(var b=X.length,d=0;d<b;d++){var e=X[d];hb?we(e.id,"cut-event",a):we(e.id,"copy-event",a)}}function ai(a){X=[];var b=ya.length;if(0<b)for(a=0;a<b;a++)X.push(ya[a]);else X.push(a)}function Ai(a){for(var b=!1,d=ya.length,e=0;e<d;e++)if(ya[e].id===a){b=!0;break}return b}function ug(a,b){for(var d=X.length,e=0;e<d;e++){var f=X[e],g=Ob(f.from,f.to);f=b?f:hd(f);f.from.setDate(a.getDate());
...
function xb(){for(var a=ya.length,b=0;b<a;b++)we(ya[b].id,"selected-event",!0);ya=[]}function Eh(a){X=[];hb=r(a)?a:!1;a=ya.length;if(0<a){for(var b=0;b<a;b++)X.push(ya[b]);Wc(!1)}}function Hh(){0<c.autoRefreshTimerDelay&&!t&&Gd&&Uc(Ca.autoRefresh,function(){ta()},c.autoRefreshTimerDelay)}function Gh(){0<c.autoRefreshTimerDelay&&!t&&Gd&&mc(Ca.autoRefresh)}function ta(a,b){a=r(a)?a:!1;b=r(b)?b:!1;if(Ch()||a)la(),Ph(),ah?Z():ra(),b&&sb("onRefresh")}function Ch(){return!wi()&&!B.body.contains(Aa)&&!Ve()&&
!gi()&&!wd()&&null===Y}function Uc(a,b,d,e){e=r(e)?e:!0;Ug(a)||(cb[a]=e?setInterval(b,d):setTimeout(function(){b();delete cb[a]},d))}function mc(a){Ug(a)&&(clearTimeout(cb[a]),delete cb[a])}function Ug(a){return cb.hasOwnProperty(a)&&null!==cb[a]}function zh(){var a=[],b=[];Sa(function(d){d=C(d.group);d!==n.empty&&-1===b.indexOf(d.toLowerCase())&&(a.push(d),b.push(d.toLowerCase()))});a.sort();return a}function Eg(a){W(a)||(a.className+=" overlay-shown",Id())}function nc(a){W(a)&&(a.className=a.className.replace(" overlay-shown",
n.empty))}function W(a){return null!==a&&-1<a.className.indexOf("overlay-shown")}function k(a,b,d){a=a.toLowerCase();var e="text"===a;Vg.hasOwnProperty(a)||(Vg[a]=e?B.createTextNode(n.empty):B.createElement(a));a=Vg[a].cloneNode(!1);r(b)&&(a.className=b);r(d)&&(a.type=d);return a}function ka(a,b,d){var e=k("p");y(e,b);a.appendChild(e);r(d)&&(e.className=d);return e}function R(a,b,d,e,f,g){f=r(f)?f:!1;(g=r(g)?g:!1)&&a.appendChild(k("div","separator"));d=k("span",d);g=qf(e);y(d,b);a.appendChild(d);
g&&(d.onclick=e);f&&g&&(d.ondblclick=D)}function sa(a,b,d,e,f){d=k("input",d,"button");d.value=b;d.onclick=e;a.appendChild(d);r(f)&&ua(d,f,!0);return d}function tb(a){sd.hasOwnProperty(a)&&null!==sd[a]||(sd[a]=Di(a));B.body.contains(sd[a])||(sd[a]=Di(a));return sd[a]}function Di(a){var b=null;if(null===G)b=B.getElementById(a);else for(var d=G.getElementsByTagName("*"),e=d.length,f=0;f<e;f++)if(d[f].id===a){b=d[f];break}return b}function vb(a,b){try{a.contains(b)||a.appendChild(b)}catch(d){console.warn(d.message)}}
function Ka(a,b){try{a.contains(b)&&a.removeChild(b)}catch(d){console.warn(d.message)}}function D(a){a.preventDefault();a.cancelBubble=!0}function Od(a,b){var d=a.pageX,e=a.pageY;var f=B.documentElement;var g=(Ga.pageXOffset||f.scrollLeft)-(f.clientLeft||0);f=(Ga.pageYOffset||f.scrollTop)-(f.clientTop||0);b.style.display="block";d+b.offsetWidth>Ga.innerWidth?d-=b.offsetWidth:d++;e+b.offsetHeight>Ga.innerHeight?e-=b.offsetHeight:e++;d<g&&(d=a.pageX+1);e<f&&(e=a.pageY+1);b.style.left=d+"px";b.style.top=
e+"px"}function ub(a,b){try{a.type=b}catch(d){console.error(d.message),a.type="text"}}function Fg(a){for(var b=0,d=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)b+=a.offsetLeft-a.scrollLeft,d+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{left:b,top:d}}function me(a){(a=r(a)?a:!0)&&La.pop()}function hd(a,b){b=r(b)?b:!0;var d=JSON.parse(JSON.stringify(a));d.from=new Date(d.from);d.to=new Date(d.to);r(d.repeatEnds)&&(d.repeatEnds=new Date(d.repeatEnds));delete d.created;delete d.lastUpdated;b&&
...
e;a.appendChild(b);ua(b,d,f);return b}function Vh(a,b){a.innerHTML=n.empty;var d=k("div","no-events-available-text");a.appendChild(d);ka(d,c.noEventsAvailableFullText);c.manualEditingEnabled&&(d.appendChild(k("div")),R(d,c.clickText+n.space),R(d,c.hereText,"link",b),R(d,n.space+c.toAddANewEventText))}function N(a){a=a.toString();return 1===a.length?"0"+a:a}function yc(a){return a.replace(/^\s+|\s+$/g,n.empty)}function ch(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push("-");var d=
Math.floor(16*Math.random()).toString(16);a.push(d)}return a.join(n.empty)}function Uj(a,b){var d=a;b=r(b)?b:30;a.length>b&&(d=0===b%2?b/2:(b-1)/2,d=a.substring(0,d)+"..."+a.substring(a.length-d));return d}function r(a){return void 0!==a&&null!==a&&a!==n.empty}function qf(a){return r(a)&&"function"===typeof a}function ja(a){return r(a)&&"string"===typeof a}function xa(a){return r(a)&&"number"===typeof a}function F(a){return r(a)&&"boolean"===typeof a}function ac(a){return r(a)&&"object"===typeof a}
function za(a){return ac(a)&&a instanceof Array}function Oa(a){return ja(a)&&a!==n.empty}function ud(a){return ac(a)&&a instanceof Date}function bh(a){return ac(a)&&void 0!==a.tagName}function li(a){return/^(?:(?:(?:https?|ftp):)?\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})))(?::\d{2,5})?(?:[/?#]\S*)?$/i.test(a)}
...
"Type:"),c.sideMenuHeaderText=m(c.sideMenuHeaderText,"Calendar.js"),c.sideMenuDaysText=m(c.sideMenuDaysText,"Days"),c.visibleDaysText=m(c.visibleDaysText,"Visible Days"),c.previousYearTooltipText=m(c.previousYearTooltipText,"Previous Year"),c.nextYearTooltipText=m(c.nextYearTooltipText,"Next Year"),c.showOnlyWorkingDaysText=m(c.showOnlyWorkingDaysText,"Show Only Working Days"),c.exportFilenamePlaceholderText=m(c.exportFilenamePlaceholderText,"Name (optional)"),c.errorText=m(c.errorText,"Error"),xe(c.eventTypeNormalText,
"Normal",0),xe(c.eventTypeMeetingText,"Meeting",1),xe(c.eventTypeBirthdayText,"Birthday",2),xe(c.eventTypeHolidayText,"Holiday",3),xe(c.eventTypeTaskText,"Task",4),Sg(),u=Uf(Ji,c.searchOptions),u.enabled=H(u.enabled,!0),u.lastSearchText=m(u.lastSearchText,n.empty),u.not=H(u.not,!1),u.matchCase=H(u.matchCase,!1),u.showAdvanced=H(u.showAdvanced,!1),u.searchTitle=H(u.searchTitle,!0),u.searchLocation=H(u.searchLocation,!1),u.searchDescription=H(u.searchDescription,!1),u.searchGroup=H(u.searchGroup,!1),
u.searchUrl=H(u.searchUrl,!1),u.startsWith=H(u.startsWith,!1),u.endsWith=H(u.endsWith,!1),u.contains=H(u.contains,!0),u.left=Ea(u.left,null),u.top=Ea(u.top,null),u.history=Wg(u.history,[]),Z(c.initialDateTime,!0),null!==G&&F(c.openInFullScreenMode)&&c.openInFullScreenMode&&!t&&vh()})(document,window)};