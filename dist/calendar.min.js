...
function calendarJs(Ii,Ji,Ki){function Z(a,b,d){A=ud(a)?a:new Date;A.setDate(1);A.setHours(0,0,0,0);a=A;var e=new Date;ah=a.getFullYear()===e.getFullYear()&&a.getMonth()===e.getMonth();b=r(b)?b:!1;d=r(d)?d:!1;a=new Date(A.getFullYear(),A.getMonth(),1);a=0===a.getDay()?7:a.getDay();e=vd(A.getFullYear(),A.getMonth());wd()&&xd();da();if(!db){if(null===G){if(bh(ia)){var f=ia;ia=f.id;ja(ia)||(ia=ch())}else f=tb(ia);if(null!==f)if("input"!==f.tagName.toLowerCase()||"text"!==f.type&&"date"!==f.type)G=f,
G.className="calendar",G.innerHTML=n.empty;else{var g=f;yd=g;ub(yd,"hidden");cc=k("input","calendar-date-picker-input");cc.readOnly=!0;cc.placeholder=c.selectDatePlaceholderText;t=!0;f=g.parentNode;f.removeChild(g);g=k("div","calendar-date-picker");f.appendChild(g);g.appendChild(yd);g.appendChild(cc);G=k("div","calendar calendar-hidden");G.id=ia;g.appendChild(G);cc.onclick=Li;cc.onkeydown=Mi;B.addEventListener("click",Ec);dh();g=yd.value.split("/");f=null;3===g.length&&(g=new Date(parseInt(g[2]),
...
Xi(),Yi(),Zi(),t||($i(),aj(),bj(),cj()));d&&ta(!0,!1);null!==G&&(cg.innerText=oh(c.monthTitleBarDateFormat,A))}function Jc(){var a=[];Sa(function(b){a.push(b)});return a}function Sa(a){for(var b in Ja)if(Ja.hasOwnProperty(b))for(var d in Ja[b])if(Ja[b].hasOwnProperty(d)){var e=ph(Ja[b][d]);if(a(e,b,d))return}}function Nb(a,b){b=r(b)?b:!0;a=a.sort(function(d,e){return d.from-e.from});b&&(a=a.sort(function(d,e){return qh(e.isAllDay)-qh(d.isAllDay)}));return a}function dg(a,b){vb(B.body,Aa);var d=function(){Ka(B.body,
...
Ue.appendChild(b);b.ondblclick=D;b.onclick=function(d){D(d);A.getFullYear()!==a&&(A.setFullYear(a),Z(A),sg())}}function fj(a){D(a);"block"!==gb.style.display?(da(),gb.style.display="block",Te.className="ib-arrow-up-full-medium",a=hj(),Ue.scrollTop=null!==a?a.offsetTop-gb.offsetHeight/2:0):sg()}function hj(){var a=gb.getElementsByClassName("year"),b=a.length;if(1<=b)for(var d=0;d<b;d++)"year"!==a[d].className&&(a[d].className="year");a=tb("year-selected-"+A.getFullYear());null!==a&&(a.className+=" year-selected");
...
g));return f}function Qb(a,b){for(var d=a.getElementsByClassName(b);d[0];)d[0].parentNode.removeChild(d[0])}function rj(a,b){for(var d=a.getElementsByClassName(b),e=d.length,f=0;f<e;f++)d[f].style.display="block"}function Jh(a,b){for(var d=a.getElementsByClassName(b);d[0];)d[0].className=d[0].className.replace(b,n.empty)}function Ag(a,b){var d=I(a.repeatEvery),e=new Date(a.to);d>x.never&&(d=new Date(b),d.setHours(e.getHours(),e.getMinutes()),e=d);return e}function Qi(){if(!t){var a=null!==ma;a&&(ma.innerHTML=
...
"side-menu-button-divider-line");a.appendChild(b)}w(a,"ib-arrow-left-full",c.previousDayTooltipText,uj);c.exportEventsEnabled&&c.showExtraToolbarButtons&&(Kh=w(a,"ib-arrow-down-full-line",c.exportEventsTooltipText,function(){Lc(Ua)}));c.showExtraToolbarButtons&&(Lh=w(a,"ib-pin",c.todayTooltipText,vj),w(a,"ib-refresh",c.refreshTooltipText,function(){ta(!0,!0)}),u.enabled&&(Mh=w(a,"ib-search",c.searchTooltipText,Ed)),c.fullScreenModeEnabled&&(Oe=w(a,"ib-arrow-expand-left-right",c.enableFullScreenTooltipText,
...
a=Ma(J);Sb(J,!0)}function vj(){J=new Date;Sb(J,!0)}function Nh(a){var b=Fg(ca);a=Math.floor((a.pageY-b.top)/(ca.offsetHeight/1440))/60;b=Math.floor(a);return[b,Math.round(60*(a-b))]}function xj(a){D(a);if(null===Pd)0===a.dataTransfer.files.length?Rh(a,J.getFullYear(),J.getMonth(),J.getDate()):Sh(a);else{var b=ca.offsetHeight/1440,d=Fg(ca);a=Math.abs(a.pageY)-d.top+Gg;b=(a-Pd.offsetTop)/b;Pd.style.top=a+"px";sc.from=$c(sc.from,b);sc.to=$c(sc.to,b);z("onEventUpdated",sc);sc=Pd=null;Gg=0;ta()}}function Qh(){$e();
...
w(a,"ib-arrow-right-full",c.nextWeekTooltipText,Ej);w(a,"ib-close",c.closeTooltipText,function(){Wa=[];nc(wa)});c.manualEditingEnabled&&c.showExtraToolbarButtons&&w(a,"ib-plus",c.addEventTooltipText,Kc);if(!t){w(a,"ib-hamburger",c.showMenuTooltipText,Cd);var b=k("div","side-menu-button-divider-line");a.appendChild(b)}w(a,"ib-arrow-left-full",c.previousWeekTooltipText,Fj);c.showExtraToolbarButtons&&(c.exportEventsEnabled&&(Wh=w(a,"ib-arrow-down-full-line",c.exportEventsTooltipText,function(){Lc(Wa)})),
w(a,"ib-pin",c.thisWeekTooltipText,Gj),w(a,"ib-refresh",c.refreshTooltipText,function(){ta(!0,!0)}),u.enabled&&(Xh=w(a,"ib-search",c.searchTooltipText,Ed)),c.fullScreenModeEnabled&&(Qe=w(a,"ib-arrow-expand-left-right",c.enableFullScreenTooltipText,eb)));ed=k("div","contents custom-scroll-bars");wa.appendChild(ed)}}function Nc(a,b){b=r(b)?b:!1;Eg(wa);ed.innerHTML=n.empty;fd={};of={};Qd={};Wa=[];Ze=[];Bb=null===a?new Date:new Date(a);b&&(ed.scrollTop=0);var d=a;d=r(d)?d:new Date;var e=0===d.getDay()?
...
"blank"));h=k("div","ib-arrow-expand-left-right-icon");b.appendChild(h);ua(h,c.expandDayTooltipText);h.onclick=function(){Sb(p,!0)};g&&c.showPreviousNextMonthNamesInMainDisplay&&R(b,c.monthNames[d],"month-name"+f,function(){1===a?Fd():Dd()},!0,!0);Hj(p,f,b);c.manualEditingEnabled&&(b.ondblclick=function(){if(c.useTemplateWhenAddingNewEvent){var v=oc(p,p);U(v);pc()}else U(null,p)},nf(b,e,d,a));t&&(b.onclick=q?function(v){D(v);Ve()?da():(v=new Date(p),v.setHours(0,0,0,0),Ec(),Vf(p),z("onDatePickerDateChanged",
v),Ib=v)}:D);c.useOnlyDotEventsForMainDisplay&&b.appendChild(k("div","dots-separator"))}}function Oh(a){var b=null;if(c.showHolidays){for(var d=[],e=[],f=c.holidays.length,g=0;g<f;g++){var h=c.holidays[g],l=C(h.title,n.empty);Zh(h,a)&&l!==n.empty&&e.indexOf(l.toLowerCase())&&(d.push(l),e.push(l.toLowerCase()))}0<d.length&&(b=d.join(", "))}return b}function Hj(a,b,d){if(c.showHolidays)for(var e=[],f=c.holidays.length,g=0;g<f;g++){var h=c.holidays[g],l=C(h.title,n.empty);Zh(h,a)&&l!==n.empty&&e.indexOf(l.toLowerCase())&&
(Ij(h,d,l,b),e.push(l.toLowerCase()))}}function Ij(a,b,d,e){var f=qf(a.onClick)||ja(a.onClickUrl)?"holiday-link":"holiday",g=a.onClick;ja(a.onClickUrl)&&(g=function(){Ga.open(a.onClickUrl,c.urlWindowTarget)});R(b,d,f+e,g,!0,!0)}function Zh(a,b){var d=I(a.day),e=I(a.month),f=I(a.year),g=!1;0===f&&d===b.getDate()&&e===b.getMonth()+1?g=!0:0<f&&d===b.getDate()&&e===b.getMonth()+1&&f===b.getFullYear()&&(g=!0);return g}function zg(a,b,d,e){if(!rf(b)&&c.dragAndDropForEventsEnabled&&c.manualEditingEnabled){var f=
new Date(d),g=0<=c.weekendDays.indexOf(f.getDay())?" drag-not-allowed-weekend-day":" drag-not-allowed";a.setAttribute("draggable",!0);a.ondragstart=function(h){z("onEventDragStart",b);h.dataTransfer.setData("event_details",JSON.stringify(b));gd=f;Y=b;r(e)&&(e.className+=g,Jj(e));sf("cell",function(l){l.className+=" prevent-pointer-events"},a);sf("events",function(l){l.className+=" prevent-pointer-events"},a)};a.ondragend=function(){z("onEventDragStop",Y);Y=gd=null;r(e)&&(e.className=e.className.replace(g,
...
g.dataTransfer.files.length){var h=e,l=new Date(b,d,h);if(null===Y||pa(gd,l))null===Y&&Rh(g,b,d,h);else{g=Y;if(null!==c&&Xa("onEventDragDrop"))c.onEventDragDrop(g,l);r(h)||(l=vd(b,d),h=Y.from.getDate(),h>l&&(h=l));var p=Ob(Y.from,gd);l=Ob(Y.from,Y.to);g=new Date(b,d,h,Y.from.getHours(),Y.from.getMinutes());h=new Date(b,d,h,Y.to.getHours(),Y.to.getMinutes());var q=Y.repeatEnds;0<p&&(g.setDate(g.getDate()-p),h.setDate(h.getDate()-p));r(q)&&(p=Ob(g,Y.from),g>Y.from?q.setDate(q.getDate()+p):q.setDate(q.getDate()-
p));0<l&&h.setDate(h.getDate()+l);qa.updateEventDateTimes(Y.id,g,h,q);ta()}}else Sh(g)}}}function Jj(a){c.dragAndDropForEventsEnabled&&c.manualEditingEnabled&&(a.ondragover=null,a.ondragenter=null,a.ondragleave=null,a.ondrop=null)}function $h(a,b,d){D(a);null===Y||-1!==b.className.indexOf(" drag-over")||pa(gd,d)||(b.className+=" drag-over")}function ai(a,b,d){D(a);null!==Y&&-1<b.className.indexOf(" drag-over")&&!pa(gd,d)&&(b.className=b.className.replace(" drag-over",n.empty))}function Rh(a,b,d,e){a=
Kg(a.dataTransfer.getData("event_details"));if(null!==a){var f=new Date(a.from),g=new Date(a.to);a.from=new Date(b,d,e,f.getHours(),f.getMinutes(),0,0);a.to=new Date(b,d,e,g.getHours(),g.getMinutes(),0,0);qa.addEvent(a)}}function Sh(a){if(r(Ga.FileReader)){var b=new FileReader;b.onload=function(d){qa.addEventsFromJson(d.target.result)};b.readAsText(a.dataTransfer.files[0])}}function Kg(a){try{var b=JSON.parse(a)}catch(d){try{b=eval("("+a+")")}catch(e){console.error("Errors in object: "+d.message+
", "+e.message),b=null}}return b}function $i(){null!==va&&(Ka(B.body,va),pf=Jg=null);va=k("div","calendar-drop-down-menu");B.body.appendChild(va);c.manualEditingEnabled&&(na(va,"ib-plus-icon",c.addEventTitle+"...",function(){if(c.useTemplateWhenAddingNewEvent){var a=oc(tc,tc);U(a);pc()}else U(null,tc)},!0),Ha(va));na(va,"ib-arrow-expand-left-right-icon",c.expandDayTooltipText,function(){Sb(tc,!0)});Ha(va);na(va,"ib-hamburger-side-icon",c.viewWeekEventsText,function(){Nc(tc,!0)});c.manualEditingEnabled&&
(Jg=Ha(va),pf=na(va,"ib-circle-icon",c.pasteText,function(){ug(tc,hb)}))}function aj(){null!==T&&(Ka(B.body,T),tf=uf=Rd=Sd=Td=Ud=Vd=Wd=Xd=Yd=Zd=$d=T=null);T=k("div","calendar-drop-down-menu");B.body.appendChild(T);c.manualEditingEnabled&&(Td=na(T,"ib-plus-icon",c.editEventTitle+"...",function(){U(Pa)},!0),Xd=Ha(T),Wd=na(T,"ib-pipe-icon",c.cutText,function(){Wc();hb=!0;bi(Pa);Wc(!1)}),Vd=Ha(T),Ud=na(T,"ib-circle-hollow-icon",c.copyText,function(){Wc();hb=!1;bi(Pa);Wc(!1)}),Zd=Ha(T),Yd=na(T,"ib-equals-icon",
c.duplicateText+"...",function(){U(Pa);y(Vb,c.addEventTitle);ae.value=c.addText;vf.style.display="none";fa=hd(fa);w(Vb,"ib-close",c.closeTooltipText,id,!0)}),Sd=Ha(T),Rd=na(T,"ib-close-icon",c.removeEventText,function(){vb(B.body,Aa);var a=function(){Ka(B.body,Aa)},b=I(Pa.repeatEvery)>x.never&&null!==be;Je(c.confirmEventRemoveTitle,c.confirmEventRemoveMessage,function(){a();r(Pa.id)&&(He.checked||null===be?qa.removeEvent(Pa.id,!0):(za(Pa.seriesIgnoreDates)?Pa.seriesIgnoreDates.push(be):Pa.seriesIgnoreDates=
[be],ra()),la())},a,b)}),$d=Ha(T));Lg=na(T,"ib-arrow-top-right-icon",c.openUrlText,function(){Mg(Pa.url)});c.exportEventsEnabled&&(uf=Ha(T),tf=na(T,"ib-arrow-down-full-line-icon",c.exportEventsTooltipText+"...",function(){Lc(ya)}))}function bj(){null!==Da&&(Ka(B.body,Da),jf=Bg=Dg=Cg=Da=null);c.manualEditingEnabled&&(Da=k("div","calendar-drop-down-menu"),B.body.appendChild(Da),na(Da,"ib-plus-icon",c.addEventTitle+"...",function(){if(c.useTemplateWhenAddingNewEvent){var a=oc(J,J,hf,hf);U(a);pc()}else U(null,
J,hf)},!0),Cg=Ha(Da),Dg=na(Da,"ib-close-icon",c.removeEventsTooltipText,function(){dg(J,pa)}),Bg=Ha(Da),jf=na(Da,"ib-circle-icon",c.pasteText,function(){ug(J,hb)}))}function cj(){null===Ta&&(Ta=k("div","calendar-drop-down-menu"),B.body.appendChild(Ta),ci=na(Ta,"ib-close-icon",c.hideDayText,function(){c.visibleDays.splice(c.visibleDays.indexOf(di),1);db=!1;z("onOptionsUpdated",c);Z(A,!0,!0)},!0),ei=Ha(Ta),fi=na(Ta,"ib-rhombus-hollow-icon",c.showOnlyWorkingDaysText,function(){1<=c.workingDays.length&&
(c.visibleDays=[].slice.call(c.workingDays),db=!1,z("onOptionsUpdated",c),Z(A,!0,!0))}),gi=Ha(Ta),na(Ta,"ib-octagon-hollow-icon",c.visibleDaysText+"...",Cd))}function na(a,b,d,e,f){f=r(f)?f:!1;var g=k("div","item");a.appendChild(g);g.appendChild(k("div",b));a=k("div","menu-text");y(a,d);g.appendChild(a);f&&(a.className+=" bold");g.onclick=function(){e()};return g}function Ha(a){var b=k("div","separator");a.appendChild(b);return b}function ff(a,b,d){if(null!==T){var e=C(b.url),f=rf(b);aa(a)||xb();
Pa=b;be=r(d)?d:null;1<ya.length?(c.manualEditingEnabled&&(Td.style.display="none",Xd.style.display="none",Wd.style.display="block",Vd.style.display="block",Ud.style.display="block",Zd.style.display="none",Yd.style.display="none",Sd.style.display="none",Rd.style.display="none"),$d.style.display="none",Lg.style.display="none",c.exportEventsEnabled&&(uf.style.display="block",tf.style.display="block")):(f?c.manualEditingEnabled&&(Td.style.display="block",Xd.style.display="none",Wd.style.display="none",
Vd.style.display="none",Ud.style.display="none",Zd.style.display="none",Yd.style.display="none",Sd.style.display="block",Rd.style.display="block",$d.style.display=e!==n.empty?"block":"none"):c.manualEditingEnabled&&(Td.style.display="block",Xd.style.display="block",Wd.style.display="block",Vd.style.display="block",Ud.style.display="block",Zd.style.display="block",Yd.style.display="block",Sd.style.display="block",Rd.style.display="block",$d.style.display=e!==n.empty?"block":"none"),Lg.style.display=
e!==n.empty?"block":"none",c.exportEventsEnabled&&(uf.style.display="none",tf.style.display="none"));if(e!==n.empty||1<T.childElementCount)da(),D(a),Od(a,T)}}function sh(a,b){if(!t){aa(a)||xb();di=b;var d=1<c.visibleDays.length?"block":"none",e=1<=c.workingDays.length?"block":"none";ci.style.display=d;ei.style.display=d;fi.style.display=e;gi.style.display=e;da();D(a);Od(a,Ta)}}function We(a){jd(a)&&(a.style.display="none")}function jd(a){return null!==a&&"block"===a.style.display}function hi(){return jd(va)||
jd(T)||jd(Da)||jd(Ta)||jd($a)}function Ti(){if(!t&&null===Qa){Qa=k("div","calendar-dialog event-editor");B.body.appendChild(Qa);var a=k("div","view");Qa.appendChild(a);wf=k("div","disabled-area");a.appendChild(wf);Vb=k("div","title-bar");a.appendChild(Vb);Fc(Vb,Qa,null);var b=k("div","contents");a.appendChild(b);a=ii(b);kd(a,c.eventText,function(d){ld(d,Db,Qa)},!0);kd(a,c.typeText.replace(":",n.empty),function(d){ld(d,xf,Qa)});kd(a,c.repeatsText.replace(":",n.empty),function(d){ld(d,yf,Qa)});kd(a,
c.optionalText,function(d){ld(d,Wb,Qa)});Db=md(b,!0,!1);xf=md(b,!1,!1);yf=md(b,!1,!1);Wb=md(b,!1,!1);Kj();Lj();Mj();a=k("div","buttons-container");b.appendChild(a);vf=sa(a,c.removeEventText,"remove",Nj);ae=sa(a,c.addText,"add-update",Oj);sa(a,c.cancelText,"cancel",id)}}function Kj(){ka(Db,c.titleText);var a=k("div","input-title-container");Db.appendChild(a);kb=k("input",null,"text");a.appendChild(kb);0<c.maximumEventTitleLength&&(kb.maxLength=c.maximumEventTitleLength);var b=function(){ji(null)};
ki=sa(a,"...","select-colors",Pj,c.selectColorsText);ka(Db,c.fromText.replace(":",n.empty)+"/"+c.toText);a=k("div","split");Db.appendChild(a);lb=k("input");lb.onchange=b;a.appendChild(lb);ub(lb,"date");mb=k("input");a.appendChild(mb);ub(mb,"time");a=k("div","split");Db.appendChild(a);Ia=k("input");Ia.onchange=b;a.appendChild(Ia);ub(Ia,"date");nb=k("input");a.appendChild(nb);ub(nb,"time");nd=M(Db,c.isAllDayText,b)[0];ce=M(Db,c.showAlertsText)[0]}function Lj(){var a=k("div","radio-buttons-container");
yf.appendChild(a);Eb=S(a,c.repeatsNever,"RepeatType",Xb);de=S(a,c.repeatsEveryDayText,"RepeatType",Xb);ee=S(a,c.repeatsEveryWeekText,"RepeatType",Xb);fe=S(a,c.repeatsEvery2WeeksText,"RepeatType",Xb);ge=S(a,c.repeatsEveryMonthText,"RepeatType",Xb);he=S(a,c.repeatsEveryYearText,"RepeatType",Xb);ob=S(a,c.repeatsCustomText,"RepeatType",Xb);zf=sa(a,"...","repeat-options",Qj,c.repeatOptionsTitle);a=k("div","split split-margin");yf.appendChild(a);Yb=k("input",null,"number");Yb.setAttribute("min","1");a.appendChild(Yb);
var b=k("div","radio-buttons-container split-contents");a.appendChild(b);uc=S(b,c.dailyText,"RepeatCustomType");ie=S(b,c.weeklyText,"RepeatCustomType");je=S(b,c.monthlyText,"RepeatCustomType");ke=S(b,c.yearlyText,"RepeatCustomType")}function Mj(){var a=k("div","split");Wb.appendChild(a);ka(a,c.locationText);ka(a,c.groupText);a=k("div","split");Wb.appendChild(a);vc=k("input",null,"text");a.appendChild(vc);0<c.maximumEventLocationLength&&(vc.maxLength=c.maximumEventLocationLength);wc=k("input",null,
...
Qa.style.display="block";kb.focus()}function pc(){kb.focus();kb.select()}function Oj(){var a=mb.value.split(":"),b=nb.value.split(":"),d=yc(kb.value),e=yc(od.value);if(2>a.length)le(c.fromTimeErrorMessage);else if(2>b.length)le(c.toTimeErrorMessage);else if(d===n.empty)le(c.titleErrorMessage);else if(0<e.length&&!mi(e))le(c.urlErrorMessage);else{a=Kd(lb);b=Kd(Ia);var f=yc(xc.value),g=yc(vc.value),h=yc(wc.value),l=Kd(dc,null),p=parseInt(Yb.value);var q=0;for(var v in K)if(K.hasOwnProperty(v)&&r(K[v].eventEditorInput)&&
...
function ne(){wf.style.display="none"}function Ui(){ye();fa.color=Gc.value;fa.colorText=Hc.value;fa.colorBorder=Ic.value}function ye(a){me(a);ne();Kb.style.display="none"}function Pj(){La.push(ye);Kb.style.display="block";Af()}function Vi(){ze();var a=[];Ae.checked&&a.push(1);Be.checked&&a.push(2);Ce.checked&&a.push(3);De.checked&&a.push(4);Ee.checked&&a.push(5);Fe.checked&&a.push(6);Ge.checked&&a.push(0);fa.repeatEveryExcludeDays=a}function ze(a){me(a);ne();Lb.style.display="none"}function Qj(){La.push(ze);
Lb.style.display="block";Af()}function Je(a,b,d,e,f,g){f=r(f)?f:!1;g=r(g)?g:!0;La.push(!1);ec.style.display="block";y(Zf,a);y($f,b);fc.onclick=ni;fc.addEventListener("click",d);gc.onclick=ni;g?(gc.style.display="inline-block",fc.value=c.yesText):(gc.style.display="none",fc.value=c.okText);f?(ag.style.display="block",He.checked=!1):(ag.style.display="none",He.checked=!0);qf(e)&&gc.addEventListener("click",e)}function ni(){La.pop();ec.style.display="none"}function Lc(a){vb(B.body,Aa);La.push(Ie);Mb.style.display=
"block";Fb=a;bg.checked=!0;Fa.value=n.empty;Fa.focus()}function Ie(a){me(a);Ka(B.body,Aa);Mb.style.display="none"}function Wi(){Ie();bg.checked?Gb(Fb,"csv",Fa.value):hh.checked?Gb(Fb,"xml",Fa.value):ih.checked?Gb(Fb,"json",Fa.value):jh.checked?Gb(Fb,"text",Fa.value):kh.checked?Gb(Fb,"ical",Fa.value):lh.checked?Gb(Fb,"md",Fa.value):mh.checked?Gb(Fb,"html",Fa.value):nh.checked&&Gb(Fb,"tsv",Fa.value)}function Xi(){if(!t&&null===ha){ha=k("div","calendar-dialog search");B.body.appendChild(ha);var a=k("div",
"title-bar");y(a,c.searchEventsTitle);ha.appendChild(a);Fc(a,ha,function(){Ng=!0;oe()});a.ondblclick=Og;var b=w(a,"ib-close",c.closeTooltipText,Id);b.onmousedown=D;b.onmouseup=D;zc=w(a,"ib-minus",c.minimizedTooltipText,Og);zc.onmousedown=D;zc.onmouseup=D;pb=k("div","contents");ha.appendChild(pb);a=k("div","history-container");pb.appendChild(a);ba=k("input",null,"text");ba.placeholder=c.searchTextBoxPlaceholder;ba.oninput=pd;ba.onpropertychange=pd;ba.onkeypress=Rj;a.appendChild(ba);qb=k("div","ib-arrow-down-full");
qb.style.display="none";qb.onclick=Sj;a.appendChild(qb);$a=k("div","history-dropdown custom-scroll-bars");a.appendChild($a);a=k("div","checkbox-container");pb.appendChild(a);Bf=M(a,c.notSearchText,rb)[0];Cf=M(a,c.matchCaseText,rb)[0];qd=M(a,c.advancedText+":",Tj)[0];qd.checked=!0;pe=k("div","advanced");pb.appendChild(pe);var d=k("div","split");pe.appendChild(d);b=k("div","split-contents");d.appendChild(b);a=k("div","split-contents");d.appendChild(a);ka(b,c.includeText,"text-header");d=k("div","checkbox-container");
...
$a&&($a.style.display="block",qb.className="ib-arrow-up-full")}function Yi(){if(!t&&null===fb){fb=k("div","calendar-dialog configuration");B.body.appendChild(fb);var a=k("div","title-bar");y(a,c.configurationTitleText);fb.appendChild(a);Fc(a,fb,null);w(a,"ib-close",c.closeTooltipText,wi,!0);a=k("div","contents");fb.appendChild(a);var b=ii(a);kd(b,c.displayTabText,function(d){ld(d,Hb,fb)},!0);kd(b,c.organizerTabText,function(d){ld(d,rd,fb)});Hb=md(a,!0,!1);rd=md(a,!1,!1);fg=M(Hb,c.enableAutoRefreshForEventsText)[0];
...
a.appendChild(b);sa(b,c.updateText,"update",Uj);sa(b,c.cancelText,"cancel",wi)}}function Uj(){fg.checked?qa.startTheAutoRefreshTimer():qa.stopTheAutoRefreshTimer();c.eventNotificationsEnabled=gg.checked;c.tooltipsEnabled=hg.checked;c.dragAndDropForEventsEnabled=ig.checked;c.showDayNamesInMainDisplay=jg.checked;c.showEmptyDaysInWeekView=kg.checked;c.showHolidays=lg.checked;c.organizerName=Re.value;c.organizerEmailAddress=Se.value;db=!1;z("onOptionsUpdated",c);Sg();mg();Z(A,!0,!0)}function wi(){mg()}
function mg(a){me(a);Ka(B.body,Aa);fb.style.display="none"}function ad(a){var b=C(a.group),d=b.toLowerCase();a=I(a.type);var e=!0;b!==n.empty?r(L.visibleGroups)&&(e=-1<L.visibleGroups.indexOf(d)):e=!c.hideEventsWithoutGroupAssigned;e&&r(L.visibleEventTypes)&&K.hasOwnProperty(a)&&(e=-1<L.visibleEventTypes.indexOf(a));return e}function Zi(){null===O&&(O=k("div","calendar-tooltip"),B.body.appendChild(O),Tg=k("div","ib-close"),Mf=k("div","ib-plus"),Nf=k("div","title-buttons"),Nf.appendChild(Tg),Nf.appendChild(Mf),
Ac=k("div","title"),se=k("div","date"),Bc=k("div","duration"),te=k("div","repeats"),ue=k("div","description"),ve=k("div","location"),Cc=k("div","url"),Tg.onclick=Tc,Mf.onclick=function(){U(Md)},document.body.addEventListener("mousemove",Tc))}function Ih(a,b,d,e){D(a);mc(Ca.showToolTip);Tc();e=r(e)?e:!1;"block"!==O.style.display&&c.tooltipsEnabled&&Uc(Ca.showToolTip,function(){if(e||!B.body.contains(Aa)&&!Ve()&&!hi()&&null===Y){d=r(d)?d:n.empty;O.className=d===n.empty?"calendar-tooltip-event":"calendar-tooltip";
if(d!==n.empty)y(O,d);else{O.onmousemove=D;Md=b;O.innerHTML=n.empty;Ac.innerHTML=n.empty;Bc.innerHTML=n.empty;O.appendChild(Nf);O.appendChild(Ac);O.appendChild(se);O.appendChild(Bc);jb(Mf,c.manualEditingEnabled);Oa(b.url)?(y(Cc,Vj(b.url)),vb(O,Cc),Cc.onclick=function(g){D(g);Mg(b.url);Tc()}):(Cc.innerHTML=n.empty,Cc.onclick=null,Ka(O,Cc));if(I(b.repeatEvery)>x.never){var f=k("div","ib-refresh-medium ib-no-hover ib-no-active");f.style.borderColor=Ac.style.color;Ac.appendChild(f)}Ac.innerHTML+=bd(b.title);
...
b,d){d=r(d)?d:!1;var e=B.getElementsByClassName("event");e=[].slice.call(e);for(var f=e.length,g=0;g<f;g++){var h=e[g],l=h.getAttribute("event-id");null!==l&&l===a.toString()&&(h.className=d?h.className.replace(n.space+b,n.empty):h.className+(n.space+b))}}function pj(a,b){Ci(function(){if(Xc(a)&&!Di.hasOwnProperty(b.id)&&(!F(b.showAlerts)||b.showAlerts)){var d=new Date,e=new Date,f=new Date,g=I(b.repeatEvery);d.setHours(b.from.getHours(),b.from.getMinutes(),0,0);e.setHours(b.to.getHours(),b.to.getMinutes(),
0,0);g!==x.never||Xc(b.from)||d.setHours(0,0,0,0);g!==x.never||Xc(b.to)||e.setHours(23,59,59,99);f>=d&&f<=e&&Wj(b)}},!1,b)}function Wj(a){Di[a.id]=!0;(new Notification(c.eventNotificationTitle,{body:c.eventNotificationBody.replace("{0}",a.title)})).onclick=function(){var b=C(a.url);b===n.empty?U(a):Mg(b);z("onNotificationClicked",a)}}function Sg(){Ci(function(){"granted"!==Notification.permission&&Notification.requestPermission()})}function Ci(a,b,d){c.eventNotificationsEnabled&&!t&&(b=r(b)?b:!0,
...
ra(),b&&sb("onRefresh")}function Ch(){return!xi()&&!B.body.contains(Aa)&&!Ve()&&!hi()&&!wd()&&null===Y}function Uc(a,b,d,e){e=r(e)?e:!0;Ug(a)||(cb[a]=e?setInterval(b,d):setTimeout(function(){b();delete cb[a]},d))}function mc(a){Ug(a)&&(clearTimeout(cb[a]),delete cb[a])}function Ug(a){return cb.hasOwnProperty(a)&&null!==cb[a]}function zh(){var a=[],b=[];Sa(function(d){d=C(d.group);d!==n.empty&&-1===b.indexOf(d.toLowerCase())&&(a.push(d),b.push(d.toLowerCase()))});a.sort();return a}function Eg(a){W(a)||
...
[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push("-");var d=Math.floor(16*Math.random()).toString(16);a.push(d)}return a.join(n.empty)}function Vj(a,b){var d=a;b=r(b)?b:30;a.length>b&&(d=0===b%2?b/2:(b-1)/2,d=a.substring(0,d)+"..."+a.substring(a.length-d));return d}function r(a){return void 0!==a&&null!==a&&a!==n.empty}function qf(a){return r(a)&&"function"===typeof a}function ja(a){return r(a)&&"string"===typeof a}function xa(a){return r(a)&&"number"===typeof a}function F(a){return r(a)&&"boolean"===
typeof a}function ac(a){return r(a)&&"object"===typeof a}function za(a){return ac(a)&&a instanceof Array}function Oa(a){return ja(a)&&a!==n.empty}function ud(a){return ac(a)&&a instanceof Date}function bh(a){return ac(a)&&void 0!==a.tagName}function mi(a){return/^(?:(?:(?:https?|ftp):)?\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})))(?::\d{2,5})?(?:[/?#]\S*)?$/i.test(a)}
function m(a,b){return ja(a)?a:b}function H(a,b){return F(a)?a:b}function Ea(a,b){return xa(a)?a:b}function Wg(a,b){return za(a)?a:b}function Xg(a,b){return ud(a)?a:b}function Gb(a,b,d){b=r(b)?b.toLowerCase():"csv";var e=n.empty,f=Nb,g=[];g=r(a)?g.concat(a):Jc();g=Nb(g);a=f(g,!1);if("csv"===b){e=a.length;f=Yg();g=f[0];var h=f[1],l=[];f=[];for(var p=0;p<h;p++)l.push(Fi(g[p]));f.push(l.join(","));for(g=0;g<e;g++){h=f;l=Zg(a[g]);p=l.length;for(var q=0;q<p;q++)l[q]=Fi(l[q]);h.push(l.join(","))}e=f.join("\n")}else if("xml"===
...
c.yesText:c.noText);b.push(C(a.title));b.push(C(a.description));b.push(C(a.location));b.push(C(a.color));b.push(C(a.colorText));b.push(C(a.colorBorder));b.push(cd(a.repeatEvery));b.push(td(a.repeatEnds));b.push(Hi(a.repeatEveryExcludeDays));b.push(Tf(a.seriesIgnoreDates));b.push(td(a.created));b.push(td(a.lastUpdated));b.push(C(a.organizerName));b.push(C(a.organizerEmailAddress));b.push(C(a.url));b.push(a.locked?c.yesText:c.noText);return b}function Qf(a){var b=[],d;for(d in a)a.hasOwnProperty(d)&&
b.push(d);b.sort();return b}function Fi(a){a=a.replace(/(\r\n|\n|\r)/gm,n.empty).replace(/(\s\s)/gm,n.space);a=a.replace(/"/g,'""');return'"'+a+'"'}function Gi(a){return a=a.replace(/\\/g,"\\\\")}function Xa(a){return qf(c[a])}function sb(a){if(null!==c&&Xa(a))c[a]()}function z(a,b){if(null!==c&&Xa(a))c[a](b)}function Dd(a){r(a)&&D(a);if(!t||Ba)a=new Date(A),a.setMonth(a.getMonth()-1),a.getFullYear()>=c.minimumYear&&(Z(a),z("onPreviousMonth",a))}function Fd(a){r(a)&&D(a);if(!t||Ba)a=new Date(A),a.setMonth(a.getMonth()+
...
m(c.exportText,"Export"),xe(c.eventTypeNormalText,"Normal",0),xe(c.eventTypeMeetingText,"Meeting",1),xe(c.eventTypeBirthdayText,"Birthday",2),xe(c.eventTypeHolidayText,"Holiday",3),xe(c.eventTypeTaskText,"Task",4),Sg(),u=Uf(Ki,c.searchOptions),u.enabled=H(u.enabled,!0),u.lastSearchText=m(u.lastSearchText,n.empty),u.not=H(u.not,!1),u.matchCase=H(u.matchCase,!1),u.showAdvanced=H(u.showAdvanced,!1),u.searchTitle=H(u.searchTitle,!0),u.searchLocation=H(u.searchLocation,!1),u.searchDescription=H(u.searchDescription,
