function calendarJs(Ld,Md,Nd){function I(a,d){u=h(a)?a:new Date;d=h(d)?d:!1;u.setDate(1);u.setHours(0,0,0,0);var b=(new Date(u.getFullYear(),u.getMonth(),1)).getDay(),e=Db(u.getFullYear(),u.getMonth());0===b&&(b=7);ta();if(!Eb){A=Ia(Pc);A.className="calendar";A.innerHTML="";Od();Pd();Qd();Rd();var f=g("div","row header-days"),k=c.dayHeaderNames.length;A.appendChild(f);for(var l=0;l<k;l++){var m=c.dayHeaderNames[l],n=g("div","cell");n.innerHTML=m;f.appendChild(n)}for(f=0;6>f;f++)for(k=g("div","row"),
...
!0),b++;b=Db(e.getFullYear(),e.getMonth());b=Math.round(b/2);oc=new Date(e.getFullYear(),e.getMonth(),b)}else oc=null;fa();d&&(null===Q&&(Q=g("div","disabled-background")),null!==ua&&B(r.body,ua),ua=g("div","calendar-dialog event-editor"),r.body.appendChild(ua),b=g("div","view"),ua.appendChild(b),ha=g("div","disabled-area"),b.appendChild(ha),Fb=g("div","title-bar"),b.appendChild(Fb),e=g("div","contents"),b.appendChild(e),b=g("p"),b.innerText=c.titleText,e.appendChild(b),b=g("div","input-title-container"),
e.appendChild(b),va=g("input",null,"text"),b.appendChild(va),f=g("input","select-colors","button"),f.value="...",f.onclick=Td,b.appendChild(f),b=g("p"),b.innerText=c.fromText.replace(":","")+"/"+c.toText,e.appendChild(b),b=g("div","split"),e.appendChild(b),J=g("input"),J.onchange=Gb,b.appendChild(J),wa(J,"date"),R=g("input"),b.appendChild(R),wa(R,"time"),b=g("div","split"),e.appendChild(b),E=g("input"),E.onchange=Gb,b.appendChild(E),wa(E,"date"),S=g("input"),b.appendChild(S),wa(S,"time"),cb=F(e,c.isAllDayText,
Gb)[0],b=g("p"),b.innerText=c.repeatsText,e.appendChild(b),b=g("div","radioButtonsContainer"),e.appendChild(b),xa=T(b,c.repeatsNever,"RepeatType",Ja),Hb=T(b,c.repeatsEveryDayText,"RepeatType",Ja),Ib=T(b,c.repeatsEveryWeekText,"RepeatType",Ja),Jb=T(b,c.repeatsEveryMonthText,"RepeatType",Ja),Kb=T(b,c.repeatsEveryYearText,"RepeatType",Ja),Ka=g("input","days-to-exclude","button"),Ka.value="...",Ka.onclick=Ud,b.appendChild(Ka),b=g("p"),b.innerText=c.locationText,e.appendChild(b),db=g("input",null,"text"),
e.appendChild(db),b=g("p"),b.innerText=c.descriptionText,e.appendChild(b),eb=g("textarea","custom-scroll-bars"),e.appendChild(eb),fb=g("p","error"),e.appendChild(fb),b=g("div","split"),e.appendChild(b),La=g("input","ok","button"),La.value=c.addText,La.onclick=Vd,b.appendChild(La),f=g("input","cancel","button"),f.value=c.cancelText,f.onclick=pc,b.appendChild(f),Ma=g("input","remove","button"),Ma.value=c.removeEventText,Ma.onclick=Wd,e.appendChild(Ma),null!==ia&&B(r.body,ia),ia=g("div","calendar-dialog event-editor-colors"),
r.body.appendChild(ia),e=g("div","title-bar"),e.innerHTML=c.selectColorsText,ia.appendChild(e),e=g("div","contents"),ia.appendChild(e),b=g("p"),b.innerText=c.backgroundColorText,e.appendChild(b),Na=g("input"),e.appendChild(Na),wa(Na,"color"),b=g("p"),b.innerText=c.textColorText,e.appendChild(b),Oa=g("input"),e.appendChild(Oa),wa(Oa,"color"),b=g("p"),b.innerText=c.borderColorText,e.appendChild(b),Pa=g("input"),e.appendChild(Pa),wa(Pa,"color"),b=g("div","split"),e.appendChild(b),e=g("input","ok","button"),
...
ma=g("div","ib-minus"),ma.onclick=ce,e.appendChild(ma),p(ma,c.minimizedTooltipText),K=g("div","contents"),y.appendChild(K),e=g("p"),e.innerText=c.forText,K.appendChild(e),U=g("input",null,"text"),U.oninput=ya,U.onpropertychange=ya,U.onkeypress=de,K.appendChild(U),Yc=F(K,c.matchCaseText,ya)[0],e=g("p"),e.innerText=c.includeText,K.appendChild(e),e=g("div","checkboxContainer"),K.appendChild(e),Zc=F(e,c.titleText.replace(":",""),ya)[0],$c=F(e,c.locationText.replace(":",""),ya)[0],ad=F(e,c.descriptionText.replace(":",
""),ya)[0],e=g("div","split"),K.appendChild(e),Qa=g("input","previous","button"),Qa.value=c.previousText,Qa.onclick=ee,e.appendChild(Qa),za=g("input","next","button"),za.value=c.nextText,za.onclick=bd,e.appendChild(za),r.body.addEventListener("mousemove",fe),null===w&&(w=g("div"),r.body.appendChild(w),uc=g("div","title"),Sb=g("div","date"),ib=g("div","repeats"),jb=g("div","description"),kb=g("div","location"),document.body.addEventListener("mousemove",vc)),ge(),he());lb.innerHTML=c.monthNames[u.getMonth()]+
", "+u.getFullYear()+" \u25be"}function mb(){var a=[];nb(function(d){a.push(d)});return a}function nb(a){for(var d in L)if(L.hasOwnProperty(d))for(var b in L[d])if(L[d].hasOwnProperty(b)){var e=cd(L[d][b]);if(a(e,d,b))return}}function Aa(a,d){d=h(d)?d:!0;a=a.sort(function(b,e){return b.from-e.from});d&&(a=a.sort(function(b,e){return dd(e.isAllDay)-dd(b.isAllDay)}));return a}function Rd(){C=g("div","header-date");A.appendChild(C);c.fullScreenModeEnabled&&(C.ondblclick=function(){Y()});var a=g("div",
...
(Z=g("div","ib-arrow-expand-left-right"),Z.ondblclick=t,C.appendChild(Z),p(Z,c.enableFullScreenTooltipText),Z.onclick=function(){Y()});a=g("div","title-container");C.appendChild(a);lb=g("span");lb.ondblclick=t;a.appendChild(lb);ie(a)}function ie(a){var d=new Date(1900,1,1),b=(new Date).getFullYear()-d.getFullYear()+c.extraSelectableYearsAhead;M=g("div","years-drop-down");a.appendChild(M);Wb=g("div","contents custom-scroll-bars");M.appendChild(Wb);for(a=0;a<b;a++)je(d.getFullYear()),d.setFullYear(d.getFullYear()+
1);lb.onclick=ke}function je(a){var d=g("div");d.innerText=a.toString();d.id="year-selected-"+a.toString();Wb.appendChild(d);d.onclick=function(){u.setFullYear(a);I(u);Xb()&&(M.style.display="none")}}function cd(a){a.isAllDay&&(a.from=new Date(a.from.getFullYear(),a.from.getMonth(),a.from.getDate(),0,0),a.to=new Date(a.from.getFullYear(),a.from.getMonth(),a.from.getDate(),23,59));return a}function pb(a,d){var b=new Date(a.getFullYear(),a.getMonth(),a.getDate()),e=new Date(d.getFullYear(),d.getMonth(),
d.getDate());return Math.ceil(Math.abs(e-b)/864E5)}function ke(a){if("block"!==M.style.display){ta();t(a);a=M.getElementsByClassName("current-year-selected");if(1<=a.length)for(var d=a.length,b=0;b<d;b++)a[b].removeAttribute("class");a=Ia("year-selected-"+u.getFullYear());null!==a&&(a.className="current-year-selected");M.style.display="block";Wb.scrollTop=a.offsetTop-M.offsetHeight/2}}function Xb(){return null!==M&&"block"===M.style.display}function na(a){if(null!==c&&zc(c[a]))c[a]()}function Yb(a,
...
"event-no-hover");sd(b,"plus-x-events")}}function sd(a,d){for(var b=a.getElementsByClassName(d);b[0];)b[0].parentNode.removeChild(b[0])}function ac(a,d,b){h(b)&&b<new Date&&(d.className+=" expired");O(a.color)?(d.style.backgroundColor=a.color,O(a.colorText)&&(d.style.color=a.colorText),O(a.colorBorder)&&(d.style.borderLeftColor=a.colorBorder)):a.isAllDay&&(d.className+=" all-day")}function Dc(a,d){var b=da(a.repeatEvery),e=new Date(a.to);0<b&&(b=new Date(d),b.setHours(e.getHours(),e.getMinutes()),
...
1)}):2===l?cc(k,e,a,function(q){q.setDate(q.getDate()+7)}):3===l?cc(k,e,a,function(q){q.setMonth(q.getMonth()+1)}):4===l&&cc(k,e,a,function(q){q.setFullYear(q.getFullYear()+1)}))});e=Aa(e);b=e.length;for(f=0;f<b;f++)pe(e[f],a);c.exportEventsEnabled&&(Ta.style.display=0===e.length?"none":"inline-block")}function cc(a,d,b,e){for(var f=new Date(a.from),k=V(a.repeatEveryExcludeDays),l=V(a.seriesIgnoreDates);f<b;){e(f);var m=Ca(f);if(-1===k.indexOf(f.getDay())&&-1===l.indexOf(m)&&f.getFullYear()===b.getFullYear()&&
...
vb.onclick=function(){Vb()});c.fullScreenModeEnabled&&(ba=g("div","ib-arrow-expand-left-right"),ba.ondblclick=t,a.appendChild(ba),p(ba,c.enableFullScreenTooltipText),ba.onclick=function(){Y()});wb=g("div","contents custom-scroll-bars");Fa.appendChild(wb)}function fd(a){a=h(a)?a:!1;Hc(Fa);wb.innerHTML="";a&&(wb.scrollTop=0);a=Aa(mb());for(var d=a.length,b=0;b<d;b++){var e=a[b],f=e.from,k="month-"+f.getMonth()+"-"+f.getFullYear(),l=Ia(k);if(null===l){var m=g("div","month");wb.appendChild(m);l=g("div",
...
[];pa=null===a?new Date:a;d&&(yb.scrollTop=0);var b=te(a),e=b[0];b=b[1];ue(e,b);for(var f=Aa(mb()),k=f.length,l=0;l<k;l++){for(var m=f[l],n=pb(m.from,m.to)+1,q=new Date(m.from),Ha=!1,Xa=0;Xa<n;Xa++)q>=e&&q<=b&&(Ha=ud(q),vd(m,Ha,q),Ha=!0),q.setDate(q.getDate()+1);Ha&&xb.push(m);n=da(m.repeatEvery);q=!1;0<n&&(1===n?q=fc(m,e,b,function(P){P.setDate(P.getDate()+1)}):2===n?q=fc(m,e,b,function(P){P.setDate(P.getDate()+7)}):3===n?q=fc(m,e,b,function(P){P.setMonth(P.getMonth()+1)}):4===n&&(q=fc(m,e,b,function(P){P.setFullYear(P.getFullYear()+
...
a.isAllDay?c.allDayText:qb(a.from,a.to):dc(d,a.from,a.to);ub(a.repeatEvery)&&0<a.repeatEvery&&(d=g("div","repeats"),d.innerHTML=c.repeatsText.replace(":","")+" "+Ua(a.repeatEvery),e.appendChild(d));O(a.location)&&(d=g("div","location"),d.innerHTML=a.location,e.appendChild(d));O(a.description)&&(d=g("div","description"),d.innerHTML=a.description,e.appendChild(d));c.manualEditingEnabled&&(e.onclick=function(){oa(a)})}function ud(a){var d=Ec(a),b=a.getFullYear()+a.getMonth()+d;if(Wa.hasOwnProperty(b))a=
Ic[b];else{var e=g("div","day");Wa[b]=e;var f=g("div","header");e.appendChild(f);ec(f,a,c.dayNames[d]+", ");a=g("div","events");e.appendChild(a);Ic[b]=a}return a}function Ec(a){return 0>a.getDay()-1?6:a.getDay()-1}function te(a){a=h(a)?a:new Date;var d=0===a.getDay()?7:a.getDay();d=a.getDate()-d+1;var b=d+6,e=new Date(a);a=new Date(a);e.setDate(d);e.setHours(0,0,0,0);a.setDate(b);a.setHours(23,59,59,99);return[e,a]}function se(){pa.setDate(pa.getDate()-7);ob(pa,!0)}function re(){pa.setDate(pa.getDate()+
7);ob(pa,!0)}function qb(a,d){return Jc(a)+" "+c.toTimeText+" "+Jc(d)}function Jc(a){return H(a.getHours())+":"+H(a.getMinutes())}function dc(a,d,b){a.innerHTML="";var e=g("span");e.innerText=c.startsOnText+" ";a.appendChild(e);Ea(a,d);d=g("span");d.innerText=" "+c.andFinishesOnText+" ";a.appendChild(d);Ea(a,b)}function Ea(a,d,b,e,f){b=h(b)?b:!0;e=h(e)?e:!0;if(f=h(f)?f:!1){f=Ec(d);var k=g("span");k.innerText=c.dayNames[f]+", ";a.appendChild(k)}ec(a,d);f=g("span");f.innerText=" "+c.monthNames[d.getMonth()];
...
else if(23===a||3===a)d=c.rdText;return d}function td(a){for(var d=null,b=[],e=c.holidays.length,f=0;f<e;f++){var k=c.holidays[f];da(k.day)===a.getDate()&&da(k.month)===a.getMonth()+1&&(k=v(k.title,null),null!==k&&b.push(k))}0<b.length&&(d=b.join(", "));return d}function ge(){null!==G&&B(r.body,G);G=g("div","calendar-drop-down-menu");r.body.appendChild(G);if(c.manualEditingEnabled){var a=g("div","item");a.innerHTML=c.addEventTitle;G.appendChild(a);a.onclick=function(){oa(null,gc)};a=g("div","separator");
G.appendChild(a)}a=g("div","item");a.innerHTML=c.expandDayTooltipText;G.appendChild(a);a.onclick=function(){tb(gc,!0)};a=g("div","separator");G.appendChild(a);a=g("div","item");a.innerHTML=c.listWeekEventsTooltipText;G.appendChild(a);a.onclick=function(){ob(gc,!0)}}function he(){null!==N&&B(r.body,N);if(c.manualEditingEnabled){N=g("div","calendar-drop-down-menu");r.body.appendChild(N);var a=g("div","item");a.innerHTML=c.removeEventText;N.appendChild(a);a.onclick=function(){Za(r.body,Q);var d=function(){B(r.body,
Q)},b=0<da(qa.repeatEvery)&&null!==zb;Ad(c.confirmEventRemoveTitle,c.confirmEventRemoveMessage,function(){d();h(qa.id)&&(sc.checked||null===zb?Ya.removeEvent(qa.id,!0):(Bd(qa.seriesIgnoreDates)?qa.seriesIgnoreDates.push(zb):qa.seriesIgnoreDates=[zb],fa()),hc())},d,b)};a=g("div","separator");N.appendChild(a);a=g("div","item");a.innerHTML=c.editEventTitle;N.appendChild(a);a.onclick=function(){oa(qa)}}}function bc(a,d,b){qa=d;zb=h(b)?b:null;ta();t(a);Kc(a,N)}function Ac(){return null!==G&&"block"===
G.style.display}function Bc(){return null!==N&&"block"===N.style.display}function wa(a,d){try{a.type=d}catch(b){a.type="text"}}function Ub(){oa(null,W)}function Ja(){Ka.disabled=xa.checked}function Gb(){var a=!1;cb.checked&&(E.value=J.value,R.value="00:00",S.value="23:59",a=!0);E.disabled=a;R.disabled=a;S.disabled=a;a=ic(J);var d=ic(E);d>a||d<a?(a=!0,xa.checked=!0):a=!1;xa.disabled=a;Hb.disabled=a;Ib.disabled=a;Jb.disabled=a;Kb.disabled=a;Ka.disabled=a;Ja()}function oa(a,d){Za(r.body,Q);if(h(a)){La.value=
c.updateText;Ma.style.display="block";Fb.innerHTML=c.editEventTitle;D=a;J.value=jc(a.from,J.type);R.value=kc(a.from);E.value=jc(a.to,E.type);S.value=kc(a.to);cb.checked=a.isAllDay;va.value=v(a.title);eb.value=v(a.description);db.value=v(a.location);Na.value=v(a.color,"#484848");Oa.value=v(a.colorText,"#F5F5F5");Pa.value=v(a.colorBorder,"#282828");var b=da(a.repeatEvery);0===b?xa.checked=!0:1===b?Hb.checked=!0:2===b?Ib.checked=!0:3===b?Jb.checked=!0:4===b&&(Kb.checked=!0);b=V(a.repeatEveryExcludeDays);
Lb.checked=-1<b.indexOf(1);Mb.checked=-1<b.indexOf(2);Nb.checked=-1<b.indexOf(3);Ob.checked=-1<b.indexOf(4);Pb.checked=-1<b.indexOf(5);Qb.checked=-1<b.indexOf(6);Rb.checked=-1<b.indexOf(0)}else{b=new Date;var e=h(d)?d:b,f=new Date;e.getDate()===f.getDate()&&e.getFullYear()===f.getFullYear()&&e.getMonth()===f.getMonth()&&(e.setHours(b.getHours()),e.setMinutes(b.getMinutes()));La.value=c.addText;Ma.style.display="none";Fb.innerHTML=c.addEventTitle;D={};J.value=jc(e,J.type);R.value=kc(e);E.value=jc(e,
E.type);S.value=kc(e);cb.checked=!1;va.value="";eb.value="";db.value="";Na.value="#484848";Oa.value="#F5F5F5";Pa.value="#282828";xa.checked=!0;Lb.checked=!1;Mb.checked=!1;Nb.checked=!1;Ob.checked=!1;Pb.checked=!1;Qb.checked=!1;Rb.checked=!1}Gb();ua.style.display="block";fb.style.display="none";va.focus()}function Vd(){var a=ic(J),d=ic(E),b=R.value.split(":"),e=S.value.split(":"),f=Lc(va.value),k=Lc(eb.value),l=Lc(db.value);2>b.length?lc(c.fromTimeErrorMessage,R):2>e.length?lc(c.toTimeErrorMessage,
S):""===f?lc(c.titleErrorMessage,va):(Cd(a,R.value),Cd(d,S.value),d<a?lc(c.toSmallerThanFromErrorMessage,E):(pc(),b=h(D.id),a={from:a,to:d,title:f,description:k,location:l,isAllDay:cb.checked,color:D.color,colorText:D.colorText,colorBorder:D.colorBorder,repeatEveryExcludeDays:D.repeatEveryExcludeDays},xa.checked?a.repeatEvery=0:Hb.checked?a.repeatEvery=1:Ib.checked?a.repeatEvery=2:Jb.checked?a.repeatEvery=3:Kb.checked&&(a.repeatEvery=4),b||(a.organizerName=c.organizerName,a.organizerEmailAddress=
...
"number"===typeof d&&(b="repeatEvery"===a?Ua(d):d.toString());return b}function Oc(a){var d=[];d.push(a.getFullYear());d.push(a.getMonth());d.push(a.getDate());d.push("T");d.push(a.getHours());d.push(a.getMinutes());d.push("00");d.push("Z");return d.join("")}function z(a){a=a.replace(/(\r\n|\n|\r)/gm,"").replace(/(\s\s)/gm," ");a=a.replace(/"/g,'""');return'"'+a+'"'}function wc(){var a=new Date(u);a.setMonth(a.getMonth()-1);I(a);na("onPreviousMonth")}function yc(){var a=new Date(u);a.setMonth(a.getMonth()+
1);I(a);na("onNextMonth")}function nd(){var a=new Date(u);a.setFullYear(a.getFullYear()-1);I(a);na("onPreviousYear")}function od(){var a=new Date(u);a.setFullYear(a.getFullYear()+1);I(a);na("onNextYear")}function xc(){var a=new Date;if(u.getMonth()!==a.getMonth()||u.getFullYear()!==a.getFullYear())I(),na("onToday")}var c={},Ya=this,u=null,oc=null,Mc={},bb={},r=null,Ba=null,Pc=null,Eb=!1,kd=!1,L={},Cb=null,x=null,jd=null,Sa=!1,A=null,C=null,lb=null,M=null,Wb=null,Ra=null,Z=null,Q=null,ua=null,ha=null,
Fb=null,J=null,R=null,E=null,S=null,cb=null,va=null,eb=null,db=null,xa=null,Hb=null,Ib=null,Jb=null,Kb=null,Ka=null,fb=null,D={},La=null,Ma=null,ia=null,Na=null,Oa=null,Pa=null,ja=null,Lb=null,Mb=null,Nb=null,Ob=null,Pb=null,Qb=null,Rb=null,Da=null,rb=null,sb=null,W=null,Gc=[],Ta=null,aa=null,Fa=null,vb=null,ba=null,wb=null,Ga=null,X=null,Va=null,ca=null,yb=null,Wa={},Ic={},xb=[],pa=null,ka=null,qc=null,rc=null,sc=null,Sc=null,gb=null,hb=null,la=null,tc=null,Tc=null,Uc=null,Vc=null,Wc=null,$a=null,
w=null,uc=null,Sb=null,ib=null,jb=null,kb=null,sa=null,G=null,gc=null,N=null,qa=null,zb=null,y=null,ma=null,K=null,U=null,Yc=null,Zc=null,$c=null,ad=null,Qa=null,za=null,Bb=!1,Gd=!1,Ed=0,Fd=0,ea=[],ra=0;this.turnOnFullScreen=function(){id()};this.turnOffFullScreen=function(){hd()};this.startTheAutoRefreshTimer=function(){qd()};this.stopTheAutoRefreshTimer=function(){pd()};this.moveToPreviousMonth=function(){wc()};this.moveToNextMonth=function(){yc()};this.moveToPreviousYear=function(){nd()};this.moveToNextYear=
function(){od()};this.moveToToday=function(){xc()};this.getCurrentDisplayDate=function(){return new Date(u)};this.setCurrentDisplayDate=function(a){I(new Date(a));na("onSetDate")};this.exportAllEvents=function(a){c.exportEventsEnabled&&(a=h(a)?a:"csv",ab(null,a))};this.refresh=function(){Tb()};this.addEvents=function(a,d,b){d=h(d)?d:!0;b=h(b)?b:!0;for(var e=a.length,f=0;f<e;f++)this.addEvent(a[f],!1,!1);b&&Yb("onEventAdded",a);d&&fa()};this.addEvent=function(a,d,b){var e=!1;if(a.from<=a.to){var f=
a.from;f=f.getFullYear()+"-"+f.getMonth()+"-"+f.getDate();var k=gd();L.hasOwnProperty(f)||(L[f]={});L[f].hasOwnProperty(k)||(d=h(d)?d:!0,b=h(b)?b:!0,h(a.id)?k=a.id:a.id=k,h(a.created)||(a.created=new Date),L[f][k]=cd(a),e=!0,b&&Yb("onEventAdded",a),d&&fa())}return e};this.updateEvent=function(a,d,b,e){if(a=this.removeEvent(a,!1,!1))b=h(b)?b:!0,e=h(e)?e:!0,d.id=gd(),(a=this.addEvent(d,b,!1))&&e&&Yb("onEventUpdated",d);return a};this.removeEvent=function(a,d,b){var e=!1;nb(function(f,k,l){if(l===a)return d=
h(d)?d:!0,b=h(b)?b:!0,delete L[k][l],e=!0,b&&Yb("onEventRemoved",f),d&&fa(),!0});return e};this.clearEvents=function(a){a=h(a)?a:!0;L={};na("onEventsCleared");a&&fa()};this.getEvents=function(){return Aa(mb())};this.getEvent=function(a){var d=null;nb(function(b,e,f){if(f===a)return d=b,!0});return d};this.setOptions=function(a){c=null!==a&&"object"===typeof a?a:{};h(c.previousMonthTooltipText)||(c.previousMonthTooltipText="Previous Month");h(c.nextMonthTooltipText)||(c.nextMonthTooltipText="Next Month");
h(c.previousDayTooltipText)||(c.previousDayTooltipText="Previous Day");h(c.nextDayTooltipText)||(c.nextDayTooltipText="Next Day");h(c.previousWeekTooltipText)||(c.previousWeekTooltipText="Previous Week");h(c.nextWeekTooltipText)||(c.nextWeekTooltipText="Next Week");h(c.addEventTooltipText)||(c.addEventTooltipText="Add Event");h(c.closeTooltipText)||(c.closeTooltipText="Close");h(c.exportEventsTooltipText)||(c.exportEventsTooltipText="Export Events");h(c.todayTooltipText)||(c.todayTooltipText="Today");
h(c.refreshTooltipText)||(c.refreshTooltipText="Refresh");h(c.searchTooltipText)||(c.searchTooltipText="Search");h(c.expandDayTooltipText)||(c.expandDayTooltipText="Expand Day");h(c.listAllEventsTooltipText)||(c.listAllEventsTooltipText="View All Events");h(c.listWeekEventsTooltipText)||(c.listWeekEventsTooltipText="View Current Week Events");h(c.dayHeaderNames)||(c.dayHeaderNames="Mon Tue Wed Thu Fri Sat Sun".split(" "));h(c.dayNames)||(c.dayNames="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "));
h(c.fromText)||(c.fromText="From:");h(c.toText)||(c.toText="To:");h(c.isAllDayText)||(c.isAllDayText="Is All-Day");h(c.titleText)||(c.titleText="Title:");h(c.descriptionText)||(c.descriptionText="Description:");h(c.locationText)||(c.locationText="Location:");h(c.addText)||(c.addText="Add");h(c.updateText)||(c.updateText="Update");h(c.cancelText)||(c.cancelText="Cancel");h(c.removeEventText)||(c.removeEventText="Remove");h(c.addEventTitle)||(c.addEventTitle="Add Event");h(c.editEventTitle)||(c.editEventTitle=
"Edit Event");h(c.monthNames)||(c.monthNames="January February March April May June July August September October November December".split(" "));h(c.showDayNumberOrdinals)||(c.showDayNumberOrdinals=!0);h(c.dragAndDropForEventsEnabled)||(c.dragAndDropForEventsEnabled=!0);h(c.exportStartFilename)||(c.exportStartFilename="exported_events_");h(c.fromTimeErrorMessage)||(c.fromTimeErrorMessage="Please select a valid 'From' time.");h(c.toTimeErrorMessage)||(c.toTimeErrorMessage="Please select a valid 'To' time.");
h(c.toSmallerThanFromErrorMessage)||(c.toSmallerThanFromErrorMessage="Please select a 'To' date that is larger than the 'From' date.");h(c.titleErrorMessage)||(c.titleErrorMessage="Please enter a value in the 'Title' field (no empty space).");h(c.stText)||(c.stText="st");h(c.ndText)||(c.ndText="nd");h(c.rdText)||(c.rdText="rd");h(c.thText)||(c.thText="th");h(c.maximumEventsPerDayDisplay)||(c.maximumEventsPerDayDisplay=3);h(c.yesText)||(c.yesText="Yes");h(c.noText)||(c.noText="No");h(c.extraSelectableYearsAhead)||
(c.extraSelectableYearsAhead=51);h(c.allDayText)||(c.allDayText="All-Day");h(c.allEventsText)||(c.allEventsText="All Events");h(c.exportEventsEnabled)||(c.exportEventsEnabled=!0);h(c.manualEditingEnabled)||(c.manualEditingEnabled=!0);h(c.showTimesInMainCalendarEvents)||(c.showTimesInMainCalendarEvents=!1);h(c.startsOnText)||(c.startsOnText="Starts on the");h(c.andFinishesOnText)||(c.andFinishesOnText="and finishes on the");h(c.toTimeText)||(c.toTimeText="to");h(c.autoRefreshTimerDelay)||(c.autoRefreshTimerDelay=
5E3);h(c.confirmEventRemoveTitle)||(c.confirmEventRemoveTitle="Confirm Event Removal");h(c.confirmEventRemoveMessage)||(c.confirmEventRemoveMessage="Removing this event cannot be undone.  Do you want to continue?");h(c.okText)||(c.okText="OK");h(c.selectExportTypeTitle)||(c.selectExportTypeTitle="Select Export Type");h(c.fullScreenModeEnabled)||(c.fullScreenModeEnabled=!0);h(c.eventTooltipDelay)||(c.eventTooltipDelay=1E3);h(c.selectColorsText)||(c.selectColorsText="Select Colors");h(c.backgroundColorText)||
(c.backgroundColorText="Background Color:");h(c.textColorText)||(c.textColorText="Text Color:");h(c.borderColorText)||(c.borderColorText="Border Color:");h(c.searchEventsTitle)||(c.searchEventsTitle="Search Events");h(c.forText)||(c.forText="For:");h(c.previousText)||(c.previousText="Previous");h(c.nextText)||(c.nextText="Next");h(c.matchCaseText)||(c.matchCaseText="Match Case");h(c.minimumDayHeight)||(c.minimumDayHeight=0);h(c.repeatsText)||(c.repeatsText="Repeats:");h(c.repeatDaysToExcludeText)||
(c.repeatDaysToExcludeText="Repeat Days To Exclude:");h(c.seriesIgnoreDatesText)||(c.seriesIgnoreDatesText="Series Ignore Dates:");h(c.repeatsNever)||(c.repeatsNever="Never");h(c.repeatsEveryDayText)||(c.repeatsEveryDayText="Every Day");h(c.repeatsEveryWeekText)||(c.repeatsEveryWeekText="Every Week");h(c.repeatsEveryMonthText)||(c.repeatsEveryMonthText="Every Month");h(c.repeatsEveryYearText)||(c.repeatsEveryYearText="Every Year");h(c.selectDaysToExcludeTitle)||(c.selectDaysToExcludeTitle="Select Days To Exclude");
...
h(c.createdText)||(c.createdText="Created:");h(c.organizerName)||(c.organizerName="");h(c.organizerEmailAddress)||(c.organizerEmailAddress="");h(c.organizerNameText)||(c.organizerNameText="Organizer:");h(c.organizerEmailAddressText)||(c.organizerEmailAddressText="Organizer Email:");h(c.enableFullScreenTooltipText)||(c.enableFullScreenTooltipText="Turn On Full-Screen Mode");h(c.disableFullScreenTooltipText)||(c.disableFullScreenTooltipText="Turn Off Full-Screen Mode");h(c.idText)||(c.idText="ID:");
Eb&&(Eb=!1,I(u,!0))};(function(a,d){r=a;Ba=d;Pc=Ld;Ya.setOptions(Md);I(Nd,!0)})(document,window)};