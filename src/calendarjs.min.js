...
Mb)[0],b=g("p"),b.innerText=d.repeatsText,e.appendChild(b),b=g("div","radioButtonsContainer"),e.appendChild(b),Ba=U(b,d.repeatsNever,"RepeatType",Ma),Nb=U(b,d.repeatsEveryDayText,"RepeatType",Ma),Ob=U(b,d.repeatsEveryWeekText,"RepeatType",Ma),Pb=U(b,d.repeatsEveryMonthText,"RepeatType",Ma),Qb=U(b,d.repeatsEveryYearText,"RepeatType",Ma),Na=g("input","repeat-options","button"),Na.value="...",Na.onclick=ce,b.appendChild(Na),b=g("p"),b.innerText=d.locationText,e.appendChild(b),gb=g("input",null,"text"),
e.appendChild(gb),b=g("p"),b.innerText=d.descriptionText,e.appendChild(b),hb=g("textarea","custom-scroll-bars"),e.appendChild(hb),ib=g("p","error"),e.appendChild(ib),b=g("div","split"),e.appendChild(b),Oa=g("input","ok","button"),Oa.value=d.addText,Oa.onclick=de,b.appendChild(Oa),f=g("input","cancel","button"),f.value=d.cancelText,f.onclick=vc,b.appendChild(f),Pa=g("input","remove","button"),Pa.value=d.removeEventText,Pa.onclick=ee,e.appendChild(Pa),null!==ma&&C(q.body,ma),ma=g("div","calendar-dialog event-editor-colors"),
...
K.appendChild(e),gd=H(e,d.titleText.replace(":",""),Da)[0],hd=H(e,d.locationText.replace(":",""),Da)[0],id=H(e,d.descriptionText.replace(":",""),Da)[0],e=g("div","split"),K.appendChild(e),Ta=g("input","previous","button"),Ta.value=d.previousText,Ta.onclick=me,e.appendChild(Ta),Ea=g("input","next","button"),Ea.value=d.nextText,Ea.onclick=jd,e.appendChild(Ea),q.body.addEventListener("mousemove",ne),null===w&&(w=g("div"),q.body.appendChild(w),Ac=g("div","title"),Zb=g("div","date"),lb=g("div","repeats"),
...
f*Bd(b.from);l=fc(b.to,a)?f*Bd(b.to)-k:e;l-=2*d.spacing}c.style.top=k+"px";null!==l&&(c.style.height=l+"px");c.offsetTop+c.offsetHeight>e-d.spacing&&(c.style.height=e-c.offsetTop-3*d.spacing+"px");a=k+ha.offsetHeight/2;a<=ha.offsetHeight&&(a=0);return a}function Bd(a){var c=a.getHours();a=a.getMinutes();return 60*c+a}function xe(){Y.setDate(Y.getDate()-1);Ya(Y,!0)}function we(){Y.setDate(Y.getDate()+1);Ya(Y,!0)}function Xd(){ta=g("div","list-all-events-view");B.appendChild(ta);var a=g("div","title-bar");
...
d.fullScreenModeEnabled&&(ea=g("div","ib-arrow-expand-left-right"),ea.ondblclick=r,ea.onclick=ba,a.appendChild(ea),p(ea,d.enableFullScreenTooltipText));zb=g("div","contents custom-scroll-bars");ta.appendChild(zb)}function nd(a){a=h(a)?a:!1;Oc(ta);zb.innerHTML="";a&&(zb.scrollTop=0);a=Fa(pb());for(var c=a.length,b=0;b<c;b++){var e=a[b],f=Ae(e.from);Be(e,f)}}function Be(a,c){var b=g("div",d.manualEditingEnabled?"event":"event-no-hover");c.appendChild(b);d.manualEditingEnabled&&(b.oncontextmenu=function(f){kc(f,
...
f<=b&&(m=Cd(f),Dd(a,m,f),m=!0)}return m}function Ee(a,c){aa.innerHTML="";if(a.getFullYear()===c.getFullYear()){Ja(aa,a,!1,!1);var b=g("span");b.innerHTML=" - ";aa.appendChild(b);Ja(aa,c,!1,!1);b=g("span");b.innerHTML=", "+a.getFullYear();aa.appendChild(b)}else Ja(aa,a,!1,!0),b=g("span"),b.innerHTML=" - ",aa.appendChild(b),Ja(aa,c,!1,!0)}function Dd(a,c,b){var e=g("div",d.manualEditingEnabled?"event":"event-no-hover");c.appendChild(e);if(d.manualEditingEnabled){var f=Wa(b);e.oncontextmenu=function(k){kc(k,
...
c);f=g("span");f.innerText=" "+d.monthNames[c.getMonth()];a.appendChild(f);e&&(e=g("span"),e.innerText=" "+c.getFullYear(),a.appendChild(e));b&&(b=g("span"),b.innerText=" "+Qc(c),a.appendChild(b))}function oc(a,c,b,e){if(h(b)){var f=g("span");f.innerText=b;a.appendChild(f)}b=g("span");b.innerText=c.getDate();a.appendChild(b);d.showDayNumberOrdinals&&(b=g("sup"),b.innerText=Fd(c.getDate()),a.appendChild(b));h(e)&&(c=g("span"),c.innerText=e,a.appendChild(c))}function tc(a,c,b,e,f){var k=new Date;k=
a===k.getDate()&&e===k.getFullYear()&&b===k.getMonth();var l=La("calendar-day-"+c);c=g("span");var m=new Date(e,b,a);l.innerHTML="";c.className=f?"day-muted":"";c.className+=k?" today":"";c.innerText=a;if(6===m.getDay()||0===m.getDay()&&"cell"===l.className)l.className="cell weekend-day";l.oncontextmenu=function(u){qc=new Date(m);ya();r(u);Rc(u,I)};d.showDayNumberOrdinals&&(f=g("sup"),f.innerText=Fd(a),c.appendChild(f));l.appendChild(c);f=g("div","ib-arrow-top-right");l.appendChild(f);p(f,d.expandDayTooltipText);
k=Ad(m);if(null!==k){var n=g("span","holiday");n.innerText=k;c.appendChild(n)}f.onclick=function(){Ya(m,!0)};d.manualEditingEnabled&&(l.ondblclick=function(){sa(null,m)},d.manualEditingEnabled&&(l.ondragover=function(u){r(u);Gd(l)},l.ondragenter=function(u){r(u);Gd(l)},l.ondragleave=function(u){r(u);Hd(l)},l.ondrop=function(u){r(u);if(null!==x){u=sb(x.from,x.to);var Z=new Date(e,b,a,x.from.getHours(),x.from.getMinutes()),y=new Date(e,b,a,x.to.getHours(),x.to.getMinutes());0<u&&y.setDate(y.getDate()+
u);Cb.updateEvent(x.id,{from:Z,to:y,title:x.title,description:x.description,location:x.location,isAllDay:x.isAllDay,color:x.color,colorText:x.colorText,colorBorder:x.colorBorder,repeatEvery:x.repeatEvery,repeatEveryExcludeDays:x.repeatEveryExcludeDays})}Hd(l)}))}function Gd(a){-1===a.className.indexOf(" drag-over")&&(a.className+=" drag-over")}function Hd(a){-1<a.className.indexOf(" drag-over")&&(a.className=a.className.replace(" drag-over",""))}function Jb(a,c){return(new Date(a,c+1,0)).getDate()}
function Fd(a){var c=d.thText;if(31===a||21===a||1===a)c=d.stText;else if(22===a||2===a)c=d.ndText;else if(23===a||3===a)c=d.rdText;return c}function Ad(a){for(var c=null,b=[],e=d.holidays.length,f=0;f<e;f++){var k=d.holidays[f];W(k.day)===a.getDate()&&W(k.month)===a.getMonth()+1&&(k=v(k.title,null),null!==k&&b.push(k))}0<b.length&&(c=b.join(", "));return c}function oe(){null!==I&&C(q.body,I);I=g("div","calendar-drop-down-menu");q.body.appendChild(I);if(d.manualEditingEnabled){var a=g("div","item");
...
a.getMonth()||t.getFullYear()!==a.getFullYear())J(),ra("onToday")}function Td(a){h(a)&&"object"===typeof a||(a={});return a}var d={},Cb=this,t=null,uc=null,Uc={},eb={},q=null,Ga=null,Xc=null,Kb=!1,sd=!1,M={},Hb=null,x=null,rd=null,Va=!1,B=null,D=null,ob=null,N=null,cc=null,Ua=null,ca=null,R=null,za=null,ka=null,Lb=null,L=null,S=null,G=null,T=null,fb=null,Aa=null,hb=null,gb=null,Ba=null,Nb=null,Ob=null,Pb=null,Qb=null,Na=null,ib=null,F={},Oa=null,Pa=null,ma=null,Qa=null,Ra=null,Sa=null,na=null,Rb=
null,Sb=null,Tb=null,Ub=null,Vb=null,Wb=null,Xb=null,Ca=null,Ha=null,vb=null,ha=null,Ia=null,wb=null,Y=null,Nc=[],Xa=null,da=null,ta=null,yb=null,ea=null,zb=null,Ka=null,aa=null,$a=null,fa=null,Bb=null,ab={},Pc={},Ab=[],ua=null,oa=null,wc=null,xc=null,Yb=null,yc=null,jb=null,kb=null,pa=null,zc=null,$c=null,ad=null,bd=null,cd=null,cb=null,w=null,Ac=null,Zb=null,lb=null,mb=null,nb=null,xa=null,I=null,qc=null,O=null,va=null,Db=null,A=null,qa=null,K=null,V=null,fd=null,gd=null,hd=null,id=null,Ta=null,
