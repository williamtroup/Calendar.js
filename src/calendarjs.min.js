...
N.offsetHeight/2}}function dc(){return null!==N&&"block"===N.style.display}function qa(a){if(null!==d&&Gc(d[a]))d[a]()}function ec(a,b){if(null!==d&&Gc(d[a]))d[a](b)}function pd(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push("-");var c=Math.floor(16*Math.random()).toString(16);a.push(c)}return a.join("")}function aa(){Wa?qd():rd()}function rd(){!Wa&&d.fullScreenModeEnabled&&(sd=A.style.cssText,Wa=!0,ba.className="ib-arrow-contract-left-right",ca.className="ib-arrow-contract-left-right",
da.className="ib-arrow-contract-left-right",ea.className="ib-arrow-contract-left-right",p(ba,d.disableFullScreenTooltipText),p(ca,d.disableFullScreenTooltipText),p(da,d.disableFullScreenTooltipText),p(ea,d.disableFullScreenTooltipText),A.className+=" full-screen-view",A.removeAttribute("style"))}function qd(){Wa&&d.fullScreenModeEnabled&&(Wa=!1,ba.className="ib-arrow-expand-left-right",ca.className="ib-arrow-expand-left-right",da.className="ib-arrow-expand-left-right",ea.className="ib-arrow-expand-left-right",
p(ba,d.enableFullScreenTooltipText),p(ca,d.enableFullScreenTooltipText),p(da,d.enableFullScreenTooltipText),p(ea,d.enableFullScreenTooltipText),A.className=A.className.replace(" full-screen-view",""),A.style.cssText=sd)}function ce(){td||(r.body.addEventListener("click",ya),r.body.addEventListener("contextmenu",ya),Ga.addEventListener("resize",ya),Ga.addEventListener("resize",ud),r.addEventListener("keydown",function(a){Wa&&vd()&&(37===a.keyCode&&(a.ctrlKey||a.metaKey)?(a.preventDefault(),wd()):39===
a.keyCode&&(a.ctrlKey||a.metaKey)?(a.preventDefault(),xd()):70===a.keyCode&&(a.ctrlKey||a.metaKey)?(a.preventDefault(),nd()):27===a.keyCode?aa():37===a.keyCode?Dc():39===a.keyCode?Fc():40===a.keyCode?Ec():116===a.keyCode&&rb())}),td=!0)}function ya(){Hc()&&(I.style.display="none");Ic()&&(O.style.display="none");dc()&&(N.style.display="none");Cc()}function fc(a,b){return a.getDate()===b.getDate()&&a.getMonth()===b.getMonth()&&a.getFullYear()===b.getFullYear()}function Jc(a,b){var c=new Date(a.getFullYear(),
...
a.getDay()-1?6:a.getDay()-1}function ve(a){a=h(a)?a:new Date;var b=0===a.getDay()?7:a.getDay();b=a.getDate()-b+1;var c=b+6,e=new Date(a);a=new Date(a);e.setDate(b);e.setHours(0,0,0,0);a.setDate(c);a.setHours(23,59,59,99);return[e,a]}function ia(){we();yd();for(var a=Fa(pb()),b=a.length,c=0;c<b;c++){var e=a[c];null!==hc(e.from)&&xe(e);var f=W(e.repeatEvery);0<f&&(1===f?ic(e,function(k){k.setDate(k.getDate()+1)}):2===f?ic(e,function(k){k.setDate(k.getDate()+7)}):3===f?ic(e,function(k){k.setMonth(k.getMonth()+
1)}):4===f&&ic(e,function(k){k.setFullYear(k.getFullYear()+1)}))}d.exportEventsEnabled&&(Va.style.display=0===b?"none":"inline-block");zd()}function ic(a,b){for(var c=new Date(a.from),e=X(a.repeatEveryExcludeDays),f=X(a.seriesIgnoreDates);c<vc;){b(c);var k=Xa(c),l=!(!h(a.repeatEnds)||Jc(c,a.repeatEnds));-1!==e.indexOf(c.getDay())||-1!==f.indexOf(k)||l||null!==hc(c)&&Lc(c,a)}}function xe(a){Lc(a.from,a);if(a.from.getDate()!==a.to.getDate()){var b=tb(a.from,a.to);if(0<b)for(var c=new Date(a.from),e=
0;e<b;e++)c.setDate(c.getDate()+1),null!==hc(c)&&Lc(c,a)}}function Lc(a,b){var c=hc(a);if(null!==c){var e=d.manualEditingEnabled?"event":"event-no-hover";if(c.getElementsByClassName(e).length<d.maximumEventsPerDayDisplay||0>=d.maximumEventsPerDayDisplay){e=g("div",e);var f=b.title;d.showTimesInMainCalendarEvents&&!b.isAllDay&&b.from.getDate()===b.to.getDate()&&(f=vb(b.from,b.to)+": "+f);e.innerHTML=f;c.appendChild(e);Ad(e,b);jc(e,b,Mc(b,a));e.onmousemove=function(m){Bd(m,b)};if(d.manualEditingEnabled){var k=
...
Ma("calendar-day-"+(7*a+(b+1)));lc(c,d.manualEditingEnabled?"event":"event-no-hover");lc(c,"plus-x-events")}}function lc(a,b){for(var c=a.getElementsByClassName(b);c[0];)c[0].parentNode.removeChild(c[0])}function jc(a,b,c){h(c)&&c<new Date&&(a.className+=" expired");P(b.color)?(a.style.backgroundColor=b.color,P(b.colorText)&&(a.style.color=b.colorText),P(b.colorBorder)&&(a.style.borderLeftColor=b.colorBorder)):b.isAllDay&&(a.className+=" all-day")}function Mc(a,b){var c=W(a.repeatEvery),e=new Date(a.to);
...
f*Dd(c.from);l=fc(c.to,a)?f*Dd(c.to)-k:e;l-=2*d.spacing}b.style.top=k+"px";null!==l&&(b.style.height=l+"px");b.offsetTop+b.offsetHeight>e-d.spacing&&(b.style.height=e-b.offsetTop-3*d.spacing+"px");a=k+fa.offsetHeight/2;a<=fa.offsetHeight&&(a=0);return a}function Dd(a){var b=a.getHours();a=a.getMinutes();return 60*b+a}function ze(){Y.setDate(Y.getDate()-1);Ha(Y,!0)}function ye(){Y.setDate(Y.getDate()+1);Ha(Y,!0)}function Zd(){ta=g("div","list-all-events-view");A.appendChild(ta);var a=g("div","title-bar");
...
function sb(a,b){b=h(b)?b:!1;Oc(La);Cb.innerHTML="";ab={};Pc={};Bb=[];ua=null===a?new Date:new Date(a);b&&(Cb.scrollTop=0);var c=ve(a),e=c[0];c=c[1];Ge(e,c);He(e,c);for(var f=Fa(pb()),k=f.length,l=0;l<k;l++){for(var m=f[l],n=tb(m.from,m.to)+1,v=new Date(m.from),sa=!1,E=0;E<n;E++)v>=e&&v<=c&&(sa=Qc(v),Ed(m,sa,v),sa=!0),v.setDate(v.getDate()+1);sa&&Bb.push(m);n=W(m.repeatEvery);v=!1;0<n&&(1===n?v=qc(m,e,c,function(Q){Q.setDate(Q.getDate()+1)}):2===n?v=qc(m,e,c,function(Q){Q.setDate(Q.getDate()+7)}):
3===n?v=qc(m,e,c,function(Q){Q.setMonth(Q.getMonth()+1)}):4===n&&(v=qc(m,e,c,function(Q){Q.setFullYear(Q.getFullYear()+1)})));v&&!sa&&Bb.push(m)}for(var Fd in ab)ab.hasOwnProperty(Fd)&&Cb.appendChild(ab[Fd]);d.exportEventsEnabled&&($a.style.display=0===Bb.length?"none":"inline-block")}function qc(a,b,c,e){for(var f=new Date(a.from),k=X(a.repeatEveryExcludeDays),l=X(a.seriesIgnoreDates),m=!1;f<c;){e(f);var n=Xa(f),v=!(!h(a.repeatEnds)||Jc(f,a.repeatEnds));-1===k.indexOf(f.getDay())&&-1===l.indexOf(n)&&
!v&&f>=b&&f<=c&&(m=Qc(f),Ed(a,m,f),m=!0)}return m}function He(a,b){Z.innerHTML="";if(a.getFullYear()===b.getFullYear()){Ka(Z,a,!1,!1);var c=g("span");c.innerHTML=" - ";Z.appendChild(c);Ka(Z,b,!1,!1);c=g("span");c.innerHTML=", "+a.getFullYear();Z.appendChild(c)}else Ka(Z,a,!1,!0),c=g("span"),c.innerHTML=" - ",Z.appendChild(c),Ka(Z,b,!1,!0)}function Ed(a,b,c){lc(b,"no-events-text");var e=g("div",d.manualEditingEnabled?"event":"event-no-hover");b.appendChild(e);if(d.manualEditingEnabled){var f=Xa(c);
e.oncontextmenu=function(k){kc(k,a,f)}}Ad(e,a);jc(e,a,Mc(a,c));b=g("div","title");b.innerHTML=a.title;e.appendChild(b);b=g("div","date");e.appendChild(b);a.from.getDate()===a.to.getDate()?b.innerHTML=a.isAllDay?d.allDayText:vb(a.from,a.to):oc(b,a.from,a.to);yb(a.repeatEvery)&&0<a.repeatEvery&&(b=g("div","repeats"),b.innerHTML=d.repeatsText.replace(":","")+" "+Za(a.repeatEvery),e.appendChild(b));P(a.location)&&(b=g("div","location"),b.innerHTML=a.location,e.appendChild(b));P(a.description)&&(b=g("div",
"description"),b.innerHTML=a.description,e.appendChild(b));d.manualEditingEnabled&&(e.onclick=function(){ra(a)})}function Ge(a,b){var c=new Date(a);do Qc(c),c.setDate(c.getDate()+1);while(c<b)}function Qc(a){var b=Kc(a),c=a.getFullYear()+a.getMonth()+b,e=null,f=new Date(a);if(ab.hasOwnProperty(c))e=Pc[c];else{var k=g("div","day");ab[c]=k;Gd(k,f.getFullYear(),f.getMonth(),f.getDate());e=g("div","header");k.appendChild(e);pc(e,a,d.dayNames[b]+", ");a=g("div","ib-arrow-expand-left-right");a.ondblclick=
q;e.appendChild(a);a.onclick=function(){Ha(f,!0)};p(a,d.expandDayTooltipText);e=g("div","events");k.appendChild(e);k=g("div","no-events-text");k.innerHTML=d.noEventsAvailableText;e.appendChild(k);Pc[c]=e}return e}function Fe(){ua.setDate(ua.getDate()-7);sb(ua,!0)}function Ee(){ua.setDate(ua.getDate()+7);sb(ua,!0)}function vb(a,b){return Rc(a)+" "+d.toTimeText+" "+Rc(b)}function Rc(a){return D(a.getHours())+":"+D(a.getMinutes())}function oc(a,b,c){a.innerHTML="";var e=g("span");e.innerText=d.startsOnText+
" ";a.appendChild(e);Ka(a,b);b=g("span");b.innerText=" "+d.andFinishesOnText+" ";a.appendChild(b);Ka(a,c)}function Ka(a,b,c,e,f){c=h(c)?c:!0;e=h(e)?e:!0;if(f=h(f)?f:!1){f=Kc(b);var k=g("span");k.innerText=d.dayNames[f]+", ";a.appendChild(k)}pc(a,b);f=g("span");f.innerText=" "+d.monthNames[b.getMonth()];a.appendChild(f);e&&(e=g("span"),e.innerText=" "+b.getFullYear(),a.appendChild(e));c&&(c=g("span"),c.innerText=" "+Rc(b),a.appendChild(c))}function pc(a,b,c,e){if(h(c)){var f=g("span");f.innerText=
c;a.appendChild(f)}c=g("span");c.innerText=b.getDate();a.appendChild(c);d.showDayNumberOrdinals&&(c=g("sup"),c.innerText=Hd(b.getDate()),a.appendChild(c));h(e)&&(b=g("span"),b.innerText=e,a.appendChild(b))}function uc(a,b,c,e,f){var k=new Date,l=a===k.getDate()&&e===k.getFullYear()&&c===k.getMonth();b=Ma("calendar-day-"+b);k=g("span");var m=new Date(e,c,a);b.innerHTML="";k.className=f?"day-muted":"";k.className+=l?" today":"";k.innerText=a;if(6===m.getDay()||0===m.getDay()&&"cell"===b.className)b.className=
"cell weekend-day";b.oncontextmenu=function(v){rc=new Date(m);ya();q(v);Sc(v,I)};d.showDayNumberOrdinals&&(f=g("sup"),f.innerText=Hd(a),k.appendChild(f));b.appendChild(k);f=g("div","ib-arrow-top-right");b.appendChild(f);p(f,d.expandDayTooltipText);l=Cd(m);if(null!==l){var n=g("span","holiday");n.innerText=l;k.appendChild(n)}f.onclick=function(){Ha(m,!0)};d.manualEditingEnabled&&(b.ondblclick=function(){ra(null,m)},Gd(b,e,c,a))}function Kb(a,b){return(new Date(a,b+1,0)).getDate()}function Hd(a){var b=
d.thText;if(31===a||21===a||1===a)b=d.stText;else if(22===a||2===a)b=d.ndText;else if(23===a||3===a)b=d.rdText;return b}function Cd(a){for(var b=null,c=[],e=d.holidays.length,f=0;f<e;f++){var k=d.holidays[f];W(k.day)===a.getDate()&&W(k.month)===a.getMonth()+1&&(k=u(k.title,null),null!==k&&c.push(k))}0<c.length&&(b=c.join(", "));return b}function Ad(a,b){d.dragAndDropForEventsEnabled&&d.manualEditingEnabled&&(a.setAttribute("draggable",!0),a.ondragstart=function(){x=b})}function Gd(a,b,c,e){d.dragAndDropForEventsEnabled&&
d.manualEditingEnabled&&(a.ondragover=function(f){q(f);Id(a)},a.ondragenter=function(f){q(f);Id(a)},a.ondragleave=function(f){q(f);Jd(a)},a.ondrop=function(f){q(f);if(null!==x){f=tb(x.from,x.to);var k=new Date(b,c,e,x.from.getHours(),x.from.getMinutes()),l=new Date(b,c,e,x.to.getHours(),x.to.getMinutes());0<f&&l.setDate(l.getDate()+f);Db.updateEvent(x.id,{from:k,to:l,title:x.title,description:x.description,location:x.location,isAllDay:x.isAllDay,color:x.color,colorText:x.colorText,colorBorder:x.colorBorder,
...
g("div","separator");I.appendChild(a)}a=g("div","item");a.innerHTML=d.expandDayTooltipText;I.appendChild(a);a.onclick=function(){Ha(rc,!0)};a=g("div","separator");I.appendChild(a);a=g("div","item");a.innerHTML=d.listWeekEventsTooltipText;I.appendChild(a);a.onclick=function(){sb(rc,!0)}}function re(){null!==O&&B(r.body,O);if(d.manualEditingEnabled){O=g("div","calendar-drop-down-menu");r.body.appendChild(O);var a=g("div","item");a.innerHTML=d.removeEventText;O.appendChild(a);a.onclick=function(){bb(r.body,
...
!1,Nd=0,Od=0,ha=[],wa=0;this.turnOnFullScreen=function(){rd()};this.turnOffFullScreen=function(){qd()};this.startTheAutoRefreshTimer=function(){zd()};this.stopTheAutoRefreshTimer=function(){yd()};this.moveToPreviousMonth=function(){Dc()};this.moveToNextMonth=function(){Fc()};this.moveToPreviousYear=function(){wd()};this.moveToNextYear=function(){xd()};this.moveToToday=function(){Ec()};this.getCurrentDisplayDate=function(){return new Date(t)};this.setCurrentDisplayDate=function(a){J(new Date(a));qa("onSetDate")};
...
(d.expandMonthTooltipText="Expand Month");h(d.repeatEndsText)||(d.repeatEndsText="Repeat Ends:");h(d.noEventsAvailableText)||(d.noEventsAvailableText="No events available");J(Yd,!0)})(document,window)};