...
d.dayNames[f]+", ";a.appendChild(k)}oc(a,c);f=g("span");f.innerText=" "+d.monthNames[c.getMonth()];a.appendChild(f);e&&(e=g("span"),e.innerText=" "+c.getFullYear(),a.appendChild(e));b&&(b=g("span"),b.innerText=" "+Qc(c),a.appendChild(b))}function oc(a,c,b,e){if(h(b)){var f=g("span");f.innerText=b;a.appendChild(f)}b=g("span");b.innerText=c.getDate();a.appendChild(b);d.showDayNumberOrdinals&&(b=g("sup"),b.innerText=Fd(c.getDate()),a.appendChild(b));h(e)&&(c=g("span"),c.innerText=e,a.appendChild(c))}
function tc(a,c,b,e,f){var k=new Date;k=a===k.getDate()&&e===k.getFullYear()&&b===k.getMonth();var l=La("calendar-day-"+c);c=g("span");var m=new Date(e,b,a);l.innerHTML="";c.className=f?"day-muted":"";c.className+=k?" today":"";c.innerText=a;if(6===m.getDay()||0===m.getDay()&&"cell"===l.className)l.className="cell weekend-day";l.oncontextmenu=function(u){qc=new Date(m);ya();r(u);Rc(u,I)};d.showDayNumberOrdinals&&(f=g("sup"),f.innerText=Fd(a),c.appendChild(f));l.appendChild(c);f=g("div","ib-arrow-top-right");
l.appendChild(f);p(f,d.expandDayTooltipText);k=Ad(m);if(null!==k){var n=g("span","holiday");n.innerText=k;c.appendChild(n)}f.onclick=function(){Ya(m,!0)};d.manualEditingEnabled&&(l.ondblclick=function(){sa(null,m)},d.manualEditingEnabled&&(l.ondragover=function(u){r(u);Gd(l)},l.ondragenter=function(u){r(u);Gd(l)},l.ondragleave=function(u){r(u);Hd(l)},l.ondrop=function(u){r(u);if(null!==x){u=sb(x.from,x.to);var Z=new Date(e,b,a,x.from.getHours(),x.from.getMinutes()),y=new Date(e,b,a,x.to.getHours(),
x.to.getMinutes());0<u&&y.setDate(y.getDate()+u);Cb.updateEvent(x.id,{from:Z,to:y,title:x.title,description:x.description,location:x.location,isAllDay:x.isAllDay,color:x.color,colorText:x.colorText,colorBorder:x.colorBorder,repeatEvery:x.repeatEvery,repeatEveryExcludeDays:x.repeatEveryExcludeDays})}Hd(l)}))}function Gd(a){-1===a.className.indexOf(" drag-over")&&(a.className+=" drag-over")}function Hd(a){-1<a.className.indexOf(" drag-over")&&(a.className=a.className.replace(" drag-over",""))}function Jb(a,
c){return(new Date(a,c+1,0)).getDate()}function Fd(a){var c=d.thText;if(31===a||21===a||1===a)c=d.stText;else if(22===a||2===a)c=d.ndText;else if(23===a||3===a)c=d.rdText;return c}function Ad(a){for(var c=null,b=[],e=d.holidays.length,f=0;f<e;f++){var k=d.holidays[f];W(k.day)===a.getDate()&&W(k.month)===a.getMonth()+1&&(k=v(k.title,null),null!==k&&b.push(k))}0<b.length&&(c=b.join(", "));return c}function oe(){null!==I&&C(q.body,I);I=g("div","calendar-drop-down-menu");q.body.appendChild(I);if(d.manualEditingEnabled){var a=
g("div","item");a.innerHTML=d.addEventTitle;I.appendChild(a);a.onclick=function(){sa(null,qc)};a=g("div","separator");I.appendChild(a)}a=g("div","item");a.innerHTML=d.expandDayTooltipText;I.appendChild(a);a.onclick=function(){Ya(qc,!0)};a=g("div","separator");I.appendChild(a);a=g("div","item");a.innerHTML=d.listWeekEventsTooltipText;I.appendChild(a);a.onclick=function(){rb(qc,!0)}}function pe(){null!==O&&C(q.body,O);if(d.manualEditingEnabled){O=g("div","calendar-drop-down-menu");q.body.appendChild(O);
var a=g("div","item");a.innerHTML=d.removeEventText;O.appendChild(a);a.onclick=function(){bb(q.body,R);var c=function(){C(q.body,R)},b=0<W(va.repeatEvery)&&null!==Db;Id(d.confirmEventRemoveTitle,d.confirmEventRemoveMessage,function(){c();h(va.id)&&(Yb.checked||null===Db?Cb.removeEvent(va.id,!0):(Sc(va.seriesIgnoreDates)?va.seriesIgnoreDates.push(Db):va.seriesIgnoreDates=[Db],ja()),rc())},c,b)};a=g("div","separator");O.appendChild(a);a=g("div","item");a.innerHTML=d.editEventTitle;O.appendChild(a);
a.onclick=function(){sa(va)}}}function kc(a,c,b){va=c;Db=h(b)?b:null;ya();r(a);Rc(a,O)}function Gc(){return null!==I&&"block"===I.style.display}function Hc(){return null!==O&&"block"===O.style.display}function la(a,c){try{a.type=c}catch(b){a.type="text"}}function ac(){sa(null,Y)}function Ma(){Na.disabled=Ba.checked}function Mb(){var a=!1;fb.checked&&(G.value=L.value,S.value="00:00",T.value="23:59",a=!0);G.disabled=a;S.disabled=a;T.disabled=a;a=Eb(L);var c=Eb(G);c>a||c<a?(a=!0,Ba.checked=!0):a=!1;
Ba.disabled=a;Nb.disabled=a;Ob.disabled=a;Pb.disabled=a;Qb.disabled=a;Na.disabled=a;Ma()}function sa(a,c){bb(q.body,R);if(h(a)){Oa.value=d.updateText;Pa.style.display="block";Lb.innerHTML=d.editEventTitle;F=a;L.value=tb(a.from,L.type);S.value=gc(a.from);G.value=tb(a.to,G.type);T.value=gc(a.to);fb.checked=a.isAllDay;Aa.value=v(a.title);hb.value=v(a.description);gb.value=v(a.location);Qa.value=v(a.color,"#484848");Ra.value=v(a.colorText,"#F5F5F5");Sa.value=v(a.colorBorder,"#282828");var b=W(a.repeatEvery);
0===b?Ba.checked=!0:1===b?Nb.checked=!0:2===b?Ob.checked=!0:3===b?Pb.checked=!0:4===b&&(Qb.checked=!0);b=X(a.repeatEveryExcludeDays);Rb.checked=-1<b.indexOf(1);Sb.checked=-1<b.indexOf(2);Tb.checked=-1<b.indexOf(3);Ub.checked=-1<b.indexOf(4);Vb.checked=-1<b.indexOf(5);Wb.checked=-1<b.indexOf(6);Xb.checked=-1<b.indexOf(0);Ca.value=tb(a.repeatEnds,Ca.type)}else{b=new Date;var e=h(c)?c:b,f=new Date;e.getDate()===f.getDate()&&e.getFullYear()===f.getFullYear()&&e.getMonth()===f.getMonth()&&(e.setHours(b.getHours()),
e.setMinutes(b.getMinutes()));Oa.value=d.addText;Pa.style.display="none";Lb.innerHTML=d.addEventTitle;F={};L.value=tb(e,L.type);S.value=gc(e);G.value=tb(e,G.type);T.value=gc(e);fb.checked=!1;Aa.value="";hb.value="";gb.value="";Qa.value="#484848";Ra.value="#F5F5F5";Sa.value="#282828";Ba.checked=!0;Rb.checked=!1;Sb.checked=!1;Tb.checked=!1;Ub.checked=!1;Vb.checked=!1;Wb.checked=!1;Xb.checked=!1;Ca.value=null}Mb();za.style.display="block";ib.style.display="none";Aa.focus()}function de(){var a=Eb(L),
...
V.value;ia=[];wa=0}function md(){"block"!==A.style.display&&(ia=[],A.style.display="block",V.value="",td(),Da());"block"!==K.style.display&&ed();V.focus()}function td(){Nd||(A.style.left=Ga.innerWidth/2-A.offsetWidth/2+"px",A.style.top=Ga.innerHeight/2-A.offsetHeight/2+"px")}function ke(){A.style.display="none"}function ed(){"block"===K.style.display?(K.style.display="none",qa.className="ib-square-hollow",p(qa,d.restoreTooltipText)):(K.style.display="block",qa.className="ib-minus",p(qa,d.minimizedTooltipText))}
