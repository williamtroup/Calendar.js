...
for(a=0;24>a;a++){b=g("div","hour");xb.appendChild(b);var c=g("div","hour-text");c.innerHTML=D(a)+":00";b.appendChild(c);c=g("div","hour-text");c.innerHTML=D(a)+":30";b.appendChild(c)}}function Ha(a,b){b=h(b)?b:!1;wb.innerText="";Y=new Date(a);Nc=[];Ja.style.display="block";lc(fa,d.manualEditingEnabled?"event":"event-no-hover");Oc(Ia);Ka(wb,a,!1,!0,!0);var c=Ed(a),e=[];if(null!==c){var f=g("span","holiday");f.innerText=" ("+c+")";wb.appendChild(f)}qb(function(m){for(var n=tb(m.from,m.to)+1,v=new Date(m.from),
...
d.fullScreenModeEnabled&&(ea=g("div","ib-arrow-expand-left-right"),ea.ondblclick=q,ea.onclick=aa,a.appendChild(ea),p(ea,d.enableFullScreenTooltipText));Cb=g("div","contents custom-scroll-bars");La.appendChild(Cb)}function sb(a,b){b=h(b)?b:!1;Oc(La);Cb.innerHTML="";ab={};Pc={};Bb=[];ua=null===a?new Date:new Date(a);b&&(Cb.scrollTop=0);var c=ve(a),e=c[0];c=c[1];Ge(e,c);He(e,c);for(var f=Fa(pb()),k=f.length,l=0;l<k;l++){for(var m=f[l],n=tb(m.from,m.to)+1,v=new Date(m.from),sa=!1,E=0;E<n;E++)v>=e&&v<=
