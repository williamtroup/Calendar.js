function calendarJs(Ld,Md,Nd){function I(a,d){u=h(a)?a:new Date;d=h(d)?d:!1;u.setDate(1);u.setHours(0,0,0,0);var b=(new Date(u.getFullYear(),u.getMonth(),1)).getDay(),e=Db(u.getFullYear(),u.getMonth());0===b&&(b=7);sa();if(!Eb){A=Ia(Pc);A.className="calendar";A.innerHTML="";Od();Pd();Qd();Rd();var f=g("div","row header-days"),k=c.dayHeaderNames.length;A.appendChild(f);for(var l=0;l<k;l++){var m=c.dayHeaderNames[l],n=g("div","cell");n.innerHTML=m;f.appendChild(n)}for(f=0;6>f;f++)for(k=g("div","row"),
...
ma=g("div","ib-minus"),ma.onclick=ce,e.appendChild(ma),p(ma,c.minimizedTooltipText),K=g("div","contents"),y.appendChild(K),e=g("p"),e.innerText=c.forText,K.appendChild(e),U=g("input",null,"text"),U.oninput=xa,U.onpropertychange=xa,U.onkeypress=de,K.appendChild(U),Yc=F(K,c.matchCaseText,xa)[0],e=g("p"),e.innerText=c.includeText,K.appendChild(e),e=g("div","checkboxContainer"),K.appendChild(e),Zc=F(e,c.titleText.replace(":",""),xa)[0],$c=F(e,c.locationText.replace(":",""),xa)[0],ad=F(e,c.descriptionText.replace(":",
""),xa)[0],e=g("div","split"),K.appendChild(e),Qa=g("input","previous","button"),Qa.value=c.previousText,Qa.onclick=ee,e.appendChild(Qa),ya=g("input","next","button"),ya.value=c.nextText,ya.onclick=bd,e.appendChild(ya),r.body.addEventListener("mousemove",fe),null===w&&(w=g("div"),r.body.appendChild(w),uc=g("div","title"),Sb=g("div","date"),ib=g("div","repeats"),jb=g("div","description"),kb=g("div","location"),document.body.addEventListener("mousemove",vc)),ge(),he());lb.innerHTML=c.monthNames[u.getMonth()]+
", "+u.getFullYear()+" \u25be"}function mb(){var a=[];nb(function(d){a.push(d)});return a}function nb(a){for(var d in L)if(L.hasOwnProperty(d))for(var b in L[d])if(L[d].hasOwnProperty(b)){var e=cd(L[d][b]);if(a(e,d,b))return}}function za(a,d){d=h(d)?d:!0;a=a.sort(function(b,e){return b.from-e.from});d&&(a=a.sort(function(b,e){return dd(e.isAllDay)-dd(b.isAllDay)}));return a}function Rd(){C=g("div","header-date");A.appendChild(C);c.fullScreenModeEnabled&&(C.ondblclick=function(){Y()});var a=g("div",
...
d.getDate());return Math.ceil(Math.abs(e-b)/864E5)}function ke(a){if("block"!==M.style.display){sa();t(a);a=M.getElementsByClassName("current-year-selected");if(1<=a.length)for(var d=a.length,b=0;b<d;b++)a[b].removeAttribute("class");a=Ia("year-selected-"+u.getFullYear());null!==a&&(a.className="current-year-selected");M.style.display="block";Wb.scrollTop=a.offsetTop-M.offsetHeight/2}}function Xb(){return null!==M&&"block"===M.style.display}function Aa(a){if(null!==c&&zc(c[a]))c[a]()}function Yb(a,
...
Y():37===a.keyCode?wc():39===a.keyCode?yc():40===a.keyCode?xc():116===a.keyCode&&Tb())}),kd=!0)}function sa(){Ac()&&(G.style.display="none");Bc()&&(N.style.display="none");Xb()&&(M.style.display="none");vc()}function fa(){le();pd();for(var a=za(mb()),d=a.length,b=0;b<d;b++){var e=a[b];null!==Zb(e.from)&&me(e);var f=da(e.repeatEvery);0<f&&(1===f?$b(e,function(k){k.setDate(k.getDate()+1)}):2===f?$b(e,function(k){k.setDate(k.getDate()+7)}):3===f?$b(e,function(k){k.setMonth(k.getMonth()+1)}):4===f&&$b(e,
...
[];oa=null===a?new Date:a;d&&(yb.scrollTop=0);var b=te(a),e=b[0];b=b[1];ue(e,b);for(var f=za(mb()),k=f.length,l=0;l<k;l++){for(var m=f[l],n=pb(m.from,m.to)+1,q=new Date(m.from),Ha=!1,Xa=0;Xa<n;Xa++)q>=e&&q<=b&&(Ha=ud(q),vd(m,Ha,q),Ha=!0),q.setDate(q.getDate()+1);Ha&&xb.push(m);n=da(m.repeatEvery);q=!1;0<n&&(1===n?q=fc(m,e,b,function(P){P.setDate(P.getDate()+1)}):2===n?q=fc(m,e,b,function(P){P.setDate(P.getDate()+7)}):3===n?q=fc(m,e,b,function(P){P.setMonth(P.getMonth()+1)}):4===n&&(q=fc(m,e,b,function(P){P.setFullYear(P.getFullYear()+
...
a.isAllDay?c.allDayText:qb(a.from,a.to):dc(d,a.from,a.to);ub(a.repeatEvery)&&0<a.repeatEvery&&(d=g("div","repeats"),d.innerHTML=c.repeatsText.replace(":","")+" "+Ua(a.repeatEvery),e.appendChild(d));O(a.location)&&(d=g("div","location"),d.innerHTML=a.location,e.appendChild(d));O(a.description)&&(d=g("div","description"),d.innerHTML=a.description,e.appendChild(d));c.manualEditingEnabled&&(e.onclick=function(){na(a)})}function ud(a){var d=Ec(a),b=a.getFullYear()+a.getMonth()+d;if(Wa.hasOwnProperty(b))a=
...
Q)},b=0<da(pa.repeatEvery)&&null!==zb;Ad(c.confirmEventRemoveTitle,c.confirmEventRemoveMessage,function(){d();h(pa.id)&&(sc.checked||null===zb?Ya.removeEvent(pa.id,!0):(Bd(pa.seriesIgnoreDates)?pa.seriesIgnoreDates.push(zb):pa.seriesIgnoreDates=[zb],fa()),hc())},d,b)};a=g("div","separator");N.appendChild(a);a=g("div","item");a.innerHTML=c.editEventTitle;N.appendChild(a);a.onclick=function(){na(pa)}}}function bc(a,d,b){pa=d;zb=h(b)?b:null;sa();t(a);Kc(a,N)}function Ac(){return null!==G&&"block"===
G.style.display}function Bc(){return null!==N&&"block"===N.style.display}function va(a,d){try{a.type=d}catch(b){a.type="text"}}function Ub(){na(null,W)}function Ja(){Ka.disabled=wa.checked}function Gb(){var a=!1;cb.checked&&(E.value=J.value,R.value="00:00",S.value="23:59",a=!0);E.disabled=a;R.disabled=a;S.disabled=a;a=ic(J);var d=ic(E);d>a||d<a?(a=!0,wa.checked=!0):a=!1;wa.disabled=a;Hb.disabled=a;Ib.disabled=a;Jb.disabled=a;Kb.disabled=a;Ka.disabled=a;Ja()}function na(a,d){Za(r.body,Q);if(h(a)){La.value=
c.updateText;Ma.style.display="block";Fb.innerHTML=c.editEventTitle;D=a;J.value=jc(a.from,J.type);R.value=kc(a.from);E.value=jc(a.to,E.type);S.value=kc(a.to);cb.checked=a.isAllDay;ua.value=v(a.title);eb.value=v(a.description);db.value=v(a.location);Na.value=v(a.color,"#484848");Oa.value=v(a.colorText,"#F5F5F5");Pa.value=v(a.colorBorder,"#282828");var b=da(a.repeatEvery);0===b?wa.checked=!0:1===b?Hb.checked=!0:2===b?Ib.checked=!0:3===b?Jb.checked=!0:4===b&&(Kb.checked=!0);b=V(a.repeatEveryExcludeDays);
...
E.type);S.value=kc(e);cb.checked=!1;ua.value="";eb.value="";db.value="";Na.value="#484848";Oa.value="#F5F5F5";Pa.value="#282828";wa.checked=!0;Lb.checked=!1;Mb.checked=!1;Nb.checked=!1;Ob.checked=!1;Pb.checked=!1;Qb.checked=!1;Rb.checked=!1}Gb();ta.style.display="block";fb.style.display="none";ua.focus()}function Vd(){var a=ic(J),d=ic(E),b=R.value.split(":"),e=S.value.split(":"),f=Lc(ua.value),k=Lc(eb.value),l=Lc(db.value);2>b.length?lc(c.fromTimeErrorMessage,R):2>e.length?lc(c.toTimeErrorMessage,
...
"number"===typeof d&&(b="repeatEvery"===a?Ua(d):d.toString());return b}function Oc(a){var d=[];d.push(a.getFullYear());d.push(a.getMonth());d.push(a.getDate());d.push("T");d.push(a.getHours());d.push(a.getMinutes());d.push("00");d.push("Z");return d.join("")}function z(a){a=a.replace(/(\r\n|\n|\r)/gm,"").replace(/(\s\s)/gm," ");a=a.replace(/"/g,'""');return'"'+a+'"'}function wc(){var a=new Date(u);a.setMonth(a.getMonth()-1);I(a);Aa("onPreviousMonth")}function yc(){var a=new Date(u);a.setMonth(a.getMonth()+
1);I(a);Aa("onNextMonth")}function nd(){var a=new Date(u);a.setFullYear(a.getFullYear()-1);I(a);Aa("onPreviousYear")}function od(){var a=new Date(u);a.setFullYear(a.getFullYear()+1);I(a);Aa("onNextYear")}function xc(){var a=new Date;if(u.getMonth()!==a.getMonth()||u.getFullYear()!==a.getFullYear())I(),Aa("onToday")}var c={},Ya=this,u=null,oc=null,Mc={},bb={},r=null,Ba=null,Pc=null,Eb=!1,kd=!1,L={},Cb=null,x=null,jd=null,Sa=!1,A=null,C=null,lb=null,M=null,Wb=null,Ra=null,Z=null,Q=null,ta=null,ha=null,
Fb=null,J=null,R=null,E=null,S=null,cb=null,ua=null,eb=null,db=null,wa=null,Hb=null,Ib=null,Jb=null,Kb=null,Ka=null,fb=null,D={},La=null,Ma=null,ia=null,Na=null,Oa=null,Pa=null,ja=null,Lb=null,Mb=null,Nb=null,Ob=null,Pb=null,Qb=null,Rb=null,Da=null,rb=null,sb=null,W=null,Gc=[],Ta=null,aa=null,Fa=null,vb=null,ba=null,wb=null,Ga=null,X=null,Va=null,ca=null,yb=null,Wa={},Ic={},xb=[],oa=null,ka=null,qc=null,rc=null,sc=null,Sc=null,gb=null,hb=null,la=null,tc=null,Tc=null,Uc=null,Vc=null,Wc=null,$a=null,
w=null,uc=null,Sb=null,ib=null,jb=null,kb=null,ra=null,G=null,gc=null,N=null,pa=null,zb=null,y=null,ma=null,K=null,U=null,Yc=null,Zc=null,$c=null,ad=null,Qa=null,ya=null,Bb=!1,Gd=!1,Ed=0,Fd=0,ea=[],qa=0;this.turnOnFullScreen=function(){id()};this.turnOffFullScreen=function(){hd()};this.startTheAutoRefreshTimer=function(){qd()};this.stopTheAutoRefreshTimer=function(){pd()};this.moveToPreviousMonth=function(){wc()};this.moveToNextMonth=function(){yc()};this.moveToPreviousYear=function(){nd()};this.moveToNextYear=
function(){od()};this.moveToToday=function(){xc()};this.getCurrentDisplayDate=function(){return new Date(u)};this.setCurrentDisplayDate=function(a){I(new Date(a))};this.exportAllEvents=function(a){c.exportEventsEnabled&&(a=h(a)?a:"csv",ab(null,a))};this.refresh=function(){Tb()};this.addEvents=function(a,d,b){d=h(d)?d:!0;b=h(b)?b:!0;for(var e=a.length,f=0;f<e;f++)this.addEvent(a[f],!1,!1);b&&Yb("onEventAdded",a);d&&fa()};this.addEvent=function(a,d,b){var e=!1;if(a.from<=a.to){var f=a.from;f=f.getFullYear()+
"-"+f.getMonth()+"-"+f.getDate();var k=gd();L.hasOwnProperty(f)||(L[f]={});L[f].hasOwnProperty(k)||(d=h(d)?d:!0,b=h(b)?b:!0,h(a.id)?k=a.id:a.id=k,h(a.created)||(a.created=new Date),L[f][k]=cd(a),e=!0,b&&Yb("onEventAdded",a),d&&fa())}return e};this.updateEvent=function(a,d,b,e){if(a=this.removeEvent(a,!1,!1))b=h(b)?b:!0,e=h(e)?e:!0,d.id=gd(),(a=this.addEvent(d,b,!1))&&e&&Yb("onEventUpdated",d);return a};this.removeEvent=function(a,d,b){var e=!1;nb(function(f,k,l){if(l===a)return d=h(d)?d:!0,b=h(b)?
b:!0,delete L[k][l],e=!0,b&&Yb("onEventRemoved",f),d&&fa(),!0});return e};this.clearEvents=function(a){a=h(a)?a:!0;L={};Aa("onEventsCleared");a&&fa()};this.getEvents=function(){return za(mb())};this.getEvent=function(a){var d=null;nb(function(b,e,f){if(f===a)return d=b,!0});return d};this.setOptions=function(a){c=null!==a&&"object"===typeof a?a:{};h(c.previousMonthTooltipText)||(c.previousMonthTooltipText="Previous Month");h(c.nextMonthTooltipText)||(c.nextMonthTooltipText="Next Month");h(c.previousDayTooltipText)||
(c.previousDayTooltipText="Previous Day");h(c.nextDayTooltipText)||(c.nextDayTooltipText="Next Day");h(c.previousWeekTooltipText)||(c.previousWeekTooltipText="Previous Week");h(c.nextWeekTooltipText)||(c.nextWeekTooltipText="Next Week");h(c.addEventTooltipText)||(c.addEventTooltipText="Add Event");h(c.closeTooltipText)||(c.closeTooltipText="Close");h(c.exportEventsTooltipText)||(c.exportEventsTooltipText="Export Events");h(c.todayTooltipText)||(c.todayTooltipText="Today");h(c.refreshTooltipText)||
(c.refreshTooltipText="Refresh");h(c.searchTooltipText)||(c.searchTooltipText="Search");h(c.expandDayTooltipText)||(c.expandDayTooltipText="Expand Day");h(c.listAllEventsTooltipText)||(c.listAllEventsTooltipText="View All Events");h(c.listWeekEventsTooltipText)||(c.listWeekEventsTooltipText="View Current Week Events");h(c.dayHeaderNames)||(c.dayHeaderNames="Mon Tue Wed Thu Fri Sat Sun".split(" "));h(c.dayNames)||(c.dayNames="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "));h(c.fromText)||
(c.fromText="From:");h(c.toText)||(c.toText="To:");h(c.isAllDayText)||(c.isAllDayText="Is All-Day");h(c.titleText)||(c.titleText="Title:");h(c.descriptionText)||(c.descriptionText="Description:");h(c.locationText)||(c.locationText="Location:");h(c.addText)||(c.addText="Add");h(c.updateText)||(c.updateText="Update");h(c.cancelText)||(c.cancelText="Cancel");h(c.removeEventText)||(c.removeEventText="Remove");h(c.addEventTitle)||(c.addEventTitle="Add Event");h(c.editEventTitle)||(c.editEventTitle="Edit Event");
h(c.monthNames)||(c.monthNames="January February March April May June July August September October November December".split(" "));h(c.showDayNumberOrdinals)||(c.showDayNumberOrdinals=!0);h(c.dragAndDropForEventsEnabled)||(c.dragAndDropForEventsEnabled=!0);h(c.exportStartFilename)||(c.exportStartFilename="exported_events_");h(c.fromTimeErrorMessage)||(c.fromTimeErrorMessage="Please select a valid 'From' time.");h(c.toTimeErrorMessage)||(c.toTimeErrorMessage="Please select a valid 'To' time.");h(c.toSmallerThanFromErrorMessage)||
...
51);h(c.allDayText)||(c.allDayText="All-Day");h(c.allEventsText)||(c.allEventsText="All Events");h(c.exportEventsEnabled)||(c.exportEventsEnabled=!0);h(c.manualEditingEnabled)||(c.manualEditingEnabled=!0);h(c.showTimesInMainCalendarEvents)||(c.showTimesInMainCalendarEvents=!1);h(c.startsOnText)||(c.startsOnText="Starts on the");h(c.andFinishesOnText)||(c.andFinishesOnText="and finishes on the");h(c.toTimeText)||(c.toTimeText="to");h(c.autoRefreshTimerDelay)||(c.autoRefreshTimerDelay=5E3);h(c.confirmEventRemoveTitle)||
(c.confirmEventRemoveTitle="Confirm Event Removal");h(c.confirmEventRemoveMessage)||(c.confirmEventRemoveMessage="Removing this event cannot be undone.  Do you want to continue?");h(c.okText)||(c.okText="OK");h(c.selectExportTypeTitle)||(c.selectExportTypeTitle="Select Export Type");h(c.fullScreenModeEnabled)||(c.fullScreenModeEnabled=!0);h(c.eventTooltipDelay)||(c.eventTooltipDelay=1E3);h(c.selectColorsText)||(c.selectColorsText="Select Colors");h(c.backgroundColorText)||(c.backgroundColorText="Background Color:");
h(c.textColorText)||(c.textColorText="Text Color:");h(c.borderColorText)||(c.borderColorText="Border Color:");h(c.searchEventsTitle)||(c.searchEventsTitle="Search Events");h(c.forText)||(c.forText="For:");h(c.previousText)||(c.previousText="Previous");h(c.nextText)||(c.nextText="Next");h(c.matchCaseText)||(c.matchCaseText="Match Case");h(c.minimumDayHeight)||(c.minimumDayHeight=0);h(c.repeatsText)||(c.repeatsText="Repeats:");h(c.repeatDaysToExcludeText)||(c.repeatDaysToExcludeText="Repeat Days To Exclude:");
...
h(c.includeText)||(c.includeText="Include:");h(c.holidays)||(c.holidays=[{day:24,month:12,title:"Christmas Eve"},{day:25,month:12,title:"Christmas Day"},{day:26,month:12,title:"Boxing Day"},{day:31,month:12,title:"New Year's Eve"},{day:1,month:1,title:"New Year's Day"}]);h(c.minimizedTooltipText)||(c.minimizedTooltipText="Minimize");h(c.restoreTooltipText)||(c.restoreTooltipText="Restore");h(c.removeAllEventsInSeriesText)||(c.removeAllEventsInSeriesText="Remove All Events In Series");h(c.createdText)||
(c.createdText="Created:");h(c.organizerName)||(c.organizerName="");h(c.organizerEmailAddress)||(c.organizerEmailAddress="");h(c.organizerNameText)||(c.organizerNameText="Organizer:");h(c.organizerEmailAddressText)||(c.organizerEmailAddressText="Organizer Email:");h(c.enableFullScreenTooltipText)||(c.enableFullScreenTooltipText="Turn On Full-Screen Mode");h(c.disableFullScreenTooltipText)||(c.disableFullScreenTooltipText="Turn Off Full-Screen Mode");h(c.idText)||(c.idText="ID:");Eb&&(Eb=!1,I(u,!0))};
(function(a,d){r=a;Ba=d;Pc=Ld;Ya.setOptions(Md);I(Nd,!0)})(document,window)};