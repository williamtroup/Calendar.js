function calendarJs(Ld,Md,Nd){function P(a,d){u=h(a)?a:new Date;d=h(d)?d:!1;u.setDate(1);u.setHours(0,0,0,0);var b=(new Date(u.getFullYear(),u.getMonth(),1)).getDay(),e=Db(u.getFullYear(),u.getMonth());0===b&&(b=7);sa();if(!Eb){A=Ia(Pc);A.className="calendar";A.innerHTML="";Od();Pd();Qd();Rd();var f=g("div","row header-days"),k=c.dayHeaderNames.length;A.appendChild(f);for(var l=0;l<k;l++){var m=c.dayHeaderNames[l],n=g("div","cell");n.innerHTML=m;f.appendChild(n)}for(f=0;6>f;f++)for(k=g("div","row"),
...
a:!0;K={};Aa("onEventsCleared");a&&fa()};this.getEvents=function(){return za(mb())};this.getEvent=function(a){var d=null;nb(function(b,e,f){if(f===a)return d=b,!0});return d};this.getCurrentDisplayDate=function(){return new Date(u)};this.setOptions=function(a){c=null!==a&&"object"===typeof a?a:{};h(c.previousMonthTooltipText)||(c.previousMonthTooltipText="Previous Month");h(c.nextMonthTooltipText)||(c.nextMonthTooltipText="Next Month");h(c.previousDayTooltipText)||(c.previousDayTooltipText="Previous Day");
