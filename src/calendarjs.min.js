function calendarJs(wc,xc,yc){function aa(a){n=h(a)?a:new Date;var b=(new Date(n.getFullYear(),n.getMonth(),1)).getDay();a=tb(n.getFullYear(),n.getMonth());0===b&&(b=7);ub();if(!Rb){var c=ba(Sb);c.className="calendar";zc(c);Ac(c);Bc(c);Cc(c);var e=f("div"),g=d.dayHeaderNames.length;e.className="row header-days";c.appendChild(e);for(var k=0;k<g;k++){var l=d.dayHeaderNames[k],m=f("div");m.className="cell";m.innerHTML=l;e.appendChild(m)}for(e=0;6>e;e++)for(g=f("div"),g.className="row",c.appendChild(g),
k=0;7>k;k++)l=7*e+(k+1),m=f("div"),m.className="cell",m.id="calendar-day-"+l,g.appendChild(m),0<d.minimumDayHeight&&(m.style.height=d.minimumDayHeight+"px");Rb=!0}k=b;if(1<k)for(c=new Date(n),c.setMonth(c.getMonth()-1),e=tb(c.getFullYear(),c.getMonth()),g=1,k=e-k+1;k<e;k++)vb(k+1,g,c.getMonth(),c.getFullYear(),!0),g++;for(e=c=0;e<a;e++)c=b+e,vb(e+1,c,n.getMonth(),n.getFullYear(),!1);if(42>c)for(a=1,b=new Date(n),b.setMonth(b.getMonth()+1),c+=1;43>c;c++)vb(a,c,b.getMonth(),b.getFullYear(),!0),a++;
