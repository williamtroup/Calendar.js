...
e.value=d.okText,e.onclick=Kd,b.appendChild(e),e=g("input","cancel","button"),e.value=d.cancelText,e.onclick=Kc,b.appendChild(e),null!==ca&&A(q.body,ca),ca=g("div","calendar-dialog event-editor-exclude-days"),q.body.appendChild(ca),e=g("div","title-bar"),e.innerHTML=d.selectDaysToExcludeTitle,ca.appendChild(e),b=g("div","contents"),ca.appendChild(b),Db=D(b,d.dayNames[0])[0],Eb=D(b,d.dayNames[1])[0],Fb=D(b,d.dayNames[2])[0],Gb=D(b,d.dayNames[3])[0],Hb=D(b,d.dayNames[4])[0],Ib=D(b,d.dayNames[5])[0],
Jb=D(b,d.dayNames[6])[0],e=g("div","split"),b.appendChild(e),b=g("input","ok","button"),b.value=d.okText,b.onclick=Ld,e.appendChild(b),b=g("input","cancel","button"),b.value=d.cancelText,b.onclick=Lc,e.appendChild(b),null!==da&&A(q.body,da),da=g("div","calendar-dialog confirmation"),q.body.appendChild(da),kc=g("div","title-bar"),da.appendChild(kc),e=g("div","contents"),da.appendChild(e),lc=g("div","message"),e.appendChild(lc),b=D(e,d.removeAllEventsInSeriesText),mc=b[0],Mc=b[1],b=g("div","split"),
e.appendChild(b),Wa=g("input","yes","button"),Wa.value=d.yesText,b.appendChild(Wa),Xa=g("input","no","button"),Xa.value=d.noText,b.appendChild(Xa),null!==ea&&A(q.body,ea),ea=g("div","calendar-dialog select-export-type"),q.body.appendChild(ea),e=g("div","title-bar"),e.innerHTML=d.selectExportTypeTitle,ea.appendChild(e),b=g("div","contents"),ea.appendChild(b),e=g("div","radioButtonsContainer"),b.appendChild(e),nc=V(e,"CSV","ExportType"),Nc=V(e,"XML","ExportType"),Oc=V(e,"JSON","ExportType"),Pc=V(e,
"TEXT","ExportType"),e=g("div","split"),b.appendChild(e),b=g("input","ok","button"),b.value=d.okText,b.onclick=Md,e.appendChild(b),b=g("input","cancel","button"),b.value=d.cancelText,b.onclick=Qc,e.appendChild(b),null!==y&&A(q.body,y),y=g("div","calendar-dialog search"),q.body.appendChild(y),e=g("div","title-bar"),e.innerHTML=d.searchEventsTitle,e.onmousedown=Nd,e.onmouseup=Od,y.appendChild(e),b=g("div","ib-close"),b.onclick=Pd,e.appendChild(b),u(b,d.closeTooltipText),fa=g("div","ib-minus"),fa.onclick=
Qd,e.appendChild(fa),u(fa,d.minimizedTooltipText),I=g("div","contents"),y.appendChild(I),e=g("p"),e.innerText=d.forText,I.appendChild(e),R=g("input",null,"text"),R.oninput=ra,R.onpropertychange=ra,R.onkeypress=Rd,I.appendChild(R),Rc=D(I,d.matchCaseText,ra)[0],e=g("p"),e.innerText=d.includeText,I.appendChild(e),e=g("div","checkboxContainer"),I.appendChild(e),Sc=D(e,d.titleText.replace(":",""),ra)[0],Tc=D(e,d.locationText.replace(":",""),ra)[0],Uc=D(e,d.descriptionText.replace(":",""),ra)[0],e=g("div",
...
"expand-day");l.appendChild(f);u(f,d.expandDayTooltipText);k=gd(m);if(null!==k){var p=g("span","holiday");p.innerText=k;c.appendChild(p)}f.onclick=function(){kb(m,!0)};d.manualEditingEnabled&&(l.ondblclick=function(){ha(null,m)},d.manualEditingEnabled&&(l.ondragover=function(n){r(n);ld(l)},l.ondragenter=function(n){r(n);ld(l)},l.ondragleave=function(n){r(n);md(l)},l.ondrop=function(n){r(n);if(null!==x){n=eb(x.from,x.to);var za=new Date(e,b,a,x.from.getHours(),x.from.getMinutes()),Oa=new Date(e,b,
a,x.to.getHours(),x.to.getMinutes());0<n&&Oa.setDate(Oa.getDate()+n);Pa.updateEvent(x.id,{from:za,to:Oa,title:x.title,description:x.description,location:x.location,isAllDay:x.isAllDay,color:x.color,colorText:x.colorText,colorBorder:x.colorBorder,repeatEvery:x.repeatEvery,repeatEveryExcludeDays:x.repeatEveryExcludeDays})}md(l)}))}function ld(a){-1===a.className.indexOf(" drag-over")&&(a.className+=" drag-over")}function md(a){-1<a.className.indexOf(" drag-over")&&(a.className=a.className.replace(" drag-over",
""))}function vb(a,c){return(new Date(a,c+1,0)).getDate()}function kd(a){var c=d.thText;if(31===a||21===a||1===a)c=d.stText;else if(22===a||2===a)c=d.ndText;else if(23===a||3===a)c=d.rdText;return c}function gd(a){for(var c=null,b=[],e=d.holidays.length,f=0;f<e;f++){var k=d.holidays[f];W(k.day)===a.getDate()&&W(k.month)===a.getMonth()+1&&(k=w(k.title,null),null!==k&&b.push(k))}0<b.length&&(c=b.join(", "));return c}function Ud(){null!==F&&A(q.body,F);F=g("div","calendar-drop-down-menu");q.body.appendChild(F);
if(d.manualEditingEnabled){var a=g("div","item");a.innerHTML=d.addEventTitle;F.appendChild(a);a.onclick=function(){ha(null,ac)};a=g("div","separator");F.appendChild(a)}a=g("div","item");a.innerHTML=d.expandDayTooltipText;F.appendChild(a);a.onclick=function(){kb(ac,!0)};a=g("div","separator");F.appendChild(a);a=g("div","item");a.innerHTML=d.listWeekEventsTooltipText;F.appendChild(a);a.onclick=function(){db(ac,!0)}}function Vd(){null!==L&&A(q.body,L);if(d.manualEditingEnabled){L=g("div","calendar-drop-down-menu");
q.body.appendChild(L);var a=g("div","item");a.innerHTML=d.removeEventText;L.appendChild(a);a.onclick=function(){Qa(q.body,O);var c=function(){A(q.body,O)},b=0<W(ja.repeatEvery)&&null!==qb;nd(d.confirmEventRemoveTitle,d.confirmEventRemoveMessage,function(){c();h(ja.id)&&(mc.checked||null===qb?Pa.removeEvent(ja.id,!0):(od(ja.seriesIgnoreDates)?ja.seriesIgnoreDates.push(qb):ja.seriesIgnoreDates=[qb],Z()),bc())},c,b)};a=g("div","separator");L.appendChild(a);a=g("div","item");a.innerHTML=d.editEventTitle;
...
!0):a=!1;qa.disabled=a;zb.disabled=a;Ab.disabled=a;Bb.disabled=a;Cb.disabled=a;Ca.disabled=a;Ba()}function ha(a,c){Qa(q.body,O);if(h(a)){Da.value=d.updateText;Ea.style.display="block";xb.innerHTML=d.editEventTitle;B=a;H.value=dc(a.from,H.type);P.value=ec(a.from);C.value=dc(a.to,C.type);Q.value=ec(a.to);Sa.checked=a.isAllDay;oa.value=w(a.title);Ua.value=w(a.description);Ta.value=w(a.location);Fa.value=w(a.color,"#484848");Ga.value=w(a.colorText,"#F5F5F5");Ha.value=w(a.colorBorder,"#282828");var b=
...
Da.value=d.addText;Ea.style.display="none";xb.innerHTML=d.addEventTitle;B={};H.value=dc(e,H.type);P.value=ec(e);C.value=dc(e,C.type);Q.value=ec(e);Sa.checked=!1;oa.value="";Ua.value="";Ta.value="";Fa.value="#484848";Ga.value="#F5F5F5";Ha.value="#282828";qa.checked=!0;Db.checked=!1;Eb.checked=!1;Fb.checked=!1;Gb.checked=!1;Hb.checked=!1;Ib.checked=!1;Jb.checked=!1}yb();na.style.display="block";Va.style.display="none";oa.focus()}function Id(){var a=cc(H),c=cc(C),b=P.value.split(":"),e=Q.value.split(":"),
f=Gc(oa.value),k=Gc(Ua.value),l=Gc(Ta.value);2>b.length?fc(d.fromTimeErrorMessage,P):2>e.length?fc(d.toTimeErrorMessage,Q):""===f?fc(d.titleErrorMessage,oa):(pd(a,P.value),pd(c,Q.value),c<a?fc(d.toSmallerThanFromErrorMessage,C):(jc(),b=h(B.id),a={from:a,to:c,title:f,description:k,location:l,isAllDay:Sa.checked,color:B.color,colorText:B.colorText,colorBorder:B.colorBorder,repeatEveryExcludeDays:B.repeatEveryExcludeDays},qa.checked?a.repeatEvery=0:zb.checked?a.repeatEvery=1:Ab.checked?a.repeatEvery=
2:Bb.checked?a.repeatEvery=3:Cb.checked&&(a.repeatEvery=4),b||(a.organizerName=d.organizerName,a.organizerEmailAddress=d.organizerEmailAddress),b?Pa.updateEvent(B.id,a,!1):Pa.addEvent(a,!1),Z(),bc()))}function pd(a,c){var b=0,e=0,f=c.split(":");if(2===f.length){var k=parseInt(f[0]);f=parseInt(f[1]);!isNaN(k)&&2>=k.toString().length&&(b=k);!isNaN(f)&&2>=f.toString().length&&(e=f)}a.setHours(b);a.setMinutes(e)}function cc(a){var c=new Date;if("date"===a.type)c=new Date(a.value);else if(a=a.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/))a=
new Date(a[3],a[2]-1,a[1]),a instanceof Date&&!isNaN(a)&&(c=a);return c}function jc(){na.style.display="none";A(q.body,O)}function Jd(){aa.style.display="block";var a=function(){aa.style.display="none"};nd(d.confirmEventRemoveTitle,d.confirmEventRemoveMessage,function(){a();jc();h(B.id)&&(Pa.removeEvent(B.id,!0),bc())},a)}function dc(a,c){var b=("0"+a.getDate()).slice(-2),e=("0"+(a.getMonth()+1)).slice(-2);return"date"===c?a.getFullYear()+"-"+e+"-"+b:b+"/"+e+"/"+a.getFullYear()}function ua(a){var c=
("0"+a.getDate()).slice(-2),b=("0"+a.getMonth()).slice(-2);return c+"/"+b+"/"+a.getFullYear()}function ec(a){return G(a.getHours())+":"+G(a.getMinutes())}function G(a){a=a.toString();return 1===a.length?"0"+a:a}function fc(a,c){Va.innerHTML=a;Va.style.display="block";c.focus()}function Gc(a){return a.replace(/^\s+|\s+$/g,"")}function bc(){rb(va)&&kb(T);rb(xa)&&Zc();rb(ya)&&db(ia)}function Kd(){Kc();B.color=Fa.value;B.colorText=Ga.value;B.colorBorder=Ha.value}function Kc(){ba.style.display="none";
aa.style.display="none"}function Gd(){ba.style.display="block";aa.style.display="block"}function Ld(){Lc();var a=[];Db.checked&&a.push(1);Eb.checked&&a.push(2);Fb.checked&&a.push(3);Gb.checked&&a.push(4);Hb.checked&&a.push(5);Ib.checked&&a.push(6);Jb.checked&&a.push(0);B.repeatEveryExcludeDays=a}function Lc(){ca.style.display="none";aa.style.display="none"}function Hd(){ca.style.display="block";aa.style.display="block"}function nd(a,c,b,e,f){f=h(f)?f:!1;da.style.display="block";kc.innerHTML=a;lc.innerHTML=
c;Wa.onclick=qd;Xa.onclick=qd;Wa.addEventListener("click",b);mc.checked=!1;Mc.style.display=f?"block":"none";tc(e)&&Xa.addEventListener("click",e)}function qd(){da.style.display="none"}function Pb(a){Qa(q.body,O);ea.style.display="block";sb=a;nc.checked=!0}function Qc(){A(q.body,O);ea.style.display="none"}function Md(){Qc();nc.checked?tb(sb,"csv"):Nc.checked?tb(sb,"xml"):Oc.checked?tb(sb,"json"):Pc.checked&&tb(sb,"text")}function Nd(a){ub||(ub=!0,rd=a.pageX-y.offsetLeft,sd=a.pageY-y.offsetTop)}function Td(a){ub&&
(y.style.left=a.pageX-rd+"px",y.style.top=a.pageY-sd+"px")}function Od(){ub&&(ub=!1,td=!0)}function ra(){Ia.disabled=!0;sa.disabled=""===R.value;X=[];ka=0}function Yc(){"block"!==y.style.display&&(X=[],y.style.display="block",R.value="",cd(),ra());R.focus()}function cd(){td||(y.style.left=ta.innerWidth/2-y.offsetWidth/2+"px",y.style.top=ta.innerHeight/2-y.offsetHeight/2+"px")}function Pd(){y.style.display="none"}function Qd(){"none"!==I.style.display?(I.style.display="none",fa.className="ib-square-hollow",
u(fa,d.restoreTooltipText)):(I.style.display="block",fa.className="ib-minus",u(fa,d.minimizedTooltipText))}function Sd(){0<ka&&(ka--,ud(),Y(X[ka].from))}function Rd(a){13!==a.keyCode||sa.disabled||Vc()}function Vc(){if(0===X.length){var a=Rc.checked,c=a?R.value:R.value.toLowerCase(),b={};Mb(function(e){var f=w(e.title),k=w(e.location),l=w(e.description),m=!1;a||(f=f.toLowerCase(),l=l.toLowerCase(),k=k.toLowerCase());Sc.checked&&-1<f.indexOf(c)?m=!0:Tc.checked&&-1<k.indexOf(c)?m=!0:Uc.checked&&-1<
l.indexOf(c)&&(m=!0);m&&(f=e.from.getMonth()+"-"+e.from.getFullYear(),b.hasOwnProperty(f)||(X.push(e),b[f]=!0))})}else ka++;ud();0<X.length&&Y(X[ka].from)}function ud(){Ia.disabled=0===ka;sa.disabled=ka===X.length-1||0===X.length}function ed(a,c,b){r(a);null!==la&&(clearTimeout(la),la=null);pc();"block"!==v.style.display&&(la=setTimeout(function(){q.body.contains(O)||Rb()||vc()||wc()||(b=h(b)?b:"",v.className=""===b?"calendar-tooltip-event":"calendar-tooltip",""!==b?v.innerHTML=b:(v.innerHTML="",
v.appendChild(oc),v.appendChild(Kb),oc.innerHTML=c.title,lb(c.repeatEvery)&&0<c.repeatEvery?(Ya.innerHTML=d.repeatsText.replace(":","")+" "+La(c.repeatEvery),Qa(v,Ya)):(Ya.innerHTML="",A(v,Ya)),M(c.location)?($a.innerHTML=c.location,Qa(v,$a)):($a.innerHTML="",A(v,$a)),M(c.description)?(Za.innerHTML=c.description,Qa(v,Za)):(Za.innerHTML="",A(v,Za)),c.from.getDate()===c.to.getDate()?Kb.innerHTML=c.isAllDay?d.allDayText:hb(c.from,c.to):Yb(Kb,c.from,c.to)),Fc(a,v))},d.eventTooltipDelay))}function pc(){null!==
la&&(clearTimeout(la),la=null);vd()&&(v.style.display="none")}function vd(){return null!==la||null!==v&&"block"===v.style.display}function u(a,c){a.onmousemove=function(b){ed(b,null,c)}}function ae(){null===gb&&0<d.autoRefreshTimerDelay&&(gb=setInterval(function(){Nb()},d.autoRefreshTimerDelay))}function Nb(){dd()&&(bc(),Z())}function dd(){return!vd()&&!q.body.contains(O)&&!Rb()&&!vc()&&!wc()}function Cc(a){rb(a)||(a.className+=" overlay-shown")}function Ac(a){rb(a)&&(a.className=a.className.replace(" overlay-shown",
""))}function rb(a){return-1<a.className.indexOf("overlay-shown")}function g(a,c,b){a=a.toLowerCase();var e="text"===a;Hc.hasOwnProperty(a)||(Hc[a]=e?q.createTextNode(""):q.createElement(a));a=Hc[a].cloneNode(!1);h(c)&&(a.className=c);h(b)&&(a.type=b);return a}function Aa(a){Ra.hasOwnProperty(a)&&null!==Ra[a]||(Ra[a]=q.getElementById(a));q.body.contains(Ra[a])||(Ra[a]=q.getElementById(a));return Ra[a]}function Qa(a,c){try{a.contains(c)||a.appendChild(c)}catch(b){console.warn(b.message)}}function A(a,
...
h(e)&&(f.onchange=e);b=g("span","check-mark");a.appendChild(b);b=g("span","text");b.innerText=c;a.appendChild(b);return f}function D(a,c,b){var e=g("div");a.appendChild(e);a=g("label","checkbox");a.innerText=c;e.appendChild(a);c=g("input",null,"checkbox");a.appendChild(c);h(b)&&(c.onchange=b);b=g("span","check-mark");a.appendChild(b);return[c,a]}function h(a){return void 0!==a&&null!==a&&""!==a}function tc(a){return h(a)&&"function"===typeof a}function wd(a){return h(a)&&"string"===typeof a}function lb(a){return h(a)&&
"number"===typeof a}function od(a){return h(a)&&"object"===typeof a&&a instanceof Array}function M(a){return wd(a)&&""!==a}function tb(a,c){c=h(c)?c.toLowerCase():"csv";var b="";var e=[];e=h(a)?e.concat(a):Lb();e=bb(e);if("csv"===c){var f=[d.fromText,d.toText,d.isAllDayText,d.titleText,d.descriptionText,d.locationText,d.backgroundColorText,d.textColorText,d.borderColorText,d.repeatsText,d.repeatDaysToExcludeText,d.seriesIgnoreDatesText,d.createdText,d.organizerNameText,d.organizerEmailAddressText],
k=f.length;b=[];for(var l=[],m=0;m<k;m++)b.push(z(f[m]));l.push(b.join(","));f=e.length;for(k=0;k<f;k++){b=l;m=e[k];var p=[];p.push(z(gc(m.from)));p.push(z(gc(m.to)));p.push(z(m.isAllDay?d.yesText:d.noText));p.push(z(w(m.title)));p.push(z(w(m.description)));p.push(z(w(m.location)));p.push(z(w(m.color)));p.push(z(w(m.colorText)));p.push(z(w(m.colorBorder)));p.push(z(La(m.repeatEvery)));p.push(z(S(m.repeatEveryExcludeDays).join(",")));p.push(z(S(m.seriesIgnoreDates).join(",")));p.push(z(gc(m.created)));
p.push(z(w(m.organizerName)));p.push(z(w(m.organizerEmailAddress)));b.push(p.join(","))}b=l.join("\n")}else if("xml"===c){f=[];f.push('<?xml version="1.0" ?>');f.push("<Events>");k=e.length;for(b=0;b<k;b++){m=e[b];f.push("<Event>");for(l in m)m.hasOwnProperty(l)&&(p=xd(l),f.push("<"+p+">"+Ic(l,m[l])+"</"+p+">"));f.push("</Event>")}f.push("</Events>");b=f.join("\n")}else if("json"===c){l=[];l.push("{");l.push('"events:": [');k=e.length;for(b=0;b<k;b++){m=e[b];l.push("{");for(f in m)m.hasOwnProperty(f)&&
l.push('"'+f+'":"'+Ic(f,m[f])+'",');m=l[l.length-1];l[l.length-1]=m.substring(0,m.length-1);l.push("},")}l[l.length-1]="}";l.push("]");l.push("}");b=l.join("\n")}else if("text"===c){l=[];f=e.length;for(b=0;b<f;b++){m=e[b];for(k in m)m.hasOwnProperty(k)&&l.push(xd(k)+": "+Ic(k,m[k]));l.push("")}l.pop();b=l.join("\n")}""!==b&&(e=g("a"),f="text"===c?"plain":c,l="text"===c?"txt":c,e.style.display="none",e.setAttribute("target","_blank"),e.setAttribute("href","data:text/"+f+";charset=utf-8,"+encodeURIComponent(b)),
f=e.setAttribute,b=new Date,k=G(b.getDate())+"-"+G(b.getMonth())+"-"+b.getFullYear(),b=G(b.getHours())+"-"+G(b.getMinutes()),f.call(e,"download",d.exportStartFilename+k+"_"+b+"."+l),q.body.appendChild(e),e.click(),q.body.removeChild(e),fb("onEventsExported"))}function gc(a){var c=G(a.getDate())+"/"+G(a.getMonth())+"/"+a.getFullYear();a=G(a.getHours())+":"+G(a.getMinutes());return c+" "+a}function w(a,c){c=h(c)?c:"";return wd(a)?a:c}function W(a,c){c=h(c)?c:0;return lb(a)?a:c}function Xc(a,c){c=h(c)?
c:0;return h(a)&&"boolean"===typeof a?a?1:0:c}function S(a,c){c=h(c)?c:[];return od(a)?a:c}function La(a){var c=d.repeatsNever;a=W(a);1===a?c=d.repeatsEveryDayText:2===a?c=d.repeatsEveryWeekText:3===a?c=d.repeatsEveryMonthText:4===a&&(c=d.repeatsEveryYearText);return c}function xd(a){return a.charAt(0).toUpperCase()+a.slice(1)}function Ic(a,c){var b=w(c);"boolean"===typeof c?b=c?d.yesText:d.noText:"object"===typeof c&&c instanceof Date?b=gc(c):"object"===typeof c&&c instanceof Array?b=S(c).join(","):
"number"===typeof c&&(b="repeatEvery"===a?La(c):c.toString());return b}function z(a){a=a.replace(/(\r\n|\n|\r)/gm,"").replace(/(\s\s)/gm," ");a=a.replace(/"/g,'""');return'"'+a+'"'}function qc(){var a=new Date(t);a.setMonth(a.getMonth()-1);a.setDate(1);Y(a);fb("onPreviousMonth")}function sc(){var a=new Date(t);a.setMonth(a.getMonth()+1);a.setDate(1);Y(a);fb("onNextMonth")}function rc(){var a=new Date;if(t.getMonth()!==a.getMonth()||t.getFullYear()!==a.getFullYear())Y(),fb("onToday")}var d={},Pa=this,
t=null,ic=null,Hc={},Ra={},q=null,ta=null,Jc=null,wb=!1,bd=!1,J={},gb=null,x=null,ad=null,uc=!1,E=null,ab=null,K=null,Qb=null,Ja=null,O=null,na=null,aa=null,xb=null,H=null,P=null,C=null,Q=null,Sa=null,oa=null,Ua=null,Ta=null,qa=null,zb=null,Ab=null,Bb=null,Cb=null,Ca=null,Va=null,B={},Da=null,Ea=null,ba=null,Fa=null,Ga=null,Ha=null,ca=null,Db=null,Eb=null,Fb=null,Gb=null,Hb=null,Ib=null,Jb=null,va=null,ib=null,jb=null,T=null,Bc=[],Ka=null,xa=null,mb=null,nb=null,ya=null,U=null,Ma=null,pb=null,Na=
{},Dc={},ob=[],ia=null,da=null,kc=null,lc=null,mc=null,Mc=null,Wa=null,Xa=null,ea=null,nc=null,Nc=null,Oc=null,Pc=null,sb=null,v=null,oc=null,Kb=null,Ya=null,Za=null,$a=null,la=null,F=null,ac=null,L=null,ja=null,qb=null,y=null,fa=null,I=null,R=null,Rc=null,Sc=null,Tc=null,Uc=null,Ia=null,sa=null,ub=!1,td=!1,rd=0,sd=0,X=[],ka=0;this.moveToPreviousMonth=function(){qc()};this.moveToNextMonth=function(){sc()};this.moveToToday=function(){rc()};this.exportAllEvents=function(a){d.exportEventsEnabled&&(a=
h(a)?a:"csv",tb(null,a))};this.refresh=function(){Nb()};this.addEvents=function(a,c,b){c=h(c)?c:!0;b=h(b)?b:!0;for(var e=a.length,f=0;f<e;f++)this.addEvent(a[f],!1,!1);b&&Sb("onEventAdded",a);c&&Z()};this.addEvent=function(a,c,b){var e=!1;if(a.from<=a.to){var f=a.from;f=f.getFullYear()+"-"+f.getMonth()+"-"+f.getDate();var k=$c();J.hasOwnProperty(f)||(J[f]={});J[f].hasOwnProperty(k)||(c=h(c)?c:!0,b=h(b)?b:!0,h(a.id)?k=a.id:a.id=k,h(a.created)||(a.created=new Date),J[f][k]=Wc(a),e=!0,b&&Sb("onEventAdded",
a),c&&Z())}return e};this.updateEvent=function(a,c,b,e){if(a=this.removeEvent(a,!1,!1))b=h(b)?b:!0,e=h(e)?e:!0,c.id=$c(),(a=this.addEvent(c,b,!1))&&e&&Sb("onEventUpdated",c);return a};this.removeEvent=function(a,c,b){var e=!1;Mb(function(f,k,l){if(l===a)return c=h(c)?c:!0,b=h(b)?b:!0,delete J[k][l],e=!0,b&&Sb("onEventRemoved",f),c&&Z(),!0});return e};this.clearEvents=function(a){a=h(a)?a:!0;J={};fb("onEventsCleared");a&&Z()};this.setOptions=function(a){d=null!==a&&"object"===typeof a?a:{};h(d.previousMonthTooltipText)||
(d.previousMonthTooltipText="Previous Month");h(d.nextMonthTooltipText)||(d.nextMonthTooltipText="Next Month");h(d.previousDayTooltipText)||(d.previousDayTooltipText="Previous Day");h(d.nextDayTooltipText)||(d.nextDayTooltipText="Next Day");h(d.previousWeekTooltipText)||(d.previousWeekTooltipText="Previous Week");h(d.nextWeekTooltipText)||(d.nextWeekTooltipText="Next Week");h(d.addEventTooltipText)||(d.addEventTooltipText="Add Event");h(d.closeTooltipText)||(d.closeTooltipText="Close");h(d.exportEventsTooltipText)||
(d.exportEventsTooltipText="Export Events");h(d.todayTooltipText)||(d.todayTooltipText="Today");h(d.refreshTooltipText)||(d.refreshTooltipText="Refresh");h(d.searchTooltipText)||(d.searchTooltipText="Search");h(d.expandDayTooltipText)||(d.expandDayTooltipText="Expand Day");h(d.listAllEventsTooltipText)||(d.listAllEventsTooltipText="View All Events");h(d.listWeekEventsTooltipText)||(d.listWeekEventsTooltipText="View Current Week Events");h(d.dayHeaderNames)||(d.dayHeaderNames="Mon Tue Wed Thu Fri Sat Sun".split(" "));
h(d.dayNames)||(d.dayNames="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "));h(d.fromText)||(d.fromText="From:");h(d.toText)||(d.toText="To:");h(d.isAllDayText)||(d.isAllDayText="Is All-Day");h(d.titleText)||(d.titleText="Title:");h(d.descriptionText)||(d.descriptionText="Description:");h(d.locationText)||(d.locationText="Location:");h(d.addText)||(d.addText="Add");h(d.updateText)||(d.updateText="Update");h(d.cancelText)||(d.cancelText="Cancel");h(d.removeEventText)||(d.removeEventText=
...
0);h(d.repeatsText)||(d.repeatsText="Repeats:");h(d.repeatDaysToExcludeText)||(d.repeatDaysToExcludeText="Repeat Days To Exclude:");h(d.seriesIgnoreDatesText)||(d.seriesIgnoreDatesText="Series Ignore Dates:");h(d.repeatsNever)||(d.repeatsNever="Never");h(d.repeatsEveryDayText)||(d.repeatsEveryDayText="Every Day");h(d.repeatsEveryWeekText)||(d.repeatsEveryWeekText="Every Week");h(d.repeatsEveryMonthText)||(d.repeatsEveryMonthText="Every Month");h(d.repeatsEveryYearText)||(d.repeatsEveryYearText="Every Year");
h(d.selectDaysToExcludeTitle)||(d.selectDaysToExcludeTitle="Select Days To Exclude");h(d.moreText)||(d.moreText="More");h(d.includeText)||(d.includeText="Include:");h(d.holidays)||(d.holidays=[{day:24,month:12,title:"Christmas Eve"},{day:25,month:12,title:"Christmas Day"},{day:26,month:12,title:"Boxing Day"},{day:31,month:12,title:"New Year's Eve"},{day:1,month:1,title:"New Year's Day"}]);h(d.minimizedTooltipText)||(d.minimizedTooltipText="Minimize");h(d.restoreTooltipText)||(d.restoreTooltipText=
"Restore");h(d.removeAllEventsInSeriesText)||(d.removeAllEventsInSeriesText="Remove All Events In Series");h(d.createdText)||(d.createdText="Created:");h(d.organizerName)||(d.organizerName="");h(d.organizerEmailAddress)||(d.organizerEmailAddress="");h(d.organizerNameText)||(d.organizerNameText="Organizer:");h(d.organizerEmailAddressText)||(d.organizerEmailAddressText="Organizer Email:");wb&&(wb=!1,Y(t,!0))};(function(a,c){q=a;ta=c;Jc=yd;Pa.setOptions(zd);Y(Ad,!0)})(document,window)};