...
f=g("div","ib-arrow-top-right");l.appendChild(f);p(f,d.expandDayTooltipText);k=Ad(m);if(null!==k){var n=g("span","holiday");n.innerText=k;c.appendChild(n)}f.onclick=function(){Ha(m,!0)};d.manualEditingEnabled&&(l.ondblclick=function(){sa(null,m)},d.manualEditingEnabled&&(l.ondragover=function(u){q(u);Gd(l)},l.ondragenter=function(u){q(u);Gd(l)},l.ondragleave=function(u){q(u);Hd(l)},l.ondrop=function(u){q(u);if(null!==x){u=sb(x.from,x.to);var Z=new Date(e,b,a,x.from.getHours(),x.from.getMinutes()),
