function calendarJs(Wd,Xd,Yd){function J(a,c){t=h(a)?a:new Date;c=h(c)?c:!1;t.setDate(1);t.setHours(0,0,0,0);var b=(new Date(t.getFullYear(),t.getMonth(),1)).getDay(),e=Lb(t.getFullYear(),t.getMonth());0===b&&(b=7);ya();if(!Mb){A=Ma(Yc);A.className="calendar";A.innerHTML="";Zd();$d();ae();be();var f=g("div","row header-days"),k=d.dayHeaderNames.length;A.appendChild(f);for(var l=0;l<k;l++){var m=d.dayHeaderNames[l],n=g("div","cell");n.innerHTML=m;f.appendChild(n)}for(f=0;6>f;f++)for(k=g("div","row"),
A.appendChild(k),l=0;7>l;l++)m=7*f+(l+1),n=g("div","cell"),n.id="calendar-day-"+m,k.appendChild(n),0<d.minimumDayHeight&&(n.style.height=d.minimumDayHeight+"px");ce();Mb=!0}m=b;if(1<m)for(f=new Date(t),f.setMonth(f.getMonth()-1),k=Lb(f.getFullYear(),f.getMonth()),l=1,m=k-m+1;m<k;m++)uc(m+1,l,f.getMonth(),f.getFullYear(),!0),l++;for(k=f=0;k<e;k++)f=b+k,uc(k+1,f,t.getMonth(),t.getFullYear(),!1);if(42>f){b=1;e=new Date(t);e.setMonth(e.getMonth()+1);for(f+=1;43>f;f++)uc(b,f,e.getMonth(),e.getFullYear(),
!0),b++;b=Lb(e.getFullYear(),e.getMonth());b=Math.round(b/2);vc=new Date(e.getFullYear(),e.getMonth(),b)}else vc=null;ia();c&&(null===R&&(R=g("div","disabled-background")),null!==za&&B(r.body,za),za=g("div","calendar-dialog event-editor"),r.body.appendChild(za),b=g("div","view"),za.appendChild(b),ja=g("div","disabled-area"),b.appendChild(ja),Nb=g("div","title-bar"),b.appendChild(Nb),e=g("div","contents"),b.appendChild(e),b=g("p"),b.innerText=d.titleText,e.appendChild(b),b=g("div","input-title-container"),
e.appendChild(b),Aa=g("input",null,"text"),b.appendChild(Aa),f=g("input","select-colors","button"),f.value="...",f.onclick=de,b.appendChild(f),b=g("p"),b.innerText=d.fromText.replace(":","")+"/"+d.toText,e.appendChild(b),b=g("div","split"),e.appendChild(b),M=g("input"),M.onchange=Ob,b.appendChild(M),ka(M,"date"),S=g("input"),b.appendChild(S),ka(S,"time"),b=g("div","split"),e.appendChild(b),G=g("input"),G.onchange=Ob,b.appendChild(G),ka(G,"date"),T=g("input"),b.appendChild(T),ka(T,"time"),fb=H(e,d.isAllDayText,
Ob)[0],b=g("p"),b.innerText=d.repeatsText,e.appendChild(b),b=g("div","radioButtonsContainer"),e.appendChild(b),Ba=U(b,d.repeatsNever,"RepeatType",Na),Pb=U(b,d.repeatsEveryDayText,"RepeatType",Na),Qb=U(b,d.repeatsEveryWeekText,"RepeatType",Na),Rb=U(b,d.repeatsEveryMonthText,"RepeatType",Na),Sb=U(b,d.repeatsEveryYearText,"RepeatType",Na),Oa=g("input","repeat-options","button"),Oa.value="...",Oa.onclick=ee,b.appendChild(Oa),b=g("p"),b.innerText=d.locationText,e.appendChild(b),gb=g("input",null,"text"),
...
K.appendChild(e),hd=H(e,d.titleText.replace(":",""),Da)[0],id=H(e,d.locationText.replace(":",""),Da)[0],jd=H(e,d.descriptionText.replace(":",""),Da)[0],e=g("div","split"),K.appendChild(e),Ua=g("input","previous","button"),Ua.value=d.previousText,Ua.onclick=oe,e.appendChild(Ua),Ea=g("input","next","button"),Ea.value=d.nextText,Ea.onclick=kd,e.appendChild(Ea),r.body.addEventListener("mousemove",pe),null===w&&(w=g("div"),r.body.appendChild(w),Bc=g("div","title"),ac=g("div","date"),lb=g("div","repeats"),
mb=g("div","description"),nb=g("div","location"),document.body.addEventListener("mousemove",Cc)),qe(),re());ob.innerHTML=d.monthNames[t.getMonth()]+", "+t.getFullYear()+" \u25be"}function pb(){var a=[];qb(function(c){a.push(c)});return a}function qb(a){for(var c in L)if(L.hasOwnProperty(c))for(var b in L[c])if(L[c].hasOwnProperty(b)){var e=ld(L[c][b]);if(a(e,c,b))return}}function Fa(a,c){c=h(c)?c:!0;a=a.sort(function(b,e){return b.from-e.from});c&&(a=a.sort(function(b,e){return md(e.isAllDay)-md(b.isAllDay)}));
...
"block";lc(fa,d.manualEditingEnabled?"event":"event-no-hover");Nc(Ia);Ka(wb,a,!1,!0,!0);var b=Dd(a),e=[];if(null!==b){var f=g("span","holiday");f.innerText=" ("+b+")";wb.appendChild(f)}qb(function(m){for(var n=ub(m.from,m.to)+1,v=new Date(m.from),ra=0;ra<n;ra++){if(fc(v,a)){e.push(m);break}v.setDate(v.getDate()+1)}n=W(m.repeatEvery);0<n&&(1===n?nc(m,e,a,function(E){E.setDate(E.getDate()+1)}):2===n?nc(m,e,a,function(E){E.setDate(E.getDate()+7)}):3===n?nc(m,e,a,function(E){E.setMonth(E.getMonth()+1)}):
4===n&&nc(m,e,a,function(E){E.setFullYear(E.getFullYear()+1)}))});e=Fa(e);b=e.length;f=null;for(var k=0;k<b;k++){var l=Be(e[k],a);null===f&&(f=l)}c&&(fa.scrollTop=f-fa.offsetHeight/2);1>=Ja.offsetHeight&&(Ja.style.display="none");d.exportEventsEnabled&&(Ya.style.display=0===e.length?"none":"inline-block")}function nc(a,c,b,e){for(var f=new Date(a.from),k=X(a.repeatEveryExcludeDays),l=X(a.seriesIgnoreDates);f<b;){e(f);var m=Xa(f),n=!(!h(a.repeatEnds)||Ic(f,a.repeatEnds));if(-1===k.indexOf(f.getDay())&&
-1===l.indexOf(m)&&!n&&fc(f,b)){c.push(a);break}}}function Be(a,c){var b=g("div",d.manualEditingEnabled?"event":"event-no-hover");a.isAllDay?Ja.appendChild(b):xb.appendChild(b);if(d.manualEditingEnabled){var e=Xa(c);b.oncontextmenu=function(k){kc(k,a,e)}}jc(b,a,Lc(a,c));var f=g("div","title");f.innerHTML=a.title;b.appendChild(f);f=g("div","date");b.appendChild(f);a.from.getDate()===a.to.getDate()?f.innerHTML=a.isAllDay?d.allDayText:vb(a.from,a.to):oc(f,a.from,a.to);yb(a.repeatEvery)&&0<a.repeatEvery&&
...
f*yd(b.from);l=fc(b.to,a)?f*yd(b.to)-k:e;l-=2*d.spacing}c.style.top=k+"px";null!==l&&(c.style.height=l+"px");c.offsetTop+c.offsetHeight>e-d.spacing&&(c.style.height=e-c.offsetTop-3*d.spacing+"px");a=k+fa.offsetHeight/2;a<=fa.offsetHeight&&(a=0);return a}function Ae(){Y.setDate(Y.getDate()-1);Ha(Y,!0)}function ze(){Y.setDate(Y.getDate()+1);Ha(Y,!0)}function Zd(){sa=g("div","list-all-events-view");A.appendChild(sa);var a=g("div","title-bar");sa.appendChild(a);d.fullScreenModeEnabled&&(a.ondblclick=
aa);var c=g("div","title");c.innerHTML=d.allEventsText;a.appendChild(c);c=g("div","ib-close");c.ondblclick=q;a.appendChild(c);p(c,d.closeTooltipText);c.onclick=function(){mc(sa)};d.manualEditingEnabled&&(c=g("div","ib-plus"),c.onclick=bc,c.ondblclick=q,a.appendChild(c),p(c,d.addEventTooltipText));d.exportEventsEnabled&&(zb=g("div","ib-arrow-down-full-line"),zb.ondblclick=q,a.appendChild(zb),p(zb,d.exportEventsTooltipText),zb.onclick=function(){cc()});d.fullScreenModeEnabled&&(da=g("div","ib-arrow-expand-left-right"),
da.ondblclick=q,da.onclick=aa,a.appendChild(da),p(da,d.enableFullScreenTooltipText));Ab=g("div","contents custom-scroll-bars");sa.appendChild(Ab)}function od(a){a=h(a)?a:!1;Nc(sa);Ab.innerHTML="";a&&(Ab.scrollTop=0);a=Fa(pb());for(var c=a.length,b=0;b<c;b++){var e=a[b],f=De(e.from);Ee(e,f)}}function Ee(a,c){var b=g("div",d.manualEditingEnabled?"event":"event-no-hover");c.appendChild(b);d.manualEditingEnabled&&(b.oncontextmenu=function(f){kc(f,a)});jc(b,a);var e=g("div","title");e.innerHTML=a.title;
b.appendChild(e);e=g("div","date");b.appendChild(e);a.from.getDate()===a.to.getDate()?a.isAllDay?pc(e,a.from,null," - "+d.allDayText):pc(e,a.from,null," - "+vb(a.from,a.to)):oc(e,a.from,a.to);yb(a.repeatEvery)&&0<a.repeatEvery&&(e=g("div","repeats"),e.innerHTML=d.repeatsText.replace(":","")+" "+Za(a.repeatEvery),b.appendChild(e));P(a.location)&&(e=g("div","location"),e.innerHTML=a.location,b.appendChild(e));P(a.description)&&(e=g("div","description"),e.innerHTML=a.description,b.appendChild(e));d.manualEditingEnabled&&
(b.onclick=function(){qa(a)})}function De(a){var c="month-"+a.getMonth()+"-"+a.getFullYear(),b=Ma(c),e=new Date(a);if(null===b){var f=g("div","month");Ab.appendChild(f);b=g("div","header");b.innerHTML=d.monthNames[a.getMonth()]+" "+a.getFullYear();f.appendChild(b);a=g("div","ib-arrow-expand-left-right");a.ondblclick=q;b.appendChild(a);a.onclick=function(){mc(sa);J(e)};p(a,d.expandMonthTooltipText);b=g("div","events");b.id=c;f.appendChild(b)}return b}function $d(){La=g("div","list-all-week-events-view");
A.appendChild(La);var a=g("div","title-bar");La.appendChild(a);d.fullScreenModeEnabled&&(a.ondblclick=aa);Z=g("div","title");a.appendChild(Z);var c=g("div","ib-close");c.ondblclick=q;a.appendChild(c);p(c,d.closeTooltipText);c.onclick=function(){mc(La)};d.manualEditingEnabled&&(c=g("div","ib-plus"),c.onclick=bc,c.ondblclick=q,a.appendChild(c),p(c,d.addEventTooltipText));c=g("div","ib-arrow-right-full");c.onclick=Fe;c.ondblclick=q;a.appendChild(c);p(c,d.nextWeekTooltipText);c=g("div","ib-arrow-left-full");
c.onclick=Ge;c.ondblclick=q;a.appendChild(c);p(c,d.previousWeekTooltipText);d.exportEventsEnabled&&($a=g("div","ib-arrow-down-full-line"),$a.ondblclick=q,a.appendChild($a),p($a,d.exportEventsTooltipText),$a.onclick=function(){cc(Bb)});d.fullScreenModeEnabled&&(ea=g("div","ib-arrow-expand-left-right"),ea.ondblclick=q,ea.onclick=aa,a.appendChild(ea),p(ea,d.enableFullScreenTooltipText));Cb=g("div","contents custom-scroll-bars");La.appendChild(Cb)}function sb(a,c){c=h(c)?c:!1;Nc(La);Cb.innerHTML="";ab=
{};Oc={};Bb=[];ta=null===a?new Date:new Date(a);c&&(Cb.scrollTop=0);var b=ve(a),e=b[0];b=b[1];He(e,b);Ie(e,b);for(var f=Fa(pb()),k=f.length,l=0;l<k;l++){for(var m=f[l],n=ub(m.from,m.to)+1,v=new Date(m.from),ra=!1,E=0;E<n;E++)v>=e&&v<=b&&(ra=Pc(v),Ed(m,ra,v),ra=!0),v.setDate(v.getDate()+1);ra&&Bb.push(m);n=W(m.repeatEvery);v=!1;0<n&&(1===n?v=qc(m,e,b,function(Q){Q.setDate(Q.getDate()+1)}):2===n?v=qc(m,e,b,function(Q){Q.setDate(Q.getDate()+7)}):3===n?v=qc(m,e,b,function(Q){Q.setMonth(Q.getMonth()+1)}):
4===n&&(v=qc(m,e,b,function(Q){Q.setFullYear(Q.getFullYear()+1)})));v&&!ra&&Bb.push(m)}for(var Fd in ab)ab.hasOwnProperty(Fd)&&Cb.appendChild(ab[Fd]);d.exportEventsEnabled&&($a.style.display=0===Bb.length?"none":"inline-block")}function qc(a,c,b,e){for(var f=new Date(a.from),k=X(a.repeatEveryExcludeDays),l=X(a.seriesIgnoreDates),m=!1;f<b;){e(f);var n=Xa(f),v=!(!h(a.repeatEnds)||Ic(f,a.repeatEnds));-1===k.indexOf(f.getDay())&&-1===l.indexOf(n)&&!v&&f>=c&&f<=b&&(m=Pc(f),Ed(a,m,f),m=!0)}return m}function Ie(a,
c){Z.innerHTML="";if(a.getFullYear()===c.getFullYear()){Ka(Z,a,!1,!1);var b=g("span");b.innerHTML=" - ";Z.appendChild(b);Ka(Z,c,!1,!1);b=g("span");b.innerHTML=", "+a.getFullYear();Z.appendChild(b)}else Ka(Z,a,!1,!0),b=g("span"),b.innerHTML=" - ",Z.appendChild(b),Ka(Z,c,!1,!0)}function Ed(a,c,b){lc(c,"no-events-text");var e=g("div",d.manualEditingEnabled?"event":"event-no-hover");c.appendChild(e);if(d.manualEditingEnabled){var f=Xa(b);e.oncontextmenu=function(k){kc(k,a,f)}}Bd(e,a);jc(e,a,Lc(a,b));
c=g("div","title");c.innerHTML=a.title;e.appendChild(c);c=g("div","date");e.appendChild(c);a.from.getDate()===a.to.getDate()?c.innerHTML=a.isAllDay?d.allDayText:vb(a.from,a.to):oc(c,a.from,a.to);yb(a.repeatEvery)&&0<a.repeatEvery&&(c=g("div","repeats"),c.innerHTML=d.repeatsText.replace(":","")+" "+Za(a.repeatEvery),e.appendChild(c));P(a.location)&&(c=g("div","location"),c.innerHTML=a.location,e.appendChild(c));P(a.description)&&(c=g("div","description"),c.innerHTML=a.description,e.appendChild(c));
d.manualEditingEnabled&&(e.onclick=function(){qa(a)})}function He(a,c){var b=new Date(a);do Pc(b),b.setDate(b.getDate()+1);while(b<c)}function Pc(a){var c=Jc(a),b=a.getFullYear()+a.getMonth()+c,e=null,f=new Date(a);if(ab.hasOwnProperty(b))e=Oc[b];else{var k=g("div","day");ab[b]=k;Gd(k,f.getFullYear(),f.getMonth(),f.getDate());e=g("div","header");k.appendChild(e);pc(e,a,d.dayNames[c]+", ");a=g("div","ib-arrow-expand-left-right");a.ondblclick=q;e.appendChild(a);a.onclick=function(){Ha(f,!0)};p(a,d.expandDayTooltipText);
e=g("div","events");k.appendChild(e);k=g("div","no-events-text");k.innerHTML=d.noEventsAvailableText;e.appendChild(k);Oc[b]=e}return e}function Ge(){ta.setDate(ta.getDate()-7);sb(ta,!0)}function Fe(){ta.setDate(ta.getDate()+7);sb(ta,!0)}function vb(a,c){return Qc(a)+" "+d.toTimeText+" "+Qc(c)}function Qc(a){return D(a.getHours())+":"+D(a.getMinutes())}function oc(a,c,b){a.innerHTML="";var e=g("span");e.innerText=d.startsOnText+" ";a.appendChild(e);Ka(a,c);c=g("span");c.innerText=" "+d.andFinishesOnText+
" ";a.appendChild(c);Ka(a,b)}function Ka(a,c,b,e,f){b=h(b)?b:!0;e=h(e)?e:!0;if(f=h(f)?f:!1){f=Jc(c);var k=g("span");k.innerText=d.dayNames[f]+", ";a.appendChild(k)}pc(a,c);f=g("span");f.innerText=" "+d.monthNames[c.getMonth()];a.appendChild(f);e&&(e=g("span"),e.innerText=" "+c.getFullYear(),a.appendChild(e));b&&(b=g("span"),b.innerText=" "+Qc(c),a.appendChild(b))}function pc(a,c,b,e){if(h(b)){var f=g("span");f.innerText=b;a.appendChild(f)}b=g("span");b.innerText=c.getDate();a.appendChild(b);d.showDayNumberOrdinals&&
(b=g("sup"),b.innerText=xd(c.getDate()),a.appendChild(b));h(e)&&(c=g("span"),c.innerText=e,a.appendChild(c))}function uc(a,c,b,e,f){var k=new Date,l=a===k.getDate()&&e===k.getFullYear()&&b===k.getMonth();c=Ma("calendar-day-"+c);k=g("span");var m=new Date(e,b,a);c.innerHTML="";k.className=f?"day-muted":"";k.className+=l?" today":"";k.innerText=a;if(6===m.getDay()||0===m.getDay()&&"cell"===c.className)c.className="cell weekend-day";c.oncontextmenu=function(v){rc=new Date(m);ya();q(v);Rc(v,I)};d.showDayNumberOrdinals&&
...
I&&B(r.body,I);I=g("div","calendar-drop-down-menu");r.body.appendChild(I);if(d.manualEditingEnabled){var a=g("div","item");a.innerHTML=d.addEventTitle;I.appendChild(a);a.onclick=function(){qa(null,rc)};a=g("div","separator");I.appendChild(a)}a=g("div","item");a.innerHTML=d.expandDayTooltipText;I.appendChild(a);a.onclick=function(){Ha(rc,!0)};a=g("div","separator");I.appendChild(a);a=g("div","item");a.innerHTML=d.viewWeekEventsText;I.appendChild(a);a.onclick=function(){sb(rc,!0)}}function re(){null!==
O&&B(r.body,O);if(d.manualEditingEnabled){O=g("div","calendar-drop-down-menu");r.body.appendChild(O);var a=g("div","item");a.innerHTML=d.removeEventText;O.appendChild(a);a.onclick=function(){bb(r.body,R);var c=function(){B(r.body,R)},b=0<W(ua.repeatEvery)&&null!==Eb;Jd(d.confirmEventRemoveTitle,d.confirmEventRemoveMessage,function(){c();h(ua.id)&&($b.checked||null===Eb?Db.removeEvent(ua.id,!0):(Sc(ua.seriesIgnoreDates)?ua.seriesIgnoreDates.push(Eb):ua.seriesIgnoreDates=[Eb],ia()),sc())},c,b)};a=g("div",
"separator");O.appendChild(a);a=g("div","item");a.innerHTML=d.editEventTitle;O.appendChild(a);a.onclick=function(){qa(ua)}}}function kc(a,c,b){ua=c;Eb=h(b)?b:null;ya();q(a);Rc(a,O)}function Gc(){return null!==I&&"block"===I.style.display}function Hc(){return null!==O&&"block"===O.style.display}function bc(){qa(null,Y)}function Na(){Oa.disabled=Ba.checked}function Ob(){var a=!1;fb.checked&&(G.value=M.value,S.value="00:00",T.value="23:59",a=!0);G.disabled=a;S.disabled=a;T.disabled=a;a=Fb(M);var c=Fb(G);
c>a||c<a?(a=!0,Ba.checked=!0):a=!1;Ba.disabled=a;Pb.disabled=a;Qb.disabled=a;Rb.disabled=a;Sb.disabled=a;Oa.disabled=a;Na()}function qa(a,c){bb(r.body,R);if(h(a)){Pa.value=d.updateText;Qa.style.display="block";Nb.innerHTML=d.editEventTitle;F=a;M.value=tb(a.from,M.type);S.value=gc(a.from);G.value=tb(a.to,G.type);T.value=gc(a.to);fb.checked=a.isAllDay;Aa.value=u(a.title);hb.value=u(a.description);gb.value=u(a.location);Ra.value=u(a.color,"#484848");Sa.value=u(a.colorText,"#F5F5F5");Ta.value=u(a.colorBorder,
"#282828");var b=W(a.repeatEvery);0===b?Ba.checked=!0:1===b?Pb.checked=!0:2===b?Qb.checked=!0:3===b?Rb.checked=!0:4===b&&(Sb.checked=!0);b=X(a.repeatEveryExcludeDays);Tb.checked=-1<b.indexOf(1);Ub.checked=-1<b.indexOf(2);Vb.checked=-1<b.indexOf(3);Wb.checked=-1<b.indexOf(4);Xb.checked=-1<b.indexOf(5);Yb.checked=-1<b.indexOf(6);Zb.checked=-1<b.indexOf(0);Ca.value=tb(a.repeatEnds,Ca.type)}else{b=new Date;var e=h(c)?c:b,f=new Date;e.getDate()===f.getDate()&&e.getFullYear()===f.getFullYear()&&e.getMonth()===
f.getMonth()&&(e.setHours(b.getHours()),e.setMinutes(b.getMinutes()));Pa.value=d.addText;Qa.style.display="none";Nb.innerHTML=d.addEventTitle;F={};M.value=tb(e,M.type);S.value=gc(e);G.value=tb(e,G.type);T.value=gc(e);fb.checked=!1;Aa.value="";hb.value="";gb.value="";Ra.value="#484848";Sa.value="#F5F5F5";Ta.value="#282828";Ba.checked=!0;Tb.checked=!1;Ub.checked=!1;Vb.checked=!1;Wb.checked=!1;Xb.checked=!1;Yb.checked=!1;Zb.checked=!1;Ca.value=null}Ob();za.style.display="block";ib.style.display="none";
Aa.focus()}function fe(){var a=Fb(M),c=Fb(G),b=S.value.split(":"),e=T.value.split(":"),f=Tc(Aa.value),k=Tc(hb.value),l=Tc(gb.value),m=Fb(Ca,null);2>b.length?tc(d.fromTimeErrorMessage,S):2>e.length?tc(d.toTimeErrorMessage,T):""===f?tc(d.titleErrorMessage,Aa):(Kd(a,S.value),Kd(c,T.value),c<a?tc(d.toSmallerThanFromErrorMessage,G):(wc(),b=h(F.id),a={from:a,to:c,title:f,description:k,location:l,isAllDay:fb.checked,color:F.color,colorText:F.colorText,colorBorder:F.colorBorder,repeatEveryExcludeDays:F.repeatEveryExcludeDays,
repeatEnds:m},Ba.checked?a.repeatEvery=0:Pb.checked?a.repeatEvery=1:Qb.checked?a.repeatEvery=2:Rb.checked?a.repeatEvery=3:Sb.checked&&(a.repeatEvery=4),b||(a.organizerName=d.organizerName,a.organizerEmailAddress=d.organizerEmailAddress),b?Db.updateEvent(F.id,a,!1):Db.addEvent(a,!1),ia(),sc()))}function Kd(a,c){var b=0,e=0,f=c.split(":");if(2===f.length){var k=parseInt(f[0]);f=parseInt(f[1]);!isNaN(k)&&2>=k.toString().length&&(b=k);!isNaN(f)&&2>=f.toString().length&&(e=f)}a.setHours(b);a.setMinutes(e)}
function Fb(a,c){var b=void 0!==c?c:new Date;if(""!==a.value)if("date"===a.type)b=new Date(a.value);else{var e=a.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/);e&&(e=new Date(e[3],e[2]-1,e[1]),e instanceof Date&&!isNaN(e)&&(b=e))}return b}function wc(){za.style.display="none";B(r.body,R)}function ge(){ja.style.display="block";var a=function(){ja.style.display="none"};Jd(d.confirmEventRemoveTitle,d.confirmEventRemoveMessage,function(){a();wc();h(F.id)&&(Db.removeEvent(F.id,!0),sc())},a)}function tc(a,
c){ib.innerHTML=a;ib.style.display="block";c.focus()}function sc(){Gb(Ia)&&Ha(Y);Gb(sa)&&od();Gb(La)&&sb(ta)}function he(){Zc();F.color=Ra.value;F.colorText=Sa.value;F.colorBorder=Ta.value}function Zc(){la.style.display="none";ja.style.display="none"}function de(){la.style.display="block";ja.style.display="block"}function ie(){$c();var a=[];Tb.checked&&a.push(1);Ub.checked&&a.push(2);Vb.checked&&a.push(3);Wb.checked&&a.push(4);Xb.checked&&a.push(5);Yb.checked&&a.push(6);Zb.checked&&a.push(0);F.repeatEveryExcludeDays=
a}function $c(){ma.style.display="none";ja.style.display="none"}function ee(){ma.style.display="block";ja.style.display="block"}function Jd(a,c,b,e,f){f=h(f)?f:!1;na.style.display="block";xc.innerHTML=a;yc.innerHTML=c;jb.onclick=Ld;kb.onclick=Ld;jb.addEventListener("click",b);f?(zc.style.display="block",$b.checked=!1):(zc.style.display="none",$b.checked=!0);Uc(e)&&kb.addEventListener("click",e)}function Ld(){na.style.display="none"}function cc(a){bb(r.body,R);oa.style.display="block";cb=a;Ac.checked=
...
0===va;Ea.disabled=va===ha.length-1||0===ha.length}function Cd(a,c,b){q(a);null!==wa&&(clearTimeout(wa),wa=null);Cc();"block"!==w.style.display&&(wa=setTimeout(function(){r.body.contains(R)||ec()||Gc()||Hc()||(b=h(b)?b:"",w.className=""===b?"calendar-tooltip-event":"calendar-tooltip",""!==b?w.innerHTML=b:(w.innerHTML="",w.appendChild(Bc),w.appendChild(ac),Bc.innerHTML=c.title,yb(c.repeatEvery)&&0<c.repeatEvery?(lb.innerHTML=d.repeatsText.replace(":","")+" "+Za(c.repeatEvery),bb(w,lb)):(lb.innerHTML=
"",B(w,lb)),P(c.location)?(nb.innerHTML=c.location,bb(w,nb)):(nb.innerHTML="",B(w,nb)),P(c.description)?(mb.innerHTML=c.description,bb(w,mb)):(mb.innerHTML="",B(w,mb)),c.from.getDate()===c.to.getDate()?ac.innerHTML=c.isAllDay?d.allDayText:vb(c.from,c.to):oc(ac,c.from,c.to)),Rc(a,w))},d.eventTooltipDelay))}function Cc(){null!==wa&&(clearTimeout(wa),wa=null);Qd()&&(w.style.display="none")}function Qd(){return null!==wa||null!==w&&"block"===w.style.display}function p(a,c){a.onmousemove=function(b){Cd(b,
null,c)}}function Ad(){null===Ib&&0<d.autoRefreshTimerDelay&&(Ib=setInterval(function(){rb()},d.autoRefreshTimerDelay))}function zd(){null!==Ib&&0<d.autoRefreshTimerDelay&&(clearTimeout(Ib),Ib=null)}function rb(){ud()&&(sc(),ia())}function ud(){return!Qd()&&!r.body.contains(R)&&!ec()&&!Gc()&&!Hc()}function Nc(a){Gb(a)||(a.className+=" overlay-shown")}function mc(a){Gb(a)&&(a.className=a.className.replace(" overlay-shown",""))}function Gb(a){return-1<a.className.indexOf("overlay-shown")}function g(a,
...
1);J(a);xa("onNextMonth")}function vd(){var a=new Date(t);a.setFullYear(a.getFullYear()-1);J(a);xa("onPreviousYear")}function wd(){var a=new Date(t);a.setFullYear(a.getFullYear()+1);J(a);xa("onNextYear")}function Ec(){var a=new Date;if(t.getMonth()!==a.getMonth()||t.getFullYear()!==a.getFullYear())J(),xa("onToday")}function Vd(a){h(a)&&"object"===typeof a||(a={});return a}function xa(a){if(null!==d&&Uc(d[a]))d[a]()}function Kb(a,c){if(null!==d&&Uc(d[a]))d[a](c)}var d={},Db=this,t=null,vc=null,Vc=
{},eb={},r=null,Ga=null,Yc=null,Mb=!1,sd=!1,L={},Ib=null,x=null,rd=null,Wa=!1,A=null,C=null,ob=null,N=null,dc=null,Va=null,ba=null,R=null,za=null,ja=null,Nb=null,M=null,S=null,G=null,T=null,fb=null,Aa=null,hb=null,gb=null,Ba=null,Pb=null,Qb=null,Rb=null,Sb=null,Oa=null,ib=null,F={},Pa=null,Qa=null,la=null,Ra=null,Sa=null,Ta=null,ma=null,Tb=null,Ub=null,Vb=null,Wb=null,Xb=null,Yb=null,Zb=null,Ca=null,Ia=null,wb=null,fa=null,Ja=null,xb=null,Y=null,Mc=[],Ya=null,ca=null,sa=null,zb=null,da=null,Ab=null,
La=null,Z=null,$a=null,ea=null,Cb=null,ab={},Oc={},Bb=[],ta=null,na=null,xc=null,yc=null,$b=null,zc=null,jb=null,kb=null,oa=null,Ac=null,ad=null,bd=null,cd=null,dd=null,cb=null,w=null,Bc=null,ac=null,lb=null,mb=null,nb=null,wa=null,I=null,rc=null,O=null,ua=null,Eb=null,z=null,pa=null,K=null,V=null,gd=null,hd=null,id=null,jd=null,Ua=null,Ea=null,Hb=!1,Od=!1,Md=0,Nd=0,ha=[],va=0;this.turnOnFullScreen=function(){qd()};this.turnOffFullScreen=function(){pd()};this.startTheAutoRefreshTimer=function(){Ad()};
this.stopTheAutoRefreshTimer=function(){zd()};this.moveToPreviousMonth=function(){Dc()};this.moveToNextMonth=function(){Fc()};this.moveToPreviousYear=function(){vd()};this.moveToNextYear=function(){wd()};this.moveToToday=function(){Ec()};this.getCurrentDisplayDate=function(){return new Date(t)};this.setCurrentDisplayDate=function(a){J(new Date(a));xa("onSetDate")};this.exportAllEvents=function(a){d.exportEventsEnabled&&(a=h(a)?a:"csv",db(null,a))};this.refresh=function(){rb()};this.setEvents=function(a,
c,b){b=h(b)?b:!0;L={};this.addEvents(a,c,!1);b&&Kb("onEventsSet",a)};this.addEvents=function(a,c,b){c=h(c)?c:!0;b=h(b)?b:!0;for(var e=a.length,f=0;f<e;f++)this.addEvent(a[f],!1,!1);b&&Kb("onEventAdded",a);c&&ia()};this.addEvent=function(a,c,b){var e=!1;if(a.from<=a.to){var f=a.from;f=f.getFullYear()+"-"+f.getMonth()+"-"+f.getDate();var k=Rd();L.hasOwnProperty(f)||(L[f]={});L[f].hasOwnProperty(k)||(c=h(c)?c:!0,b=h(b)?b:!0,h(a.id)?k=a.id:a.id=k,h(a.created)||(a.created=new Date),L[f][k]=ld(a),e=!0,
b&&Kb("onEventAdded",a),c&&ia())}return e};this.updateEvent=function(a,c,b,e){if(a=this.removeEvent(a,!1,!1))b=h(b)?b:!0,e=h(e)?e:!0,c.id=Rd(),(a=this.addEvent(c,b,!1))&&e&&Kb("onEventUpdated",c);return a};this.removeEvent=function(a,c,b){var e=!1;qb(function(f,k,l){if(l===a)return c=h(c)?c:!0,b=h(b)?b:!0,delete L[k][l],e=!0,b&&Kb("onEventRemoved",f),c&&ia(),!0});return e};this.clearEvents=function(a){a=h(a)?a:!0;L={};xa("onEventsCleared");a&&ia()};this.getEvents=function(){return Fa(pb())};this.getEvent=
function(a){var c=null;qb(function(b,e,f){if(f===a)return c=b,!0});return c};this.setOptions=function(a){a=Vd(a);for(var c in a)a.hasOwnProperty(c)&&(d[c]=a[c]);Mb&&(Mb=!1,J(t,!0))};(function(a,c){r=a;Ga=c;Yc=Wd;d=Vd(Xd);h(d.previousMonthTooltipText)||(d.previousMonthTooltipText="Previous Month");h(d.nextMonthTooltipText)||(d.nextMonthTooltipText="Next Month");h(d.previousDayTooltipText)||(d.previousDayTooltipText="Previous Day");h(d.nextDayTooltipText)||(d.nextDayTooltipText="Next Day");h(d.previousWeekTooltipText)||
(d.previousWeekTooltipText="Previous Week");h(d.nextWeekTooltipText)||(d.nextWeekTooltipText="Next Week");h(d.addEventTooltipText)||(d.addEventTooltipText="Add Event");h(d.closeTooltipText)||(d.closeTooltipText="Close");h(d.exportEventsTooltipText)||(d.exportEventsTooltipText="Export Events");h(d.todayTooltipText)||(d.todayTooltipText="Today");h(d.refreshTooltipText)||(d.refreshTooltipText="Refresh");h(d.searchTooltipText)||(d.searchTooltipText="Search");h(d.expandDayTooltipText)||(d.expandDayTooltipText=
"Expand Day");h(d.listAllEventsTooltipText)||(d.listAllEventsTooltipText="View All Events");h(d.listWeekEventsTooltipText)||(d.listWeekEventsTooltipText="View Current Week Events");h(d.dayHeaderNames)||(d.dayHeaderNames="Mon Tue Wed Thu Fri Sat Sun".split(" "));h(d.dayNames)||(d.dayNames="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "));h(d.fromText)||(d.fromText="From:");h(d.toText)||(d.toText="To:");h(d.isAllDayText)||(d.isAllDayText="Is All-Day");h(d.titleText)||(d.titleText=
"Title:");h(d.descriptionText)||(d.descriptionText="Description:");h(d.locationText)||(d.locationText="Location:");h(d.addText)||(d.addText="Add");h(d.updateText)||(d.updateText="Update");h(d.cancelText)||(d.cancelText="Cancel");h(d.removeEventText)||(d.removeEventText="Remove");h(d.addEventTitle)||(d.addEventTitle="Add Event");h(d.editEventTitle)||(d.editEventTitle="Edit Event");h(d.monthNames)||(d.monthNames="January February March April May June July August September October November December".split(" "));
